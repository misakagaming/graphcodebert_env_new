...
//
//    Name: DYYY0221_CHILD_READ              Date: 2023/07/05
//    Target OS:   JVM                       Time: 15:08:51
...
public class DYYY0221 extends ABBase
{
  // * * * * * * * * * * * * * * * * * * *
  ...
  // * * * * * * * * * * * * * * * * * * *
  String sl_29360181 = ErrorData.NONE_FL_LS;
  String Child_es;
  String Child_001cd;
  String Child_lk;
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
   ...
   **/
  public class DYYY0221_EA extends ViewBase implements IEntityActionView, Serializable
  {
    // Entity View: 
    //        Type: CHILD
    /**
  ...
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  DYYY0221_EA w_ea = new DYYY0221_EA();
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  ...
  // CURSOR OPEN FLAGS
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  boolean curs_open_0029360181 = false;
  ...
  //    FOLLOW AS NEEDED:             
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  boolean func_0022020306_esc_flag;
  PreparedStatement hstmt_0037932487_1;
  ResultSet hstmt_0037932487_1_rs;
  int hstmt_0037932487_1_cnt;
  PadView padview[] = new PadView [56];
  int trace_ret_code;
  PadText padtext[] = initPadText();
  public PadText [] initPadText()
  {
    PadText [] result = new PadText [PADTEXT_SIZE];
    result[0] = PadText.getInstance(   0,"+->   DYYY0221_CHILD_READ               07/05/2023  15:08");
    ...
    result[10] = PadText.getInstance(   0,"!         Entity View imp child (Transient, Mandatory, Import only)");
    result[11] = PadText.getInstance(   0,"!           cinstance_id");
    ...
    result[15] = PadText.getInstance(   0,"!         Entity View exp child (Transient, Export only)");
    result[16] = PadText.getInstance(   0,"!           cinstance_id");
    result[17] = PadText.getInstance(   0,"!           creference_id");
    result[18] = PadText.getInstance(   0,"!           ccreate_user_id");
    result[19] = PadText.getInstance(   0,"!           cupdate_user_id");
    result[20] = PadText.getInstance(   0,"!           cparent_pkey_attr_text");
    result[21] = PadText.getInstance(   0,"!           ckey_attr_num");
    result[22] = PadText.getInstance(   0,"!           csearch_attr_text");
    result[23] = PadText.getInstance(   0,"!           cother_attr_text");
    result[24] = PadText.getInstance(   0,"!         Work View exp_error iyy1_component (Transient, Export only)");
    ...
    result[32] = PadText.getInstance(   0,"!       ENTITY ACTIONS:");
    ...
    result[48] = PadText.getInstance(   0,"!           121_child_not_found");
    result[49] = PadText.getInstance(   0,"!");
    result[50] = PadText.getInstance(   0,"!     PROCEDURE STATEMENTS");
    result[51] = PadText.getInstance(   0,"!");
    result[52] = PadText.getInstance(   1,"!  NOTE: ");
    result[53] = PadText.getInstance(   1,"!  See the description for the purpose");
    result[54] = PadText.getInstance(   1,"!  ");
    result[55] = PadText.getInstance(   2,"!  NOTE: ");
    result[56] = PadText.getInstance(   2,"!  RELEASE HISTORY");
    result[57] = PadText.getInstance(   2,"!  01_00 23-02-1998 New release");
    result[58] = PadText.getInstance(   2,"!  ");
    result[59] = PadText.getInstance(   3,"!  MOVE imp_error iyy1_component TO exp_error iyy1_component");
    result[60] = PadText.getInstance(   4,"!   ");
    result[61] = PadText.getInstance(   5,"!  NOTE: ");
    result[62] = PadText.getInstance(   5,"!  ****************************************************************");
    result[63] = PadText.getInstance(   5,"!  The used ReturnCode/ReasonCode values");
    result[64] = PadText.getInstance(   5,"!  ");
    result[65] = PadText.getInstance(   6,"!  NOTE: ");
    result[66] = PadText.getInstance(   6,"!  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[67] = PadText.getInstance(   6,"!  Set the return and reason codes below");
    result[68] = PadText.getInstance(   6,"!  ");
    result[69] = PadText.getInstance(   7,"!  SET loc dont_change_return_codes 1_ok TO 1 ");
    result[70] = PadText.getInstance(   8,"!  SET loc dont_change_return_codes n10_obj_not_found TO -10 ");
    result[71] = PadText.getInstance(   9,"!   ");
    result[72] = PadText.getInstance(  10,"!  SET loc dont_change_reason_codes 1_default TO 1 ");
    result[73] = PadText.getInstance(  11,"!  SET loc dont_change_reason_codes 121_child_not_found TO 121 ");
    result[74] = PadText.getInstance(  12,"!   ");
    result[75] = PadText.getInstance(  13,"!  NOTE: ");
    result[76] = PadText.getInstance(  13,"!  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[77] = PadText.getInstance(  13,
      "!  If the Instance_id is being used, reading must be operated according to this section, instead ");
    result[78] = PadText.getInstance(  13,"!  of business_key(s).");
    result[79] = PadText.getInstance(  13,"!  ");
    result[80] = PadText.getInstance(  13,"!  ");
    result[81] = PadText.getInstance(  13,"!  ");
    result[82] = PadText.getInstance(  14,"!  NOTE: ");
    result[83] = PadText.getInstance(  14,"!  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[84] = PadText.getInstance(  14,"!  Choose Control of Cursor Generation property as \"Select only\".");
    result[85] = PadText.getInstance(  14,"!  ");
    result[86] = PadText.getInstance(  15,"!  +=>READ (Select Only) child");
    result[87] = PadText.getInstance(  15,
      "!  !        WHERE DESIRED child cparent_pkey_attr_text = imp child cparent_pkey_attr_text  ");
    result[88] = PadText.getInstance(  15,"!  !              AND  DESIRED child ckey_attr_num = imp child ckey_attr_num");
    result[89] = PadText.getInstance(  15, 1, "!  +> WHEN successful");
    result[90] = PadText.getInstance(  16,"!  !  MOVE  child TO exp child");
  ...
  public void DYYY0221( Object in_runtime_parm1, 
  	...
  	throws ABException
  {
    ...
    {
      f_29360181();
      if ( sl_29360181.equals( ErrorData.SUCCEEDS_FL_LS ) == true )
      {
        ...
        f_0_trace();
        {
          ...
          if ( trace_ret_code != 8 )
          {
            w_oa.ExpChildCinstanceId = TimestampAttr.valueOf(w_ea.ChildCinstanceId);
            w_oa.ExpChildCreferenceId = TimestampAttr.valueOf(w_ea.ChildCreferenceId);
            w_oa.ExpChildCcreateUserId = FixedStringAttr.valueOf(w_ea.ChildCcreateUserId, (short)8);
            w_oa.ExpChildCupdateUserId = FixedStringAttr.valueOf(w_ea.ChildCupdateUserId, (short)8);
            w_oa.ExpChildCparentPkeyAttrText = FixedStringAttr.valueOf(w_ea.ChildCparentPkeyAttrText, (short)5);
            w_oa.ExpChildCkeyAttrNum = IntAttr.valueOf(w_ea.ChildCkeyAttrNum);
            w_oa.ExpChildCsearchAttrText = FixedStringAttr.valueOf(w_ea.ChildCsearchAttrText, (short)25);
            w_oa.ExpChildCotherAttrText = FixedStringAttr.valueOf(w_ea.ChildCotherAttrText, (short)25);
          }
        }
      }
      else if ( sl_29360181.equals( ErrorData.NOT_FOUND_FL_LS ) == true )
      {
  ...
  public void f_22020306_localAlloc(String abname)
  {
    ...
    w_la = (gen.ort.yyy.DYYY0221_LA)(iefRuntimeParm2.getInstance("gen.ort.yyy.DYYY0221_LA"));
    if ( w_la == null )
    {
      globdata.getStateData().setCurrentABId( "0022020306" );
...
padview[0] = PadView.getInstance("IMPORT                          ", 0, 0, 0, (short)1, PadView.VT_BASE, PadView.DT_NONE, w_ia, 
    ...
    padview[10] = PadView.getInstance("IMP                             ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_ia, 
      null);
    padview[11] = PadView.getInstance("CHILD                           ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_ia, null);
    padview[12] = PadView.getInstance("CINSTANCE_ID                    ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, 
    ...
    padview[16] = PadView.getInstance("EXP                             ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_oa, 
      null);
    padview[17] = PadView.getInstance("CHILD                           ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_oa, null);
    padview[18] = PadView.getInstance("CINSTANCE_ID                    ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_TIMESTAMP, w_oa, "ExpChildCinstanceId");
    padview[19] = PadView.getInstance("CREFERENCE_ID                   ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_TIMESTAMP, w_oa, "ExpChildCreferenceId");
    padview[20] = PadView.getInstance("CCREATE_USER_ID                 ", 8, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpChildCcreateUserId");
    padview[21] = PadView.getInstance("CUPDATE_USER_ID                 ", 8, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpChildCupdateUserId");
    padview[22] = PadView.getInstance("CPARENT_PKEY_ATTR_TEXT          ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpChildCparentPkeyAttrText");
    padview[23] = PadView.getInstance("CKEY_ATTR_NUM                   ", 6, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_oa, "ExpChildCkeyAttrNum");
    padview[24] = PadView.getInstance("CSEARCH_ATTR_TEXT               ", 25, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpChildCsearchAttrText");
    padview[25] = PadView.getInstance("COTHER_ATTR_TEXT                ", 25, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpChildCotherAttrText");
    ...
    padview[40] = PadView.getInstance("CCREATE_USER_ID                 ", 8, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_ea, "ChildCcreateUserId");
    padview[41] = PadView.getInstance("CUPDATE_USER_ID                 ", 8, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_ea, "ChildCupdateUserId");
    padview[42] = PadView.getInstance("CPARENT_PKEY_ATTR_TEXT          ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_ea, "ChildCparentPkeyAttrText");
    padview[43] = PadView.getInstance("CKEY_ATTR_NUM                   ", 6, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_ea, "ChildCkeyAttrNum");
    padview[44] = PadView.getInstance("CSEARCH_ATTR_TEXT               ", 25, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_ea, "ChildCsearchAttrText");
    padview[45] = PadView.getInstance("COTHER_ATTR_TEXT                ", 25, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
    ...
    padview[50] = PadView.getInstance("N10_OBJ_NOT_FOUND               ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
    ...
    padview[55] = PadView.getInstance("******** BOTTOM OF DATA ********", 0, 0, 0, (short)0, PadView.VT_END, PadView.DT_NONE, w_la, 
      null);
  }
  public void f_29360181()
  	throws ABException
  {
    sl_29360181 = ErrorData.SUCCEEDS_FL_LS;
    ...
    if ( sl_29360181.equals( ErrorData.SUCCEEDS_FL_LS ) == true )
    {
      ...
      try {
        ...
        SQLStatement.append(")");
        hstmt_0037932487_1 = globdata.getDBMSData().getDBMSManager().getStatement(globdata, iefRuntimeParm2, "IEFDB", 
          SQLStatement.toString());
        globdata.getDBMSData().getDBMSManager().bindParameterString("IEFDB", hstmt_0037932487_1, 1, CparentPkeyAttrText_001TP);
        hstmt_0037932487_1.setInt(2, CkeyAttrNum_002TP);
        hstmt_0037932487_1.execute();
        hstmt_0037932487_1_rs = hstmt_0037932487_1.getResultSet();
        if ( hstmt_0037932487_1_rs.next() == false )
        {
          throw new SQLException("No data found");
        }
        cinstance_id_011EF = hstmt_0037932487_1_rs.getTimestamp(1);
        creference_id_013EF = hstmt_0037932487_1_rs.getTimestamp(2);
        ccreate_userid_007EF = globdata.getDBMSData().getDBMSManager().getStringFromResultSet("IEFDB", hstmt_0037932487_1_rs, 3);
        cupdate_userid_009EF = globdata.getDBMSData().getDBMSManager().getStringFromResultSet("IEFDB", hstmt_0037932487_1_rs, 4);
        cparent_pkey_attr_015EF = globdata.getDBMSData().getDBMSManager().getStringFromResultSet("IEFDB", hstmt_0037932487_1_rs, 5);
        ckey_attr_001EF = hstmt_0037932487_1_rs.getInt(6);
        csearch_attr_003EF = globdata.getDBMSData().getDBMSManager().getStringFromResultSet("IEFDB", hstmt_0037932487_1_rs, 7);
        cother_attr_005EF = globdata.getDBMSData().getDBMSManager().getStringFromResultSet("IEFDB", hstmt_0037932487_1_rs, 8);
        if ( hstmt_0037932487_1_rs.next() == true )
        {
      ...
      {
        f_29360181_movea();
        if ( sl_29360181.equals( ErrorData.SUCCEEDS_FL_LS ) )
        {
          Child_es = ABBase.EV_USABLE;
        }
        else {
        ...
        try {
          ...
          if ( hstmt_0037932487_1 != null )
          {
            hstmt_0037932487_1.close();
            hstmt_0037932487_1 = null;
          }
        } catch( SQLException e ) {
          if ( globdata.getDBMSData().getDBMSManager().wasSuccessful(e) == false )
          {
            sqlException = e;
            f_29360181_jdbc_dberror();
          }
        }
      }
      else if ( globdata.getDBMSData().getDBMSManager().wasNoDataFound(sqlException) )
      {
        sl_29360181 = ErrorData.NOT_FOUND_FL_LS;
        Child_es = ABBase.EV_UNUSABLE;
        try {
          if ( hstmt_0037932487_1_rs != null )
          {
  ...
  public void f_29360181_jdbc_dberror()
  	throws ABException
  {
    globdata.getErrorData().setStatus( ErrorData.FATAL_ERROR_FL_LS );
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: DYYY0221_IA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:08:51
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: DYYY0221_IA
 **/
public class DYYY0221_IA extends ViewBase implements IImportView, Serializable
{
  ...
  public DYYY0221_IA(DYYY0221_IA orig)
  {
    copyFrom(orig);
  }
  /**
  ...
  public static DYYY0221_IA getInstance()
  {
    return new DYYY0221_IA();
  }
  /**
  ...
  {
    this.copyFrom((DYYY0221_IA) orig);
  }
  
  /**
   * Sets the current instance based on the passed view.
   **/
  public void copyFrom(DYYY0221_IA orig)
  {
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: DYYY0221_LA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:08:51
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 ...
 **/
public class DYYY0221_LA extends ViewBase implements ILocalView, Serializable
{
  // Entity View: LOC
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: DYYY0221_OA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:08:51
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 ...
 **/
public class DYYY0221_OA extends ViewBase implements IExportView, Serializable
{
  // Entity View: EXP
  //        Type: CHILD
  /**

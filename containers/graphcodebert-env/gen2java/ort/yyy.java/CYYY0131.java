...
//
//    Name: CYYY0131_PARENT_UPDATE           Date: 2023/07/05
//    Target OS:   JVM                       Time: 15:08:12
...
public class CYYY0131 extends ABBase
{
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  ...
  gen.ort.yyy.DYYY0131_IA dyyy0131_ia;
  gen.ort.yyy.DYYY0131_OA dyyy0131_oa;
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  ...
  //    FOLLOW AS NEEDED:             
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  boolean func_0022020341_esc_flag;
  boolean func_0020972544_esc_flag;
  boolean func_0020972237_esc_flag;
  boolean func_0020972334_esc_flag;
  boolean func_0020972317_esc_flag;
  ...
  public PadText [] initPadText()
  {
    ...
    result[0] = PadText.getInstance(   0,"+->   CYYY0131_PARENT_UPDATE            07/05/2023  15:08");
    ...
    result[6] = PadText.getInstance(   0,"!           pinstance_id");
    result[7] = PadText.getInstance(   0,"!           preference_id");
    result[8] = PadText.getInstance(   0,"!           pkey_attr_text");
    result[9] = PadText.getInstance(   0,"!           psearch_attr_text");
    result[10] = PadText.getInstance(   0,"!           pother_attr_text");
    result[11] = PadText.getInstance(   0,"!           ptype_tkey_attr_text");
    result[12] = PadText.getInstance(   0,"!       EXPORTS:");
    result[13] = PadText.getInstance(   0,"!         Entity View exp parent (Transient, Export only)");
    result[14] = PadText.getInstance(   0,"!           preference_id");
    ...
    result[24] = PadText.getInstance(   0,"!         Entity View loc_imp parent");
    result[25] = PadText.getInstance(   0,"!           pinstance_id");
    result[26] = PadText.getInstance(   0,"!           preference_id");
    result[27] = PadText.getInstance(   0,"!           pkey_attr_text");
    result[28] = PadText.getInstance(   0,"!           psearch_attr_text");
    result[29] = PadText.getInstance(   0,"!           pother_attr_text");
    result[30] = PadText.getInstance(   0,"!           ptype_tkey_attr_text");
    result[31] = PadText.getInstance(   0,"!         Entity View loc_empty parent");
    result[32] = PadText.getInstance(   0,"!           pinstance_id");
    result[33] = PadText.getInstance(   0,"!           pkey_attr_text");
    result[34] = PadText.getInstance(   0,"!           psearch_attr_text");
    result[35] = PadText.getInstance(   0,"!           pother_attr_text");
    result[36] = PadText.getInstance(   0,"!           ptype_tkey_attr_text");
    result[37] = PadText.getInstance(   0,"!         Work View loc_error iyy1_component");
    result[38] = PadText.getInstance(   0,"!           severity_code");
    result[39] = PadText.getInstance(   0,"!           rollback_indicator");
    result[40] = PadText.getInstance(   0,"!           origin_servid");
    result[41] = PadText.getInstance(   0,"!           context_string");
    result[42] = PadText.getInstance(   0,"!           return_code");
    result[43] = PadText.getInstance(   0,"!           reason_code");
    result[44] = PadText.getInstance(   0,"!           checksum");
    result[45] = PadText.getInstance(   0,"!         Group View (9) loc_group_context");
    result[46] = PadText.getInstance(   0,"!           Work View loc_g_context dont_change_text");
    result[47] = PadText.getInstance(   0,"!             text_150");
    result[48] = PadText.getInstance(   0,"!         Work View loc dont_change_return_codes");
    result[49] = PadText.getInstance(   0,"!           1_ok");
    result[50] = PadText.getInstance(   0,"!           n20_mandatory_import_missing");
    result[51] = PadText.getInstance(   0,"!         Work View loc dont_change_reason_codes");
    result[52] = PadText.getInstance(   0,"!           1_default");
    result[53] = PadText.getInstance(   0,"!           104_parent_type_key_attr_mand");
    result[54] = PadText.getInstance(   0,"!           105_parent_key_attr_mand");
    result[55] = PadText.getInstance(   0,"!           106_parent_search_attr_mand");
    ...
    result[60] = PadText.getInstance(   1,"!  See the description for the purpose.");
    ...
    result[66] = PadText.getInstance(   3,"!  USE cyyy9001_exception_hndlng_dflt");
    result[67] = PadText.getInstance(   3,
      "!     WHICH EXPORTS: Work View exp_error iyy1_component FROM Work View exp_error iyy1_component");
    result[68] = PadText.getInstance(   4,"!   ");
    result[69] = PadText.getInstance(   5,"!  NOTE: ");
    result[70] = PadText.getInstance(   5,"!  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[71] = PadText.getInstance(   5,"!  Name the method below");
    result[72] = PadText.getInstance(   5,"!  ");
    result[73] = PadText.getInstance(   6,"!  SET SUBSCRIPT OF loc_group_context TO 1 ");
    result[74] = PadText.getInstance(   7,"!  SET loc_g_context dont_change_text text_150 TO \"CYYY0131\" ");
    result[75] = PadText.getInstance(   8,"!  SET SUBSCRIPT OF loc_group_context TO 2 ");
    result[76] = PadText.getInstance(   9,"!  SET loc_g_context dont_change_text text_150 TO \"UPDATE\" ");
    result[77] = PadText.getInstance(  10,"!   ");
    result[78] = PadText.getInstance(  11,"!  NOTE: ");
    result[79] = PadText.getInstance(  11,"!  ****************************************************************");
    result[80] = PadText.getInstance(  11,"!  The used ReturnCode/ReasonCode values");
    result[81] = PadText.getInstance(  11,"!  ");
    result[82] = PadText.getInstance(  12,"!  NOTE: ");
    result[83] = PadText.getInstance(  12,"!  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[84] = PadText.getInstance(  12,"!  Set the return and reason codes below");
    result[85] = PadText.getInstance(  12,"!  ");
    result[86] = PadText.getInstance(  13,"!  SET loc dont_change_return_codes 1_ok TO 1 ");
    result[87] = PadText.getInstance(  14,"!  SET loc dont_change_return_codes n20_mandatory_import_missing TO -20 ");
    result[88] = PadText.getInstance(  15,"!   ");
    result[89] = PadText.getInstance(  16,"!  SET loc dont_change_reason_codes 1_default TO 1 ");
    result[90] = PadText.getInstance(  17,"!  SET loc dont_change_reason_codes 104_parent_type_key_attr_mand TO 104 ");
    result[91] = PadText.getInstance(  18,"!  SET loc dont_change_reason_codes 105_parent_key_attr_mand TO 105 ");
    result[92] = PadText.getInstance(  19,"!  SET loc dont_change_reason_codes 106_parent_search_attr_mand TO 106 ");
    result[93] = PadText.getInstance(  20,"!   ");
    result[94] = PadText.getInstance(  21,"!  NOTE: ");
    result[95] = PadText.getInstance(  21,"!  ****************************************************************");
    result[96] = PadText.getInstance(  21,"!  ");
    result[97] = PadText.getInstance(  22,"!  MOVE imp parent TO loc_imp parent");
    result[98] = PadText.getInstance(  23,"!   ");
    result[99] = PadText.getInstance(  24,"!  NOTE: ");
    result[100] = PadText.getInstance(  24,"!  ****************************************************************");
    result[101] = PadText.getInstance(  24,"!  Mandatory or optional only the needed fields for the operation are checked.");
    result[102] = PadText.getInstance(  24,"!  ");
    result[103] = PadText.getInstance(  25,"!  +->IF exp_error iyy1_component return_code >= loc dont_change_return_codes 1_ok");
    result[104] = PadText.getInstance(  26,"!  !  +->IF loc_imp parent pkey_attr_text <= loc_empty parent pkey_attr_text");
    ...
    result[106] = PadText.getInstance(  28,
      "!  !  !  SET exp_error iyy1_component reason_code TO loc dont_change_reason_codes 104_parent_type_key_attr_mand ");
    result[107] = PadText.getInstance(  26,"!  !  +--");
    result[108] = PadText.getInstance(  29,"!  !  +->IF loc_imp parent psearch_attr_text <= loc_empty parent psearch_attr_text");
    result[109] = PadText.getInstance(  30,
      "!  !  !  SET exp_error iyy1_component return_code TO loc dont_change_return_codes n20_mandatory_import_missing ");
    result[110] = PadText.getInstance(  31,
    ...
    result[112] = PadText.getInstance(  32,"!  !  +->IF imp parent ptype_tkey_attr_text <= loc_empty parent ptype_tkey_attr_text");
    result[113] = PadText.getInstance(  33,
      "!  !  !  SET exp_error iyy1_component return_code TO loc dont_change_return_codes n20_mandatory_import_missing ");
    result[114] = PadText.getInstance(  34,
      "!  !  !  SET exp_error iyy1_component reason_code TO loc dont_change_reason_codes 106_parent_search_attr_mand ");
    result[115] = PadText.getInstance(  32,"!  !  +--");
    result[116] = PadText.getInstance(  25,"!  +--");
    result[117] = PadText.getInstance(  35,"!   ");
    result[118] = PadText.getInstance(  36,"!  +->IF exp_error iyy1_component return_code >= loc dont_change_return_codes 1_ok");
    result[119] = PadText.getInstance(  37,"!  !  USE dyyy0131_parent_update");
    result[120] = PadText.getInstance(  37,
      "!  !     WHICH IMPORTS: Work View exp_error iyy1_component TO Work View imp_error iyy1_component");
    result[121] = PadText.getInstance(  37,
      "!  !                    Work View imp_reference iyy1_server_data TO Work View imp_reference iyy1_server_data");
    result[122] = PadText.getInstance(  37,"!  !                    Entity View loc_imp parent TO Entity View imp parent");
    result[123] = PadText.getInstance(  37,"!  !     WHICH EXPORTS: Entity View exp parent FROM Entity View exp parent");
    result[124] = PadText.getInstance(  37,
      "!  !                    Work View loc_error iyy1_component FROM Work View exp_error iyy1_component");
    result[125] = PadText.getInstance(  38,"!  !  +->IF loc_error iyy1_component return_code < loc dont_change_return_codes 1_ok");
    result[126] = PadText.getInstance(  39,"!  !  !  MOVE loc_error iyy1_component TO exp_error iyy1_component");
    result[127] = PadText.getInstance(  40,"!  !  !  NOTE: ");
    result[128] = PadText.getInstance(  40,"!  !  !  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[129] = PadText.getInstance(  40,
      "!  !  !  !! WARNING: In D AB, if there' s a need for generating context string, must exit from ESCAPE AB.");
    result[130] = PadText.getInstance(  40,"!  !  !  ");
    result[131] = PadText.getInstance(  41,"! <------ESCAPE");
    result[132] = PadText.getInstance(  38,"!  !  +--");
    result[133] = PadText.getInstance(  36,"!  +--");
    result[134] = PadText.getInstance(  42,"!   ");
    result[135] = PadText.getInstance(  43,"!  +->IF exp_error iyy1_component return_code < loc dont_change_return_codes 1_ok");
    result[136] = PadText.getInstance(  44,"!  !  USE cyyy9141_context_string_set");
    result[137] = PadText.getInstance(  44,"!  !     WHICH IMPORTS: Group View  loc_group_context TO Group View imp_group_context");
    ...
    result[139] = PadText.getInstance(  44,
      "!  !                    Work View exp_error iyy1_component FROM Work View exp_context iyy1_component");
    result[140] = PadText.getInstance(  45,"!  !   ");
    result[141] = PadText.getInstance(  46,"!  !  +->IF loc_error iyy1_component return_code < loc dont_change_return_codes 1_ok");
    result[142] = PadText.getInstance(  47,"!  !  !  MOVE loc_error iyy1_component TO exp_error iyy1_component");
    result[143] = PadText.getInstance(  46,"!  !  +--");
    result[144] = PadText.getInstance(  48,"!  !  SET exp_error iyy1_component severity_code TO \"E\" ");
    result[145] = PadText.getInstance(  43,"!  +--");
    result[146] = PadText.getInstance(   0,"+---");
    result[147] = PadText.getInstance(PadText.LASTLINE,"************************* BOTTOM OF DATA *************************");
    return result;
  }
  final static int PADTEXT_SIZE = 148;
  ...
  public void CYYY0131( Object in_runtime_parm1, 
  	...
  	throws ABException
  {
    ...
    f_0022020341_esctag: 
    {
      ...
      if ( trace_ret_code != 8 )
      {
        w_la.LocGContextDontChangeTextText150[LocGroupContext_PS_001-1] = FixedStringAttr.valueOf("CYYY0131", (short)150);
        f_173015048_rgvc();
      }
      ...
      if ( trace_ret_code != 8 )
      {
        w_la.LocImpParentPinstanceId = TimestampAttr.valueOf(w_ia.ImpParentPinstanceId);
        w_la.LocImpParentPreferenceId = TimestampAttr.valueOf(w_ia.ImpParentPreferenceId);
  	...
  	throws ABException
  {
    ...
    if ( trace_ret_code != 8 )
    {
      if ( CompareExit.compareTo(w_ia.ImpParentPtypeTkeyAttrText, w_la.LocEmptyParentPtypeTkeyAttrText) <= 0 )
      {
  	...
  	throws ABException
  {
    ...
    f_0020972237_esctag: 
    {
      ...
      if ( trace_ret_code != 8 )
      {
        ...
        dyyy0131_ia = (gen.ort.yyy.DYYY0131_IA)(iefRuntimeParm2.getInstance("gen.ort.yyy.DYYY0131_IA"));
        dyyy0131_oa = (gen.ort.yyy.DYYY0131_OA)(iefRuntimeParm2.getInstance("gen.ort.yyy.DYYY0131_OA"));
        dyyy0131_ia.ImpParentPinstanceId = TimestampAttr.valueOf(w_la.LocImpParentPinstanceId);
        dyyy0131_ia.ImpParentPreferenceId = TimestampAttr.valueOf(w_la.LocImpParentPreferenceId);
        dyyy0131_ia.ImpParentPkeyAttrText = FixedStringAttr.valueOf(w_la.LocImpParentPkeyAttrText, (short)5);
        dyyy0131_ia.ImpParentPsearchAttrText = FixedStringAttr.valueOf(w_la.LocImpParentPsearchAttrText, (short)25);
        dyyy0131_ia.ImpParentPotherAttrText = FixedStringAttr.valueOf(w_la.LocImpParentPotherAttrText, (short)25);
        dyyy0131_ia.ImpParentPtypeTkeyAttrText = FixedStringAttr.valueOf(w_la.LocImpParentPtypeTkeyAttrText, (short)4);
        dyyy0131_ia.ImpReferenceIyy1ServerDataUserid = FixedStringAttr.valueOf(w_ia.ImpReferenceIyy1ServerDataUserid, (short)8);
        dyyy0131_ia.ImpReferenceIyy1ServerDataReferenceId = TimestampAttr.valueOf(w_ia.ImpReferenceIyy1ServerDataReferenceId);
        dyyy0131_ia.ImpErrorIyy1ComponentSeverityCode = FixedStringAttr.valueOf(w_oa.ExpErrorIyy1ComponentSeverityCode, (short)1);
        dyyy0131_ia.ImpErrorIyy1ComponentRollbackIndicator = FixedStringAttr.valueOf(w_oa.ExpErrorIyy1ComponentRollbackIndicator, (
          short)1);
        dyyy0131_ia.ImpErrorIyy1ComponentOriginServid = DoubleAttr.valueOf(w_oa.ExpErrorIyy1ComponentOriginServid);
        dyyy0131_ia.ImpErrorIyy1ComponentContextString = StringAttr.valueOf(w_oa.ExpErrorIyy1ComponentContextString, (short)512);
        dyyy0131_ia.ImpErrorIyy1ComponentReturnCode = IntAttr.valueOf(w_oa.ExpErrorIyy1ComponentReturnCode);
        dyyy0131_ia.ImpErrorIyy1ComponentReasonCode = IntAttr.valueOf(w_oa.ExpErrorIyy1ComponentReasonCode);
        dyyy0131_ia.ImpErrorIyy1ComponentChecksum = FixedStringAttr.valueOf(w_oa.ExpErrorIyy1ComponentChecksum, (short)15);
        globdata.getErrorData().setErrorEncounteredSW( ErrorData.NO_ERROR_FOUND_SW );
        iefRuntimeParm2.useActionBlock("gen.ort.yyy.DYYY0131", "DYYY0131", dyyy0131_ia, dyyy0131_oa);
        if ( ((!(globdata.getErrorData().getStatus().equals( ErrorData.NONE_SF ))) || (globdata.getErrorData().getErrorEncounteredSW(
          ) != ErrorData.NO_ERROR_FOUND_SW)) || (globdata.getErrorData().getViewOverflowSW() != ErrorData.NO_ERROR_FOUND_SW) )
        {
          throw new ABException();
        ...
        globdata.getStateData().setCurrentABName( "CYYY0131_PARENT_UPDATE" );
        globdata.getStateData().setLastStatementNumber( "0000000037" );
        w_la.LocErrorIyy1ComponentSeverityCode = FixedStringAttr.valueOf(dyyy0131_oa.ExpErrorIyy1ComponentSeverityCode, (short)1);
        w_la.LocErrorIyy1ComponentRollbackIndicator = FixedStringAttr.valueOf(dyyy0131_oa.ExpErrorIyy1ComponentRollbackIndicator, (
          short)1);
        w_la.LocErrorIyy1ComponentOriginServid = DoubleAttr.valueOf(dyyy0131_oa.ExpErrorIyy1ComponentOriginServid);
        w_la.LocErrorIyy1ComponentContextString = StringAttr.valueOf(dyyy0131_oa.ExpErrorIyy1ComponentContextString, (short)512);
        w_la.LocErrorIyy1ComponentReturnCode = IntAttr.valueOf(dyyy0131_oa.ExpErrorIyy1ComponentReturnCode);
        w_la.LocErrorIyy1ComponentReasonCode = IntAttr.valueOf(dyyy0131_oa.ExpErrorIyy1ComponentReasonCode);
        w_la.LocErrorIyy1ComponentChecksum = FixedStringAttr.valueOf(dyyy0131_oa.ExpErrorIyy1ComponentChecksum, (short)15);
        w_oa.ExpParentPreferenceId = TimestampAttr.valueOf(dyyy0131_oa.ExpParentPreferenceId);
        dyyy0131_ia.freeInstance();
        dyyy0131_ia = null;
        dyyy0131_oa.freeInstance();
        dyyy0131_oa = null;
      }
...
"                                                                                                                                                      "
  ...
  public void f_22020341_localAlloc(String abname)
  {
    ...
    w_la = (gen.ort.yyy.CYYY0131_LA)(iefRuntimeParm2.getInstance("gen.ort.yyy.CYYY0131_LA"));
    if ( w_la == null )
    {
      globdata.getStateData().setCurrentABId( "0022020341" );
...
padview[0] = PadView.getInstance("IMPORT                          ", 0, 0, 0, (short)1, PadView.VT_BASE, PadView.DT_NONE, w_ia, 
    ...
    padview[6] = PadView.getInstance("PARENT                          ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, w_ia,
       null);
    padview[7] = PadView.getInstance("PINSTANCE_ID                    ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_TIMESTAMP, w_ia, "ImpParentPinstanceId");
    padview[8] = PadView.getInstance("PREFERENCE_ID                   ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_TIMESTAMP, w_ia, "ImpParentPreferenceId");
    padview[9] = PadView.getInstance("PKEY_ATTR_TEXT                  ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_ia, "ImpParentPkeyAttrText");
    padview[10] = PadView.getInstance("PSEARCH_ATTR_TEXT               ", 25, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_ia, "ImpParentPsearchAttrText");
    padview[11] = PadView.getInstance("POTHER_ATTR_TEXT                ", 25, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_ia, "ImpParentPotherAttrText");
    padview[12] = PadView.getInstance("PTYPE_TKEY_ATTR_TEXT            ", 4, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
    ...
    padview[15] = PadView.getInstance("PARENT                          ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_oa, null);
    padview[16] = PadView.getInstance("PREFERENCE_ID                   ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, 
    ...
    padview[28] = PadView.getInstance("PARENT                          ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_la, null);
    padview[29] = PadView.getInstance("PINSTANCE_ID                    ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_TIMESTAMP, w_la, "LocImpParentPinstanceId");
    padview[30] = PadView.getInstance("PREFERENCE_ID                   ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_TIMESTAMP, w_la, "LocImpParentPreferenceId");
    ...
    padview[32] = PadView.getInstance("PSEARCH_ATTR_TEXT               ", 25, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocImpParentPsearchAttrText");
    padview[33] = PadView.getInstance("POTHER_ATTR_TEXT                ", 25, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocImpParentPotherAttrText");
    padview[34] = PadView.getInstance("PTYPE_TKEY_ATTR_TEXT            ", 4, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
    ...
    padview[38] = PadView.getInstance("PKEY_ATTR_TEXT                  ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocEmptyParentPkeyAttrText");
    padview[39] = PadView.getInstance("PSEARCH_ATTR_TEXT               ", 25, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocEmptyParentPsearchAttrText");
    padview[40] = PadView.getInstance("POTHER_ATTR_TEXT                ", 25, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocEmptyParentPotherAttrText");
    padview[41] = PadView.getInstance("PTYPE_TKEY_ATTR_TEXT            ", 4, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocEmptyParentPtypeTkeyAttrText");
    padview[42] = PadView.getInstance("LOC_ERROR                       ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    ...
    padview[51] = PadView.getInstance("LOC_GROUP_CONTEXT               ", 0, 0, 9, (short)2, PadView.VT_GROUP, PadView.DT_NONE, w_la,
       "LocGroupContext_MA");
    padview[52] = PadView.getInstance("LOC_G_CONTEXT                   ", 0, 0, 0, (short)3, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    padview[53] = PadView.getInstance("DONT_CHANGE_TEXT                ", 0, 0, 0, (short)4, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_la, null);
    padview[54] = PadView.getInstance("TEXT_150                        ", 150, 0, 0, (short)4, PadView.VT_PREDICATE, PadView.DT_TEXT,
    ...
    padview[55] = PadView.getInstance("LOC                             ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    padview[56] = PadView.getInstance("DONT_CHANGE_RETURN_CODES        ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_la, null);
    padview[57] = PadView.getInstance("1_OK                            ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocDontChangeReturnCodesQ1Ok");
    padview[58] = PadView.getInstance("N20_MANDATORY_IMPORT_MISSING    ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
    ...
    padview[62] = PadView.getInstance("104_PARENT_TYPE_KEY_ATTR_MAND   ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocDontChangeReasonCodesQ104ParentTypeKeyAttrMand");
    padview[63] = PadView.getInstance("105_PARENT_KEY_ATTR_MAND        ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocDontChangeReasonCodesQ105ParentKeyAttrMand");
    padview[64] = PadView.getInstance("106_PARENT_SEARCH_ATTR_MAND     ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYYY0131_IA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:08:12
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: CYYY0131_IA
 **/
public class CYYY0131_IA extends ViewBase implements IImportView, Serializable
{
  ...
  public CYYY0131_IA(CYYY0131_IA orig)
  {
    copyFrom(orig);
  }
  /**
  ...
  public static CYYY0131_IA getInstance()
  {
    return new CYYY0131_IA();
  }
  /**
  ...
  {
    this.copyFrom((CYYY0131_IA) orig);
  }
  
  /**
   * Sets the current instance based on the passed view.
   **/
  public void copyFrom(CYYY0131_IA orig)
  {
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYYY0131_LA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:08:12
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: CYYY0131_LA
 **/
public class CYYY0131_LA extends ViewBase implements ILocalView, Serializable
{
  // Entity View: LOC_IMP
  //        Type: PARENT
  /**
  ...
  public CYYY0131_LA(CYYY0131_LA orig)
  {
  ...
  public static CYYY0131_LA getInstance()
  {
    return new CYYY0131_LA();
  }
  /**
   * Static free instance method
   **/
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYYY0131_OA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:08:12
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: CYYY0131_OA
 **/
public class CYYY0131_OA extends ViewBase implements IExportView, Serializable
{
  // Entity View: EXP
  //        Type: PARENT
  /**
  ...
  public CYYY0131_OA(CYYY0131_OA orig)
  {
    copyFrom(orig);
  }
  /**
  ...
  public static CYYY0131_OA getInstance()
  {
    return new CYYY0131_OA();
  }
  /**
   * Static free instance method
   **/
  ...
  {
    this.copyFrom((CYYY0131_OA) orig);
  }
  
  /**
   * Sets the current instance based on the passed view.
   **/
  public void copyFrom(CYYY0131_OA orig)
  {

...
//
//    Name: DYYY0111_PARENT_CREATE           Date: 2023/07/05
//    Target OS:   JVM                       Time: 15:08:18
...
public class DYYY0111 extends ABBase
{
  // * * * * * * * * * * * * * * * * * * *
  ...
  // * * * * * * * * * * * * * * * * * * *
  String sl_29360135 = ErrorData.NONE_FL_LS;
  String cr_26214420 = ErrorData.NONE_FL_LS;
  String Parent_es;
  String Parent_001cd;
  String Parent_lk;
  String Type_es;
   ...
   **/
  public class DYYY0111_EA extends ViewBase implements IEntityActionView, Serializable
  {
    // Entity View: 
    //        Type: PARENT
    /**
  ...
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  DYYY0111_EA w_ea = new DYYY0111_EA();
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  ...
  // CURSOR OPEN FLAGS
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  boolean curs_open_0029360135 = false;
  ...
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  String pkey_attr_003EF;
  String pkey_attr_004EN;
  String psearch_attr_005EF;
  String psearch_attr_006EN;
  String pother_attr_007EF;
  String pother_attr_008EN;
  String pcreate_userid_009EF;
  String pcreate_userid_010EN;
  String pupdate_userid_011EF;
  String pupdate_userid_012EN;
  java.sql.Timestamp pinstance_id_013EF;
  java.sql.Timestamp pinstance_id_014EN;
  java.sql.Timestamp preference_id_015EF;
  java.sql.Timestamp preference_id_016EN;
  String ptype_tkey_attr_te_017EF;
  String ptype_tkey_attr_te_018EN;
  ...
  //    FOLLOW AS NEEDED:             
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  boolean func_0022020280_esc_flag;
  PreparedStatement hstmt_0037954512_1;
  ResultSet hstmt_0037954512_1_rs;
  int hstmt_0037954512_1_cnt;
  boolean func_0020972390_esc_flag;
  PreparedStatement hstmt_0026214420_1;
  ResultSet hstmt_0026214420_1_rs;
  int hstmt_0026214420_1_cnt;
  PadView padview[] = new PadView [61];
  int trace_ret_code;
  PadText padtext[] = initPadText();
  public PadText [] initPadText()
  {
    PadText [] result = new PadText [PADTEXT_SIZE];
    result[0] = PadText.getInstance(   0,"+->   DYYY0111_PARENT_CREATE            07/05/2023  15:08");
    ...
    result[15] = PadText.getInstance(   0,"!           pkey_attr_text");
    result[16] = PadText.getInstance(   0,"!           psearch_attr_text");
    result[17] = PadText.getInstance(   0,"!           pother_attr_text");
    result[18] = PadText.getInstance(   0,"!           ptype_tkey_attr_text");
    result[19] = PadText.getInstance(   0,"!       EXPORTS:");
    result[20] = PadText.getInstance(   0,"!         Entity View exp parent (Transient, Export only)");
    ...
    result[33] = PadText.getInstance(   0,"!           preference_id");
    result[34] = PadText.getInstance(   0,"!           pcreate_user_id");
    ...
    result[48] = PadText.getInstance(   0,"!           101_parent_not_found");
    result[49] = PadText.getInstance(   0,"!           102_parent_already_exist");
    result[50] = PadText.getInstance(   0,"!           103_parent_attr_value_invalid");
    result[51] = PadText.getInstance(   0,"!           111_parents_type_not_found");
    ...
    result[56] = PadText.getInstance(   1,"!  See the description for the purpose");
    ...
    result[66] = PadText.getInstance(   5,"!  The used ReturnCode/ReasonCode values");
    result[67] = PadText.getInstance(   5,"!  ");
    result[68] = PadText.getInstance(   6,"!  NOTE: ");
    result[69] = PadText.getInstance(   6,"!  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[70] = PadText.getInstance(   6,"!  Set the return and reason codes below");
    result[71] = PadText.getInstance(   6,"!  ");
    result[72] = PadText.getInstance(   7,"!  SET loc dont_change_return_codes 1_ok TO 1 ");
    result[73] = PadText.getInstance(   8,"!  SET loc dont_change_return_codes n40_obj_create_failed TO -40 ");
    result[74] = PadText.getInstance(   9,"!   ");
    result[75] = PadText.getInstance(  10,"!  SET loc dont_change_reason_codes 1_default TO 1 ");
    result[76] = PadText.getInstance(  11,"!  SET loc dont_change_reason_codes 102_parent_already_exist TO 102 ");
    result[77] = PadText.getInstance(  12,"!  SET loc dont_change_reason_codes 103_parent_attr_value_invalid TO 103 ");
    result[78] = PadText.getInstance(  13,"!  SET loc dont_change_reason_codes 111_parents_type_not_found TO 111 ");
    result[79] = PadText.getInstance(  14,"!   ");
    result[80] = PadText.getInstance(  15,"!  NOTE: ");
    result[81] = PadText.getInstance(  15,"!  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[82] = PadText.getInstance(  15,"!  If the operation depends on 'type' data type");
    result[83] = PadText.getInstance(  15,"!  protect the 'READ type' operation below, delete if not.");
    result[84] = PadText.getInstance(  15,"!  ");
    result[85] = PadText.getInstance(  16,"!  NOTE: ");
    result[86] = PadText.getInstance(  16,"!  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[87] = PadText.getInstance(  16,"!  Choose Control of Cursor Generation property as \"Select only\".");
    result[88] = PadText.getInstance(  16,"!  ");
    result[89] = PadText.getInstance(  17,"!  +=>READ (Select Only) type");
    result[90] = PadText.getInstance(  17,"!  !        WHERE DESIRED type tkey_attr_text = imp parent ptype_tkey_attr_text");
    result[91] = PadText.getInstance(  17, 1, "!  +> WHEN successful");
    result[92] = PadText.getInstance(  18,"!  !  +->CREATE parent");
    result[93] = PadText.getInstance(  19,"!  !  !  SET pinstance_id TO imp parent pinstance_id ");
    result[94] = PadText.getInstance(  20,"!  !  !  SET preference_id TO imp_reference iyy1_server_data reference_id ");
    result[95] = PadText.getInstance(  21,"!  !  !  SET pcreate_user_id TO imp_reference iyy1_server_data userid ");
    result[96] = PadText.getInstance(  22,"!  !  !  SET pupdate_user_id TO imp_reference iyy1_server_data userid ");
    result[97] = PadText.getInstance(  23,"!  !  !  SET pkey_attr_text TO imp parent pkey_attr_text ");
    result[98] = PadText.getInstance(  24,"!  !  !  SET psearch_attr_text TO imp parent psearch_attr_text ");
    result[99] = PadText.getInstance(  25,"!  !  !  SET pother_attr_text TO imp parent pother_attr_text ");
    result[100] = PadText.getInstance(  26,"!  !  !  SET ptype_tkey_attr_text TO imp parent ptype_tkey_attr_text ");
    result[101] = PadText.getInstance(  18, 1, "!  !  +> WHEN successful");
    result[102] = PadText.getInstance(  27,"!  !  !  SET exp parent preference_id TO imp_reference iyy1_server_data reference_id ");
    result[103] = PadText.getInstance(  18, 2, "!  !  +> WHEN already exists");
    result[104] = PadText.getInstance(  28,
      "!  !  !  SET exp_error iyy1_component return_code TO loc dont_change_return_codes n40_obj_create_failed ");
    result[105] = PadText.getInstance(  29,
      "!  !  !  SET exp_error iyy1_component reason_code TO loc dont_change_reason_codes 102_parent_already_exist ");
    result[106] = PadText.getInstance(  18, 3, "!  !  +> WHEN permitted value violation");
    result[107] = PadText.getInstance(  30,
      "!  !  !  SET exp_error iyy1_component return_code TO loc dont_change_return_codes n40_obj_create_failed ");
    result[108] = PadText.getInstance(  31,
      "!  !  !  SET exp_error iyy1_component reason_code TO loc dont_change_reason_codes 103_parent_attr_value_invalid ");
    result[109] = PadText.getInstance(  18,"!  !  +--");
    result[110] = PadText.getInstance(  17, 2, "!  +> WHEN not found");
    ...
    result[113] = PadText.getInstance(  17,"!  +--");
    result[114] = PadText.getInstance(   0,"+---");
    result[115] = PadText.getInstance(PadText.LASTLINE,"************************* BOTTOM OF DATA *************************");
    return result;
  }
  final static int PADTEXT_SIZE = 116;
  ...
  public void DYYY0111( Object in_runtime_parm1, 
  	...
  	throws ABException
  {
    ...
    {
      f_29360135();
      if ( sl_29360135.equals( ErrorData.SUCCEEDS_FL_LS ) == true )
      {
      ...
      else if ( sl_29360135.equals( ErrorData.NOT_FOUND_FL_LS ) == true )
      {
  	...
  	throws ABException
  {
    ...
    if ( trace_ret_code != 8 )
    {
      w_ea.ParentPinstanceId = TimestampAttr.valueOf(w_ia.ImpParentPinstanceId);
      w_ea.ParentPreferenceId = TimestampAttr.valueOf(w_ia.ImpReferenceIyy1ServerDataReferenceId);
      w_ea.ParentPcreateUserId = FixedStringAttr.valueOf(w_ia.ImpReferenceIyy1ServerDataUserid, (short)8);
      w_ea.ParentPupdateUserId = FixedStringAttr.valueOf(w_ia.ImpReferenceIyy1ServerDataUserid, (short)8);
      w_ea.ParentPkeyAttrText = FixedStringAttr.valueOf(w_ia.ImpParentPkeyAttrText, (short)5);
      ...
      valChkDBError = false;
      f_26214420();
      if ( cr_26214420.equals( ErrorData.SUCCEEDS_FL_LS ) == true )
      {
        globdata.getStateData().setLastSubStatementNumber( "1" );
        f_0_trace();
        {
          ...
          if ( trace_ret_code != 8 )
          {
            w_oa.ExpParentPreferenceId = TimestampAttr.valueOf(w_ia.ImpReferenceIyy1ServerDataReferenceId);
          }
        }
      }
      else if ( cr_26214420.equals( ErrorData.DUPLICATE_FOUND_FL_LS ) == true )
      {
        globdata.getStateData().setLastSubStatementNumber( "2" );
        f_0_trace();
        {
      ...
      else if ( cr_26214420.equals( ErrorData.INVALID_DATAB_PERM_FL_LS ) == true )
      {
  ...
  public void f_22020280_localAlloc(String abname)
  {
    ...
    w_la = (gen.ort.yyy.DYYY0111_LA)(iefRuntimeParm2.getInstance("gen.ort.yyy.DYYY0111_LA"));
    if ( w_la == null )
    {
      globdata.getStateData().setCurrentABId( "0022020280" );
  	...
  	throws ABException
  {
    ...
    pkey_attr_003EF = SPACES;
    pkey_attr_004EN = SPACES;
    psearch_attr_005EF = SPACES;
    psearch_attr_006EN = SPACES;
    pother_attr_007EF = SPACES;
    pother_attr_008EN = SPACES;
    pcreate_userid_009EF = SPACES;
    pcreate_userid_010EN = SPACES;
    pupdate_userid_011EF = SPACES;
    pupdate_userid_012EN = SPACES;
    pinstance_id_013EF = TIRVW2S.TIRVW2S(globdata, "IEFDB", "00010101000000000000");
    pinstance_id_014EN = TIRVW2S.TIRVW2S(globdata, "IEFDB", "00010101000000000000");
    preference_id_015EF = TIRVW2S.TIRVW2S(globdata, "IEFDB", "00010101000000000000");
    preference_id_016EN = TIRVW2S.TIRVW2S(globdata, "IEFDB", "00010101000000000000");
    ptype_tkey_attr_te_017EF = SPACES;
    ptype_tkey_attr_te_018EN = SPACES;
    if ( nestingLevel < 2 )
    {
      w_la.reset();
    }
...
padview[0] = PadView.getInstance("IMPORT                          ", 0, 0, 0, (short)1, PadView.VT_BASE, PadView.DT_NONE, w_ia, 
    ...
    padview[18] = PadView.getInstance("PSEARCH_ATTR_TEXT               ", 25, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_ia, "ImpParentPsearchAttrText");
    padview[19] = PadView.getInstance("POTHER_ATTR_TEXT                ", 25, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_ia, "ImpParentPotherAttrText");
    padview[20] = PadView.getInstance("PTYPE_TKEY_ATTR_TEXT            ", 4, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
    ...
    padview[23] = PadView.getInstance("PARENT                          ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_oa, null);
    padview[24] = PadView.getInstance("PREFERENCE_ID                   ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, 
    ...
    padview[56] = PadView.getInstance("101_PARENT_NOT_FOUND            ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocDontChangeReasonCodesQ101ParentNotFound");
    padview[57] = PadView.getInstance("102_PARENT_ALREADY_EXIST        ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocDontChangeReasonCodesQ102ParentAlreadyExist");
    padview[58] = PadView.getInstance("103_PARENT_ATTR_VALUE_INVALID   ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocDontChangeReasonCodesQ103ParentAttrValueInvalid");
    padview[59] = PadView.getInstance("111_PARENTS_TYPE_NOT_FOUND      ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocDontChangeReasonCodesQ111ParentsTypeNotFound");
    padview[60] = PadView.getInstance("******** BOTTOM OF DATA ********", 0, 0, 0, (short)0, PadView.VT_END, PadView.DT_NONE, w_la, 
      null);
  }
  public void f_29360135()
  	throws ABException
  {
    sl_29360135 = ErrorData.SUCCEEDS_FL_LS;
    ...
    if ( sl_29360135.equals( ErrorData.SUCCEEDS_FL_LS ) == true )
    {
      ...
      try {
        ...
        SQLStatement.append("VDVYYYT01.`TKEY_ATTR` = ?");
        SQLStatement.append(")");
        hstmt_0037954512_1 = globdata.getDBMSData().getDBMSManager().getStatement(globdata, iefRuntimeParm2, "IEFDB", 
          SQLStatement.toString());
        globdata.getDBMSData().getDBMSManager().bindParameterString("IEFDB", hstmt_0037954512_1, 1, PtypeTkeyAttrText_001TP);
        hstmt_0037954512_1.execute();
        hstmt_0037954512_1_rs = hstmt_0037954512_1.getResultSet();
        if ( hstmt_0037954512_1_rs.next() == false )
        {
          throw new SQLException("No data found");
        }
        tkey_attr_001EF = globdata.getDBMSData().getDBMSManager().getStringFromResultSet("IEFDB", hstmt_0037954512_1_rs, 1);
        if ( hstmt_0037954512_1_rs.next() == true )
        {
      ...
      {
        f_29360135_movea();
        if ( sl_29360135.equals( ErrorData.SUCCEEDS_FL_LS ) )
        {
          Type_es = ABBase.EV_USABLE;
        }
        else {
        ...
        try {
          ...
          if ( hstmt_0037954512_1 != null )
          {
            hstmt_0037954512_1.close();
            hstmt_0037954512_1 = null;
          }
        } catch( SQLException e ) {
          if ( globdata.getDBMSData().getDBMSManager().wasSuccessful(e) == false )
          {
            sqlException = e;
            f_29360135_jdbc_dberror();
          }
        }
      }
      else if ( globdata.getDBMSData().getDBMSManager().wasNoDataFound(sqlException) )
      {
        sl_29360135 = ErrorData.NOT_FOUND_FL_LS;
        Type_es = ABBase.EV_UNUSABLE;
        try {
          if ( hstmt_0037954512_1_rs != null )
          {
  ...
  public void f_29360135_jdbc_dberror()
  	throws ABException
  {
    globdata.getErrorData().setStatus( ErrorData.FATAL_ERROR_FL_LS );
  ...
  public void f_29360135_moveb()
  	throws ABException
  {
    PtypeTkeyAttrText_001TP = w_ia.ImpParentPtypeTkeyAttrText;
  }
  ...
  {
    pinstance_id_014EN = TIRVW2S.TIRVW2S(globdata, "IEFDB", w_ea.ParentPinstanceId);
    preference_id_016EN = TIRVW2S.TIRVW2S(globdata, "IEFDB", w_ea.ParentPreferenceId);
    pcreate_userid_010EN = w_ea.ParentPcreateUserId;
    pupdate_userid_012EN = w_ea.ParentPupdateUserId;
    pkey_attr_004EN = w_ea.ParentPkeyAttrText;
    psearch_attr_006EN = w_ea.ParentPsearchAttrText;
    pother_attr_008EN = w_ea.ParentPotherAttrText;
    ptype_tkey_attr_te_018EN = w_ea.ParentPtypeTkeyAttrText;
  }
  public void f_26214420()
  	throws ABException
  {
    cr_26214420 = ErrorData.SUCCEEDS_FL_LS;
    Parent_001cd = ABBase.PV_CREATE;
    f_26214420_moveb();
    ...
    if ( cr_26214420.equals( ErrorData.SUCCEEDS_FL_LS ) == true )
    {
      ...
      try {
        ...
        SQLStatement.append("?");
        SQLStatement.append(")");
        hstmt_0026214420_1 = globdata.getDBMSData().getDBMSManager().getStatement(globdata, iefRuntimeParm2, "IEFDB", 
          SQLStatement.toString());
        globdata.getDBMSData().getDBMSManager().bindParameterString("IEFDB", hstmt_0026214420_1, 1, pkey_attr_004EN);
        globdata.getDBMSData().getDBMSManager().bindParameterString("IEFDB", hstmt_0026214420_1, 2, psearch_attr_006EN);
        globdata.getDBMSData().getDBMSManager().bindParameterString("IEFDB", hstmt_0026214420_1, 3, pother_attr_008EN);
        globdata.getDBMSData().getDBMSManager().bindParameterString("IEFDB", hstmt_0026214420_1, 4, pcreate_userid_010EN);
        globdata.getDBMSData().getDBMSManager().bindParameterString("IEFDB", hstmt_0026214420_1, 5, pupdate_userid_012EN);
        hstmt_0026214420_1.setTimestamp(6, pinstance_id_014EN);
        hstmt_0026214420_1.setTimestamp(7, preference_id_016EN);
        globdata.getDBMSData().getDBMSManager().bindParameterString("IEFDB", hstmt_0026214420_1, 8, ptype_tkey_attr_te_018EN);
        hstmt_0026214420_1.execute();
        hstmt_0026214420_1_rs = hstmt_0026214420_1.getResultSet();
        hstmt_0026214420_1_cnt = hstmt_0026214420_1.getUpdateCount();
      } catch( SQLException e ) {
        sqlException = e;
      }
      if ( globdata.getDBMSData().getDBMSManager().wasSuccessful(sqlException) )
      {
        pkey_attr_003EF = pkey_attr_004EN;
        psearch_attr_005EF = psearch_attr_006EN;
        pother_attr_007EF = pother_attr_008EN;
        pcreate_userid_009EF = pcreate_userid_010EN;
        pupdate_userid_011EF = pupdate_userid_012EN;
        pinstance_id_013EF = pinstance_id_014EN;
        preference_id_015EF = preference_id_016EN;
        ptype_tkey_attr_te_017EF = ptype_tkey_attr_te_018EN;
        ...
        try {
          ...
          if ( hstmt_0026214420_1 != null )
          {
            hstmt_0026214420_1.close();
            hstmt_0026214420_1 = null;
          }
        } catch( SQLException e ) {
          if ( globdata.getDBMSData().getDBMSManager().wasSuccessful(e) == false )
          {
            sqlException = e;
            f_26214420_jdbc_dberror();
          }
        }
      }
      else if ( globdata.getDBMSData().getDBMSManager().wasDuplicateFound("IEFDB", sqlException) )
      {
        cr_26214420 = ErrorData.DUPLICATE_FOUND_FL_LS;
        Parent_es = ABBase.EV_UNUSABLE;
        try {
          if ( hstmt_0026214420_1_rs != null )
          {
    ...
    else if ( cr_26214420.equals( ErrorData.INVALID_DATAB_PERM_FL_LS ) == false )
    {
      globdata.getErrorData().setStatus( ErrorData.FATAL_ERROR_FL_LS );
  ...
  public void f_26214420_jdbc_dberror()
  	throws ABException
  {
    globdata.getErrorData().setStatus( ErrorData.FATAL_ERROR_FL_LS );
    globdata.getDBMSData().setActionId( 18 );
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: DYYY0111_IA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:08:18
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 ...
 **/
public class DYYY0111_IA extends ViewBase implements IImportView, Serializable
{
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: DYYY0111_LA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:08:18
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 ...
 **/
public class DYYY0111_LA extends ViewBase implements ILocalView, Serializable
{
  // Entity View: LOC
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: DYYY0111_OA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:08:18
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: DYYY0111_OA
 **/
public class DYYY0111_OA extends ViewBase implements IExportView, Serializable
{
  // Entity View: EXP
  //        Type: PARENT
  /**
  ...
  public DYYY0111_OA(DYYY0111_OA orig)
  {
    copyFrom(orig);
  }
  /**
  ...
  public static DYYY0111_OA getInstance()
  {
    return new DYYY0111_OA();
  }
  /**
   * Static free instance method
   **/
  ...
  {
    this.copyFrom((DYYY0111_OA) orig);
  }
  
  /**
   * Sets the current instance based on the passed view.
   **/
  public void copyFrom(DYYY0111_OA orig)
  {

...
//
//    Name: CYYY9811_SET_EXCPTN_OTHER_ERROR  Date: 2023/07/05
...
public class CYYY9811 extends ABBase
{
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  ...
  //    FOLLOW AS NEEDED:             
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  boolean func_0022020212_esc_flag;
  ...
  public PadText [] initPadText()
  {
    ...
    result[0] = PadText.getInstance(   0,"+->   CYYY9811_SET_EXCPTN_OTHER_ERROR   07/05/2023  15:07");
    ...
    result[19] = PadText.getInstance(   3,"!  ");
    result[20] = PadText.getInstance(   3,"!  Recommended return_code = -1999");
    result[21] = PadText.getInstance(   3,"!           reason_code =     1");
  ...
  //       +->   CYYY9811_SET_EXCPTN_OTHER_ERROR   07/05/2023  15:07
  //       !       EXPORTS:
  ...
  public void CYYY9811( Object in_runtime_parm1, 
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYYY9811_OA                      Date: 2023/07/05
 ...
 **/
public class CYYY9811_OA extends ViewBase implements IExportView, Serializable
{

...
//
//    Name: CYY1S091_PARENT_CHILD_DBL_LIST   Date: 2023/07/05
//    Target OS:   JVM                       Time: 15:09:39
...
public class CYY1S091 extends ABBase
{
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  ...
  //    FOLLOW AS NEEDED:             
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  boolean func_0022020104_esc_flag;
  boolean func_0020973096_esc_flag;
  boolean func_0020971623_esc_flag;
  boolean func_0020971753_esc_flag;
  boolean func_0020972771_esc_flag;
  ...
  public PadText [] initPadText()
  {
    ...
    result[0] = PadText.getInstance(   0,"+->   CYY1S091_PARENT_CHILD_DBL_LIST    07/05/2023  15:09");
    ...
    result[14] = PadText.getInstance(   0,"!         Work View exp_reference iyy1_server_data (Transient, Export only)");
    result[15] = PadText.getInstance(   0,"!           server_date");
    result[16] = PadText.getInstance(   0,"!           server_time");
    result[17] = PadText.getInstance(   0,"!           reference_id");
    result[18] = PadText.getInstance(   0,"!         Entity View exp isc1_authorization_info (Transient, Export only)");
    result[19] = PadText.getInstance(   0,"!           token_id");
    result[20] = PadText.getInstance(   0,"!           authority_ind");
    result[21] = PadText.getInstance(   0,"!           authority_status_r");
    result[22] = PadText.getInstance(   0,"!           authority_status_u");
    result[23] = PadText.getInstance(   0,"!           authority_status_d");
    result[24] = PadText.getInstance(   0,"!           authority_status_l");
    ...
    result[65] = PadText.getInstance(   0,"!           1_ok");
    result[66] = PadText.getInstance(   0,"!           n1120_invalid_command");
    result[67] = PadText.getInstance(   0,"!         Work View loc dont_change_reason_codes");
    result[68] = PadText.getInstance(   0,"!           1_default");
    ...
    result[73] = PadText.getInstance(   1,"!  PURPOSE(CONTINUED)");
    result[74] = PadText.getInstance(   2,"!   ");
    result[75] = PadText.getInstance(   3,"!  NOTE: ");
    result[76] = PadText.getInstance(   3,"!  PRE-CONDITION:");
    result[77] = PadText.getInstance(   3,"!  INIT command, user info is given.");
    result[78] = PadText.getInstance(   3,"!  POST-CONDITION:");
    result[79] = PadText.getInstance(   3,"!  Security check results are generated.");
    result[80] = PadText.getInstance(   3,"!  RETURN CODE = 1, REASON CODE = 1");
    result[81] = PadText.getInstance(   4,"!   ");
    result[82] = PadText.getInstance(   5,"!  NOTE: ");
    result[83] = PadText.getInstance(   5,"!  PRE-CONDITION:");
    result[84] = PadText.getInstance(   5,"!  An invalid operation code is given.");
    result[85] = PadText.getInstance(   5,"!  POST-CONDITION:");
    result[86] = PadText.getInstance(   5,"!  No result is generated.");
    result[87] = PadText.getInstance(   5,"!  RETURN CODE = -1120, REASON CODE = 1");
    result[88] = PadText.getInstance(   5,"!  ");
    result[89] = PadText.getInstance(   6,"!  NOTE: ");
    result[90] = PadText.getInstance(   6,"!  RETURN / REASON  CODES");
    result[91] = PadText.getInstance(   6,"!  +1/1 Normal");
    result[92] = PadText.getInstance(   6,"!  -1120/1 Erronous command");
    result[93] = PadText.getInstance(   7,"!   ");
    result[94] = PadText.getInstance(   8,"!  NOTE: ");
    result[95] = PadText.getInstance(   8,"!  RELEASE HISTORY");
    result[96] = PadText.getInstance(   8,"!  01_00 23-02-1998 New release");
    result[97] = PadText.getInstance(   9,"!   ");
    result[98] = PadText.getInstance(  10,"!  USE cyyy9001_exception_hndlng_dflt");
    result[99] = PadText.getInstance(  10,
      "!     WHICH EXPORTS: Work View exp_error iyy1_component FROM Work View exp_error iyy1_component");
    result[100] = PadText.getInstance(  11,"!   ");
    result[101] = PadText.getInstance(  12,"!  NOTE: ");
    result[102] = PadText.getInstance(  12,"!  **************************************************************");
    result[103] = PadText.getInstance(  12,"!  Return/Reason code values");
    result[104] = PadText.getInstance(  12,"!  ");
    result[105] = PadText.getInstance(  13,"!  NOTE: ");
    result[106] = PadText.getInstance(  13,"!  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[107] = PadText.getInstance(  13,"!  Set the values of the return code/reason codes used");
    result[108] = PadText.getInstance(  13,"!  ");
    result[109] = PadText.getInstance(  14,"!  SET loc dont_change_return_codes 1_ok TO 1 ");
    result[110] = PadText.getInstance(  15,"!  SET loc dont_change_return_codes n1120_invalid_command TO -1120 ");
    result[111] = PadText.getInstance(  16,"!   ");
    result[112] = PadText.getInstance(  17,"!  SET loc dont_change_reason_codes 1_default TO 1 ");
    result[113] = PadText.getInstance(  18,"!   ");
    result[114] = PadText.getInstance(  19,"!  NOTE: ");
    result[115] = PadText.getInstance(  19,"!  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[116] = PadText.getInstance(  19,"!  Name the procedure below");
    result[117] = PadText.getInstance(  19,"!  ");
    result[118] = PadText.getInstance(  20,"!  SET SUBSCRIPT OF loc_group_context TO 1 ");
    result[119] = PadText.getInstance(  21,"!  SET loc_g_context dont_change_text text_150 TO \"CYY1S091\" ");
    result[120] = PadText.getInstance(  22,"!  SET SUBSCRIPT OF loc_group_context TO 2 ");
    result[121] = PadText.getInstance(  23,
      "!  SET loc_g_context dont_change_text text_150 TO imp_command iyy1_component send_command ");
    result[122] = PadText.getInstance(  24,"!   ");
    result[123] = PadText.getInstance(  25,"!  USE cyy1a131_server_init");
    result[124] = PadText.getInstance(  25,
      "!     WHICH EXPORTS: Work View loc_reference iyy1_server_data FROM Work View exp_reference iyy1_server_data");
    result[125] = PadText.getInstance(  26,"!  MOVE loc_reference iyy1_server_data TO exp_reference iyy1_server_data");
    result[126] = PadText.getInstance(  27,"!   ");
    result[127] = PadText.getInstance(  28,"!  NOTE: ");
    result[128] = PadText.getInstance(  28,"!  ****************************************************************");
    result[129] = PadText.getInstance(  28,"!  Security check");
    result[130] = PadText.getInstance(  28,"!  ");
    result[131] = PadText.getInstance(  29,"!  USE isc1z021_o_authorization_check_s");
    ...
    result[133] = PadText.getInstance(  29,
    ...
    result[135] = PadText.getInstance(  30,"!   ");
    result[136] = PadText.getInstance(  31,"!  +->IF loc_error isc1_component return_code < loc dont_change_return_codes 1_ok");
    result[137] = PadText.getInstance(  32,"!  !  USE cyyy9831_mv_sc1_to_yy1");
    result[138] = PadText.getInstance(  32,
      "!  !     WHICH IMPORTS: Work View loc_error isc1_component TO Work View imp_error isc1_component");
    result[139] = PadText.getInstance(  32,
      "!  !     WHICH EXPORTS: Work View exp_error iyy1_component FROM Work View exp_error iyy1_component");
    result[140] = PadText.getInstance(  31,"!  +--");
    result[141] = PadText.getInstance(  33,"!   ");
    result[142] = PadText.getInstance(  34,"!  NOTE: ");
    result[143] = PadText.getInstance(  34,"!  ****************************************************************");
    result[144] = PadText.getInstance(  34,"!  All essential Server controls are being made...");
    result[145] = PadText.getInstance(  34,"!  ");
    result[146] = PadText.getInstance(  35,"!  +->IF exp_error iyy1_component return_code = loc dont_change_return_codes 1_ok");
    result[147] = PadText.getInstance(  36,"!  !   ");
    result[148] = PadText.getInstance(  37,"!  !  NOTE: ");
    result[149] = PadText.getInstance(  37,"!  !  ****************************************************************");
    result[150] = PadText.getInstance(  37,"!  !  Check the operation wanted.");
    result[151] = PadText.getInstance(  37,"!  !  ");
    result[152] = PadText.getInstance(  38,"!  !  SET loc_reference iyy1_server_data userid TO imp isc1_authorization_info userid ")
      ;
    result[153] = PadText.getInstance(  39,"!  !   ");
    result[154] = PadText.getInstance(  40,"!  !  +->CASE OF imp_command iyy1_component send_command");
    result[155] = PadText.getInstance(  40, 1, "!  !  +> CASE \"INIT\"");
    result[156] = PadText.getInstance(  40, 2, "!  !  +> OTHERWISE");
    result[157] = PadText.getInstance(  41,
    ...
    result[159] = PadText.getInstance(  43,"!  !  !  SET SUBSCRIPT OF loc_group_context TO 3 ");
    result[160] = PadText.getInstance(  44,
      "!  !  !  SET loc_g_context dont_change_text text_150 TO imp_command iyy1_component send_command ");
    result[161] = PadText.getInstance(  40,"!  !  +--");
    result[162] = PadText.getInstance(  45,"!  !   ");
    result[163] = PadText.getInstance(  46,"!  !  NOTE: ");
    result[164] = PadText.getInstance(  46,"!  !  ****************************************************************");
    result[165] = PadText.getInstance(  46,"!  !  OK. Nothing left to control. Let' s build Context string.");
    result[166] = PadText.getInstance(  46,"!  !  ");
    result[167] = PadText.getInstance(  47,"!  !  NOTE: ");
    result[168] = PadText.getInstance(  47,"!  !  ****************************************************************");
    result[169] = PadText.getInstance(  47,"!  !  Generate Context string whether there is an error or not.");
    result[170] = PadText.getInstance(  47,"!  !  There' s message to return in error-free condition.");
    result[171] = PadText.getInstance(  47,"!  !  ");
    result[172] = PadText.getInstance(  48,"!  !  USE cyyy9141_context_string_set");
    result[173] = PadText.getInstance(  48,"!  !     WHICH IMPORTS: Group View  loc_group_context TO Group View imp_group_context");
    result[174] = PadText.getInstance(  48,
      "!  !     WHICH EXPORTS: Work View loc_context iyy1_component FROM Work View exp_context iyy1_component");
    result[175] = PadText.getInstance(  48,
      "!  !                    Work View loc_error iyy1_component FROM Work View exp_error iyy1_component");
    result[176] = PadText.getInstance(  49,"!  !  +->IF loc_error iyy1_component return_code < loc dont_change_return_codes 1_ok");
    result[177] = PadText.getInstance(  50,"!  !  !  MOVE loc_error iyy1_component TO exp_error iyy1_component");
    result[178] = PadText.getInstance(  49, 1, "!  !  +> ELSE");
    result[179] = PadText.getInstance(  51,
      "!  !  !  SET exp_error iyy1_component context_string TO loc_context iyy1_component context_string ");
    result[180] = PadText.getInstance(  49,"!  !  +--");
    result[181] = PadText.getInstance(  35,"!  +--");
    result[182] = PadText.getInstance(  52,"!   ");
    result[183] = PadText.getInstance(  53,"!  NOTE: ");
    result[184] = PadText.getInstance(  53,"!  ****************************************************************");
    result[185] = PadText.getInstance(  53,"!  Everything' s OK. Nothing left to control.");
    result[186] = PadText.getInstance(  53,"!  ");
    result[187] = PadText.getInstance(  54,"!  +->IF exp_error iyy1_component return_code = loc dont_change_return_codes 1_ok");
    result[188] = PadText.getInstance(  55,"!  !   ");
    result[189] = PadText.getInstance(  56,"!  !  +->CASE OF imp_command iyy1_component send_command");
    result[190] = PadText.getInstance(  56, 1, "!  !  +> CASE \"INIT\"");
    result[191] = PadText.getInstance(  57,"!  !  !   ");
    result[192] = PadText.getInstance(  58,"!  !  !  NOTE: ");
    result[193] = PadText.getInstance(  58,"!  !  !  ****************************************************************");
    result[194] = PadText.getInstance(  58,"!  !  !  Things to be done when the Server is initially called.");
    result[195] = PadText.getInstance(  58,"!  !  !  ");
    result[196] = PadText.getInstance(  59,"!  !  !  NOTE: ");
    result[197] = PadText.getInstance(  59,"!  !  !  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[198] = PadText.getInstance(  59,"!  !  !  Encode the Things to be done when the Server is initially called.");
    result[199] = PadText.getInstance(  59,"!  !  !  ");
    result[200] = PadText.getInstance(  56,"!  !  +--");
    result[201] = PadText.getInstance(  54,"!  +--");
    result[202] = PadText.getInstance(  60,"!   ");
    result[203] = PadText.getInstance(  61,"!  USE cyy1a121_server_termination");
    result[204] = PadText.getInstance(  61,
      "!     WHICH IMPORTS: Work View exp_error iyy1_component TO Work View imp_error iyy1_component");
    result[205] = PadText.getInstance(  61,
      "!                    Work View imp_dialect iyy1_component TO Work View imp_dialect iyy1_component");
    result[206] = PadText.getInstance(  61,
      "!     WHICH EXPORTS: Work View exp_msg iyy1_component FROM Work View exp_error_msg iyy1_component");
    result[207] = PadText.getInstance(  61,
      "!                    Work View exp_error iyy1_component FROM Work View exp_error iyy1_component");
    result[208] = PadText.getInstance(   0,"+---");
    result[209] = PadText.getInstance(PadText.LASTLINE,"************************* BOTTOM OF DATA *************************");
    return result;
  }
  final static int PADTEXT_SIZE = 210;
  ...
  public void CYY1S091( Object in_runtime_parm1, 
  	...
  	throws ABException
  {
    ...
    if ( trace_ret_code != 8 )
    {
      w_la.LocGContextDontChangeTextText150[LocGroupContext_PS_001-1] = FixedStringAttr.valueOf("CYY1S091", (short)150);
      f_173015108_rgvc();
    }
...
"                                                                                                                                                      "
  ...
  public void f_20971753()
  	throws ABException
  {
    func_0020971753_esc_flag = false;
  ...
  public void f_20972771()
  	throws ABException
  {
    func_0020972771_esc_flag = false;
  ...
  public void f_22020104_localAlloc(String abname)
  {
    ...
    w_la = (gen.ort.yyy.CYY1S091_LA)(iefRuntimeParm2.getInstance("gen.ort.yyy.CYY1S091_LA"));
    if ( w_la == null )
    {
      globdata.getStateData().setCurrentABId( "0022020104" );
...
padview[0] = PadView.getInstance("IMPORT                          ", 0, 0, 0, (short)1, PadView.VT_BASE, PadView.DT_NONE, w_ia, 
    ...
    padview[15] = PadView.getInstance("EXPORT                          ", 0, 0, 0, (short)1, PadView.VT_BASE, PadView.DT_NONE, w_oa, 
      "w_oa");
    padview[16] = PadView.getInstance("EXP_REFERENCE                   ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_oa, 
      null);
    padview[17] = PadView.getInstance("IYY1_SERVER_DATA                ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_oa, null);
    padview[18] = PadView.getInstance("SERVER_DATE                     ", 8, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_DATE, 
      w_oa, "ExpReferenceIyy1ServerDataServerDate");
    padview[19] = PadView.getInstance("SERVER_TIME                     ", 6, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TIME, 
      w_oa, "ExpReferenceIyy1ServerDataServerTime");
    padview[20] = PadView.getInstance("REFERENCE_ID                    ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_TIMESTAMP, w_oa, "ExpReferenceIyy1ServerDataReferenceId");
    padview[21] = PadView.getInstance("EXP                             ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_oa, 
      null);
    padview[22] = PadView.getInstance("ISC1_AUTHORIZATION_INFO         ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_oa, null);
    padview[23] = PadView.getInstance("TOKEN_ID                        ", 32, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpIsc1AuthorizationInfoTokenId");
    padview[24] = PadView.getInstance("AUTHORITY_IND                   ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpIsc1AuthorizationInfoAuthorityInd");
    padview[25] = PadView.getInstance("AUTHORITY_STATUS_R              ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpIsc1AuthorizationInfoAuthorityStatusR");
    padview[26] = PadView.getInstance("AUTHORITY_STATUS_U              ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpIsc1AuthorizationInfoAuthorityStatusU");
    padview[27] = PadView.getInstance("AUTHORITY_STATUS_D              ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpIsc1AuthorizationInfoAuthorityStatusD");
    padview[28] = PadView.getInstance("AUTHORITY_STATUS_L              ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpIsc1AuthorizationInfoAuthorityStatusL");
    padview[29] = PadView.getInstance("EXP_MSG                         ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_oa, 
      null);
    padview[30] = PadView.getInstance("IYY1_COMPONENT                  ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_oa, null);
    padview[31] = PadView.getInstance("SEVERITY_CODE                   ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpMsgIyy1ComponentSeverityCode");
    padview[32] = PadView.getInstance("MESSAGE_TX                      ", 512, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_VARCHAR, w_oa, "ExpMsgIyy1ComponentMessageTx");
    padview[33] = PadView.getInstance("EXP_ERROR                       ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_oa, 
      null);
    padview[34] = PadView.getInstance("IYY1_COMPONENT                  ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_oa, null);
    padview[35] = PadView.getInstance("SEVERITY_CODE                   ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpErrorIyy1ComponentSeverityCode");
    padview[36] = PadView.getInstance("ROLLBACK_INDICATOR              ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpErrorIyy1ComponentRollbackIndicator");
    padview[37] = PadView.getInstance("ORIGIN_SERVID                   ", 15, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_oa, "ExpErrorIyy1ComponentOriginServid");
    padview[38] = PadView.getInstance("CONTEXT_STRING                  ", 512, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_VARCHAR, w_oa, "ExpErrorIyy1ComponentContextString");
    padview[39] = PadView.getInstance("RETURN_CODE                     ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_oa, "ExpErrorIyy1ComponentReturnCode");
    padview[40] = PadView.getInstance("REASON_CODE                     ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_oa, "ExpErrorIyy1ComponentReasonCode");
    padview[41] = PadView.getInstance("CHECKSUM                        ", 15, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpErrorIyy1ComponentChecksum");
    padview[42] = PadView.getInstance("LOCAL                           ", 0, 0, 0, (short)1, PadView.VT_BASE, PadView.DT_NONE, w_la, 
      "w_la");
    padview[43] = PadView.getInstance("LOC_REFERENCE                   ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    padview[44] = PadView.getInstance("IYY1_SERVER_DATA                ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_la, null);
    padview[45] = PadView.getInstance("USERID                          ", 8, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocReferenceIyy1ServerDataUserid");
    padview[46] = PadView.getInstance("SERVER_DATE                     ", 8, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_DATE, 
      w_la, "LocReferenceIyy1ServerDataServerDate");
    padview[47] = PadView.getInstance("SERVER_TIME                     ", 6, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TIME, 
      w_la, "LocReferenceIyy1ServerDataServerTime");
    padview[48] = PadView.getInstance("REFERENCE_ID                    ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_TIMESTAMP, w_la, "LocReferenceIyy1ServerDataReferenceId");
    padview[49] = PadView.getInstance("SERVER_TIMESTAMP                ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_TIMESTAMP, w_la, "LocReferenceIyy1ServerDataServerTimestamp");
    padview[50] = PadView.getInstance("LOC_ERROR                       ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    padview[51] = PadView.getInstance("ISC1_COMPONENT                  ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_la, null);
    padview[52] = PadView.getInstance("SEVERITY_CODE                   ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocErrorIsc1ComponentSeverityCode");
    padview[53] = PadView.getInstance("ROLLBACK_INDICATOR              ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocErrorIsc1ComponentRollbackIndicator");
    padview[54] = PadView.getInstance("ORIGIN_SERVID                   ", 15, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocErrorIsc1ComponentOriginServid");
    padview[55] = PadView.getInstance("CONTEXT_STRING                  ", 512, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_VARCHAR, w_la, "LocErrorIsc1ComponentContextString");
    padview[56] = PadView.getInstance("RETURN_CODE                     ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocErrorIsc1ComponentReturnCode");
    padview[57] = PadView.getInstance("REASON_CODE                     ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocErrorIsc1ComponentReasonCode");
    padview[58] = PadView.getInstance("CHECKSUM                        ", 15, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocErrorIsc1ComponentChecksum");
    padview[59] = PadView.getInstance("LOC_GROUP_CONTEXT               ", 0, 0, 9, (short)2, PadView.VT_GROUP, PadView.DT_NONE, w_la,
       "LocGroupContext_MA");
    padview[60] = PadView.getInstance("LOC_G_CONTEXT                   ", 0, 0, 0, (short)3, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    padview[61] = PadView.getInstance("DONT_CHANGE_TEXT                ", 0, 0, 0, (short)4, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_la, null);
    padview[62] = PadView.getInstance("TEXT_150                        ", 150, 0, 0, (short)4, PadView.VT_PREDICATE, PadView.DT_TEXT,
       w_la, "LocGContextDontChangeTextText150");
    padview[63] = PadView.getInstance("LOC_ERROR                       ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    ...
    padview[66] = PadView.getInstance("ROLLBACK_INDICATOR              ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocErrorIyy1ComponentRollbackIndicator");
    padview[67] = PadView.getInstance("ORIGIN_SERVID                   ", 15, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocErrorIyy1ComponentOriginServid");
    padview[68] = PadView.getInstance("CONTEXT_STRING                  ", 512, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_VARCHAR, w_la, "LocErrorIyy1ComponentContextString");
    padview[69] = PadView.getInstance("RETURN_CODE                     ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocErrorIyy1ComponentReturnCode");
    padview[70] = PadView.getInstance("REASON_CODE                     ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocErrorIyy1ComponentReasonCode");
    padview[71] = PadView.getInstance("CHECKSUM                        ", 15, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocErrorIyy1ComponentChecksum");
    padview[72] = PadView.getInstance("LOC_CONTEXT                     ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    padview[73] = PadView.getInstance("IYY1_COMPONENT                  ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_la, null);
    padview[74] = PadView.getInstance("CONTEXT_STRING                  ", 512, 0, 0, (short)3, PadView.VT_PREDICATE, 
    ...
    padview[75] = PadView.getInstance("LOC                             ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    padview[76] = PadView.getInstance("DONT_CHANGE_RETURN_CODES        ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_la, null);
    padview[77] = PadView.getInstance("1_OK                            ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
...
/**
 * Contains the export request data returned from the 'CYY1S091_PARENT_CHILD_DBL_LIST' server.
 * @see Cyy1s091ParentChildDblList
 **/
@javax.xml.bind.annotation.XmlType(name="Cyy1s091ParentChildDblListExport",
          propOrder={"command",
            "exitState",
            "exitStateType",
            "exitStateMessage",
...
public class Cyy1s091ParentChildDblListExport  implements Externalizable, Cloneable
{
  private final static long serialVersionUID = 427823746L;
  /**
   * Default Constructor.
   **/
  public Cyy1s091ParentChildDblListExport()
  {
  }
  /**
  ...
  {
    Cyy1s091ParentChildDblListExport copy = new Cyy1s091ParentChildDblListExport();
  ...
  /**
   * Resets the Cyy1s091ParentChildDblListExport class properties to all of their default values.
   **/
  public void reset()
  {
    _TrustClients = false;
  ...
  /**
   * Unserializes the Cyy1s091ParentChildDblListExport class from the ObjectInput.
  ...
  /**
   * Serializes the Cyy1s091ParentChildDblListExport class to the ObjectOutput.
   * @throws IOException Thrown If an I/O error has occurred.
   **/
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: Cyy1s091ParentChildDblListExportWrapper Date: 2023/07/05
//    User: HakanBal                         Time: 15:09:36
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
/**
 * Wraps a Cyy1s091ParentChildDblListExport class as an IExportWrapper. Allows for the generic access by runtimes and conversions. 
 * @see IExportWrapper
 * @see Cyy1s091ParentChildDblListExport
 * @see CYY1S091_OA
 **/
public class Cyy1s091ParentChildDblListExportWrapper  implements IExportWrapper, Serializable
{
  /**
   * Returns a Cyy1s091ParentChildDblListExportWrapper instance, wrapping a default Cyy1s091ParentChildDblListExport.
   **/
  public Cyy1s091ParentChildDblListExportWrapper()
  {
  }
  
  /**
   * Returns a Cyy1s091ParentChildDblListExportWrapper instance, wrapping the Cyy1s091ParentChildDblListExport instance parameter.
   **/
  public Cyy1s091ParentChildDblListExportWrapper(Object exportView)
  {
    setExport((Cyy1s091ParentChildDblListExport)exportView);
  }
  
  /**
   * Returns a Cyy1s091ParentChildDblListExportWrapper instance, wrapping a Cyy1s091ParentChildDblListExport instance initialized 
    with the parameters.
   **/
  public Cyy1s091ParentChildDblListExportWrapper(IExportView oa, String command, int exitStateType, int exitState, String 
    exitStateMessage)
  {
    setOA(oa);
    setCommand(command);
   ...
   **/
  private Cyy1s091ParentChildDblListExport exportView = null;
  /**
  ...
  public Object getExport()
  {
    if ( exportView == null )
    {
      exportView = new Cyy1s091ParentChildDblListExport();
    }
    return(exportView);
  }
  ...
  {
    exportView = (Cyy1s091ParentChildDblListExport)value;
  }
  ...
  public String getCommand()
  {
    Cyy1s091ParentChildDblListExport exportView = (Cyy1s091ParentChildDblListExport)getExport();
  ...
  /**
   * Returns a CYY1S091_OA instance based on the Cyy1s091ParentChildDblListExport export view instance.
   * No validation is performed during the mapping.
   **/
  public IExportView getOA()
  {
    CYY1S091_OA result = CYY1S091_OA.getInstance();
  ...
  /**
   * Based on the CYY1S091_OA instance set the Cyy1s091ParentChildDblListExport export view instance.
   * No validation is performed during the mapping.
   **/
  public void setOA(IExportView value)
  {
    CYY1S091_OA view = (CYY1S091_OA)value;
...
/**
 * Contains the import request data for the 'CYY1S091_PARENT_CHILD_DBL_LIST' server.
 * @see Cyy1s091ParentChildDblList
 **/
@javax.xml.bind.annotation.XmlType(name="Cyy1s091ParentChildDblListImport",
          propOrder={"command",
            "clientId",
            "clientPassword",
            "nextLocation",
...
public class Cyy1s091ParentChildDblListImport  implements Externalizable, Cloneable
{
  private final static long serialVersionUID = 423629116L;
  /**
   * Default Constructor.
   **/
  public Cyy1s091ParentChildDblListImport()
  {
  }
  /**
   * Internal storage for TrustClients property.
  ...
  @Override public Object clone()
  {
    Cyy1s091ParentChildDblListImport copy = new Cyy1s091ParentChildDblListImport();
    copy._TrustClients = _TrustClients;
    copy._Command = _Command;
  ...
  /**
   * Resets the Cyy1s091ParentChildDblListImport class properties to all of their default values.
   **/
  public void reset()
  {
    _TrustClients = false;
  ...
  /**
   * Unserializes the Cyy1s091ParentChildDblListImport class from the ObjectInput.
   * @throws IOException Thrown If an I/O error has occurred.
   **/
  public void readExternal(ObjectInput in)
  	throws IOException
  ...
  /**
   * Serializes the Cyy1s091ParentChildDblListImport class to the ObjectOutput.
   * @throws IOException Thrown If an I/O error has occurred.
   **/
  public void writeExternal(ObjectOutput out)
  	throws IOException
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: Cyy1s091ParentChildDblListImportWrapper Date: 2023/07/05
//    User: HakanBal                         Time: 15:09:36
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
/**
 * Wraps a Cyy1s091ParentChildDblListImport class as an IImportWrapper. Allows for the generic access by runtimes and conversions. 
 * @see IImportWrapper
 * @see Cyy1s091ParentChildDblListImport
 * @see CYY1S091_IA
 **/
public class Cyy1s091ParentChildDblListImportWrapper  implements IImportWrapper, Serializable
{
  /**
   * Returns a Cyy1s091ParentChildDblListImportWrapper instance, wrapping a default Cyy1s091ParentChildDblListImport.
   **/
  public Cyy1s091ParentChildDblListImportWrapper()
  {
  }
  
  /**
   * Returns a Cyy1s091ParentChildDblListImportWrapper instance, wrapping the Cyy1s091ParentChildDblListImport instance parameter.
   **/
  public Cyy1s091ParentChildDblListImportWrapper(Object importView)
  {
    setImport((Cyy1s091ParentChildDblListImport)importView);
  }
  
  /**
   * Returns a Cyy1s091ParentChildDblListImportWrapper instance, wrapping a Cyy1s091ParentChildDblListImport instance initialized 
    with the parameters.
   **/
  public Cyy1s091ParentChildDblListImportWrapper(IImportView ia, String command, String nextLocation, String clientId, String 
   ...
   **/
  private Cyy1s091ParentChildDblListImport importView = null;
  /**
  ...
  public Object getImport()
  {
    if ( importView == null )
    {
      importView = new Cyy1s091ParentChildDblListImport();
    }
    return(importView);
  }
  ...
  {
    importView = (Cyy1s091ParentChildDblListImport)value;
  }
  ...
  public String getCommand()
  {
    Cyy1s091ParentChildDblListImport importView = (Cyy1s091ParentChildDblListImport)getImport();
  ...
  /**
   * Returns a CYY1S091_IA instance based on the Cyy1s091ParentChildDblListImport import view instance.
   * No validation is performed during the mapping.
   **/
  public IImportView getIA()
  {
    CYY1S091_IA result = CYY1S091_IA.getInstance();
  ...
  /**
   * Based on the CYY1S091_IA instance set the Cyy1s091ParentChildDblListImport import view instance.
   * No validation is performed during the mapping.
   **/
  public void setIA(IImportView value)
  {
    ...
    boolean saveTrustClients = importView.getTrustClients();
    importView.setTrustClients(true);
    if (value instanceof CYY1S091_IA) {
      view = (CYY1S091_IA)value;
    }
    else {
      view = CYY1S091_IA.getInstance();
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYY1S091_IA                      Date: 2023/07/05
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: CYY1S091_IA
 **/
public class CYY1S091_IA extends ViewBase implements IImportView, Serializable
{
  ...
  public CYY1S091_IA(CYY1S091_IA orig)
  {
    copyFrom(orig);
  }
  /**
  ...
  public static CYY1S091_IA getInstance()
  {
    return new CYY1S091_IA();
  }
  /**
  ...
  {
    this.copyFrom((CYY1S091_IA) orig);
  }
  
  /**
   * Sets the current instance based on the passed view.
   **/
  public void copyFrom(CYY1S091_IA orig)
  {
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYY1S091_LA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:09:39
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: CYY1S091_LA
 **/
public class CYY1S091_LA extends ViewBase implements ILocalView, Serializable
{
  ...
  public CYY1S091_LA(CYY1S091_LA orig)
  {
  ...
  public static CYY1S091_LA getInstance()
  {
    return new CYY1S091_LA();
  }
  /**
   * Static free instance method
   **/
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYY1S091_OA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:09:39
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 ...
 **/
public class CYY1S091_OA extends ViewBase implements IExportView, Serializable
{
  static VDF localVdf = null;
    ...
    if ( localVdf == null )
    {
      VDFEntry [] vdfEntries = {
        ...
        new VDFEntry((int)9, "", "ExpIsc1AuthorizationInfo", "Isc1AuthorizationInfo", "AuthorityStatusL", VDFEntry.TYPE_STRING, (
          short)1, (short)0, 1, (short)0, null), 
        new VDFEntry((int)10, "", "ExpMsgIyy1Component", "Iyy1Component", "SeverityCode", VDFEntry.TYPE_STRING, (short)1, (short)0, 
          1, (short)0, null), 
        new VDFEntry((int)11, "", "ExpMsgIyy1Component", "Iyy1Component", "MessageTx", VDFEntry.TYPE_STRING, (short)1, (short)0, 512,
           (short)0, null), 
        new VDFEntry((int)12, "", "ExpErrorIyy1Component", "Iyy1Component", "SeverityCode", VDFEntry.TYPE_STRING, (short)1, (short)0,
           1, (short)0, null), 
        new VDFEntry((int)13, "", "ExpErrorIyy1Component", "Iyy1Component", "RollbackIndicator", VDFEntry.TYPE_STRING, (short)1, (
          short)0, 1, (short)0, null), 
        new VDFEntry((int)14, "", "ExpErrorIyy1Component", "Iyy1Component", "OriginServid", VDFEntry.TYPE_DOUBLE, (short)1, (short)0,
           15, (short)0, null), 
        new VDFEntry((int)15, "", "ExpErrorIyy1Component", "Iyy1Component", "ContextString", VDFEntry.TYPE_STRING, (short)1, (short)
          0, 512, (short)0, null), 
        new VDFEntry((int)16, "", "ExpErrorIyy1Component", "Iyy1Component", "ReturnCode", VDFEntry.TYPE_INT, (short)1, (short)0, 8, (
          short)0, null), 
        new VDFEntry((int)17, "", "ExpErrorIyy1Component", "Iyy1Component", "ReasonCode", VDFEntry.TYPE_INT, (short)1, (short)0, 8, (
          short)0, null), 
        new VDFEntry((int)18, "", "ExpErrorIyy1Component", "Iyy1Component", "Checksum", VDFEntry.TYPE_STRING, (short)1, (short)0, 15,
           (short)0, null), 
      };
      localVdf = new VDF(vdfEntries);
    }
  ...
  public void setFromVDF(VDF vdf)
  {
    ...
    {
      ExpMsgIyy1ComponentSeverityCode = ((String)vdf.getEntries()[9].getDataValue().getObject());
    }
    else 
    {
      ExpMsgIyy1ComponentSeverityCode = " ";
    ...
    {
      ExpMsgIyy1ComponentMessageTx = ((String)vdf.getEntries()[10].getDataValue().getObject());
    }
    else 
    {
      ExpMsgIyy1ComponentMessageTx = "";
    ...
    {
      ExpErrorIyy1ComponentSeverityCode = ((String)vdf.getEntries()[11].getDataValue().getObject());
    }
    else 
    {
      ExpErrorIyy1ComponentSeverityCode = " ";
    ...
    {
      ExpErrorIyy1ComponentRollbackIndicator = ((String)vdf.getEntries()[12].getDataValue().getObject());
    }
    else 
    {
      ExpErrorIyy1ComponentRollbackIndicator = " ";
    ...
    {
      ExpErrorIyy1ComponentOriginServid = ((Double)vdf.getEntries()[13].getDataValue().getObject()).doubleValue();
    }
    else 
    {
      ExpErrorIyy1ComponentOriginServid = 0.0;
    ...
    {
      ExpErrorIyy1ComponentContextString = ((String)vdf.getEntries()[14].getDataValue().getObject());
    }
    else 
    {
      ExpErrorIyy1ComponentContextString = "";
    ...
    {
      ExpErrorIyy1ComponentReturnCode = ((Integer)vdf.getEntries()[15].getDataValue().getObject()).intValue();
    }
    else 
    {
      ExpErrorIyy1ComponentReturnCode = 0;
    ...
    {
      ExpErrorIyy1ComponentReasonCode = ((Integer)vdf.getEntries()[16].getDataValue().getObject()).intValue();
    }
    else 
    {
      ExpErrorIyy1ComponentReasonCode = 0;
    ...
    {
      ExpErrorIyy1ComponentChecksum = ((String)vdf.getEntries()[17].getDataValue().getObject());
    }
    else 
    {
      ExpErrorIyy1ComponentChecksum = "               ";
  ...
  public VDF getVDF()
  {
    ...
    // predicate view item
    vdf.getEntries()[9].getDataValue().setObject(ExpMsgIyy1ComponentSeverityCode);
    // predicate view item
    vdf.getEntries()[10].getDataValue().setObject(ExpMsgIyy1ComponentMessageTx);
    // predicate view item
    vdf.getEntries()[11].getDataValue().setObject(ExpErrorIyy1ComponentSeverityCode);
    // predicate view item
    vdf.getEntries()[12].getDataValue().setObject(ExpErrorIyy1ComponentRollbackIndicator);
    // predicate view item
    vdf.getEntries()[13].getDataValue().setObject(new Double(ExpErrorIyy1ComponentOriginServid));
    // predicate view item
    vdf.getEntries()[14].getDataValue().setObject(ExpErrorIyy1ComponentContextString);
    // predicate view item
    vdf.getEntries()[15].getDataValue().setObject(new Integer(ExpErrorIyy1ComponentReturnCode));
    // predicate view item
    vdf.getEntries()[16].getDataValue().setObject(new Integer(ExpErrorIyy1ComponentReasonCode));
    // predicate view item
    vdf.getEntries()[17].getDataValue().setObject(ExpErrorIyy1ComponentChecksum);
    return(vdf);
  }
...
// Generated Bean Interface for procedure step: CYY1S091_PARENT_CHILD_DBL_LIST
// EJBName: CYY1S091_PARENT_CHILD_DBL_LIST_Bean Date:       2023 Time: 15:09:36
...
@Stateless(name = "CYY1S091_PARENT_CHILD_DBL_LIST")
public class CYY1S091_PARENT_CHILD_DBL_LIST_Bean
 implements CYY1S091_PARENT_CHILD_DBL_LIST_Local,
            CYY1S091_PARENT_CHILD_DBL_LIST_Remote {
  
  private EJBProcedureStepContext psctx;
  @Resource public SessionContext context;
  private EJBRMIResponse execute(EJBRMIRequest rs, CYY1S091_IA iv)
  	throws Exception
  {
    if ( null == psctx )
    {
    ...
    return(psctx.execute( rs, "gen.ort.yyy.CYY1S091", "CYY1S091", iv, "gen.ort.yyy.CYY1S091_OA"));
  }
  
  public EJBRMIResponse call(EJBRMIRequest rs, CYY1S091_IA iv)
  	throws Exception
  {
    return(execute( rs, iv ));
  }
  
  // External Import and Export view call for CYY1S091_PARENT_CHILD_DBL_LIST
  public Cyy1s091ParentChildDblListExport call(Cyy1s091ParentChildDblListImport in)
  	throws Exception
  {
    Cyy1s091ParentChildDblListImportWrapper iw = new Cyy1s091ParentChildDblListImportWrapper(in);
    EJBRMIRequest rs = new EJBRMIRequest( iw.getCommand(), "YY09", iw.getNextLocation(), iw.getExitState(), iw.getDialect(), 
      iw.getClientId(), iw.getClientPassword(), null);
    EJBRMIResponse rq;
    rq = execute(rs, (CYY1S091_IA)iw.getIA());
    if (rq.isErrorEncountered() || rq.wasAbortRequested()) {
      throw new Exception(rq.createExceptionStr());
    }
    Cyy1s091ParentChildDblListExportWrapper xw = new Cyy1s091ParentChildDblListExportWrapper( rq.getResponseView(), rq.getCommand(), 
      rq.getExitStateType(), rq.getExitState(), rq.getExitInfoMsg() );
    return (Cyy1s091ParentChildDblListExport)xw.getExport();
  }
  
  // External Import and Export view call for CYY1S091_PARENT_CHILD_DBL_LIST
  public Cyy1s091ParentChildDblListExport Cyy1s091ParentChildDblListcall(Cyy1s091ParentChildDblListImport in)
  	throws Exception
  {
    Cyy1s091ParentChildDblListImportWrapper iw = new Cyy1s091ParentChildDblListImportWrapper(in);
    EJBRMIRequest rs = new EJBRMIRequest( iw.getCommand(), "YY09", iw.getNextLocation(), iw.getExitState(), iw.getDialect(), 
...
// CA Gen Enterprise Java Beans
// Generated Local Interface for procedure step:  CYY1S091_PARENT_CHILD_DBL_LIST
// EJBName: CYY1S091_PARENT_CHILD_DBL_LIST_Local Date:       2023 Time: 15:09:36

import javax.ejb.Local;
import com.ca.gen.odc.coopflow.ejbrmi.EJBRMIRequest;
import com.ca.gen.odc.coopflow.ejbrmi.EJBRMIResponse;

@Local public interface CYY1S091_PARENT_CHILD_DBL_LIST_Local 
{
  public EJBRMIResponse call(EJBRMIRequest rs, CYY1S091_IA iv)
  	throws Exception
  ;
...
// CA Gen Enterprise Java Beans
// Generated Remote Interface for procedure step:  CYY1S091_PARENT_CHILD_DBL_LIST
// EJBName: CYY1S091_PARENT_CHILD_DBL_LIST_Remote Date:       2023 Time: 15:09:36

import javax.ejb.Remote;

@Remote public interface CYY1S091_PARENT_CHILD_DBL_LIST_Remote 
{
  public Cyy1s091ParentChildDblListExport Cyy1s091ParentChildDblListcall(Cyy1s091ParentChildDblListImport in)
  	throws Exception
  ;

...
//
//    Name: CYYY0411_XML_CREATE              Date: 2023/07/05
//    Target OS:   JVM                       Time: 15:09:49
...
public class CYYY0411 extends ABBase
{
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  ...
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  gen.ort.yyy.EYYY0411_IA eyyy0411_ia;
  gen.ort.yyy.EYYY0411_OA eyyy0411_oa;
  ...
  //    FOLLOW AS NEEDED:             
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  boolean func_0022020269_esc_flag;
  boolean func_0020971939_esc_flag;
  boolean func_0020972013_esc_flag;
  boolean func_0020971984_esc_flag;
  boolean func_0020971983_esc_flag;
  PadView padview[] = new PadView [57];
  int trace_ret_code;
  PadText padtext[] = initPadText();
  public PadText [] initPadText()
  {
    PadText [] result = new PadText [PADTEXT_SIZE];
    result[0] = PadText.getInstance(   0,"+->   CYYY0411_XML_CREATE               07/05/2023  15:09");
    result[1] = PadText.getInstance(   0,"!       IMPORTS:");
    result[2] = PadText.getInstance(   0,"!         Entity View imp type (Transient, Optional, Import only)");
    result[3] = PadText.getInstance(   0,"!           tinstance_id");
    result[4] = PadText.getInstance(   0,"!           treference_id");
    result[5] = PadText.getInstance(   0,"!           tcreate_user_id");
    result[6] = PadText.getInstance(   0,"!           tupdate_user_id");
    result[7] = PadText.getInstance(   0,"!           tkey_attr_text");
    result[8] = PadText.getInstance(   0,"!           tsearch_attr_text");
    result[9] = PadText.getInstance(   0,"!           tother_attr_text");
    result[10] = PadText.getInstance(   0,"!           tother_attr_date");
    result[11] = PadText.getInstance(   0,"!           tother_attr_time");
    result[12] = PadText.getInstance(   0,"!           tother_attr_amount");
    ...
    result[30] = PadText.getInstance(   0,"!         Group View (9) loc_group_context");
    result[31] = PadText.getInstance(   0,"!           Work View loc_g_context dont_change_text");
    result[32] = PadText.getInstance(   0,"!             text_150");
    result[33] = PadText.getInstance(   0,"!         Work View loc dont_change_return_codes");
    result[34] = PadText.getInstance(   0,"!           1_ok");
    result[35] = PadText.getInstance(   0,"!           n70_xml_error");
    result[36] = PadText.getInstance(   0,"!         Work View loc dont_change_reason_codes");
    result[37] = PadText.getInstance(   0,"!           1_default");
    ...
    result[46] = PadText.getInstance(   0,"!         Work View loc_context iyy1_component");
    ...
    result[52] = PadText.getInstance(   1,"!  Check description for porpose");
    result[53] = PadText.getInstance(   1,"!  ");
    result[54] = PadText.getInstance(   2,"!  NOTE: ");
    result[55] = PadText.getInstance(   2,"!  RELEASE HISTORY");
    result[56] = PadText.getInstance(   2,"!  01_00 01-10-2009 New Release");
    result[57] = PadText.getInstance(   2,"!  ");
    result[58] = PadText.getInstance(   3,"!  USE cyyy9001_exception_hndlng_dflt");
    result[59] = PadText.getInstance(   3,
    ...
    result[63] = PadText.getInstance(   5,"!  Change Action Block Name");
    result[64] = PadText.getInstance(   5,"!  ");
    result[65] = PadText.getInstance(   6,"!  SET SUBSCRIPT OF loc_group_context TO 1 ");
    result[66] = PadText.getInstance(   7,"!  SET loc_g_context dont_change_text text_150 TO \"CYYY0411\" ");
    result[67] = PadText.getInstance(   8,"!  SET SUBSCRIPT OF loc_group_context TO 2 ");
    result[68] = PadText.getInstance(   9,"!  SET loc_g_context dont_change_text text_150 TO \"XML CREATE\" ");
    result[69] = PadText.getInstance(  10,"!   ");
    result[70] = PadText.getInstance(  11,"!  NOTE: ");
    result[71] = PadText.getInstance(  11,"!  ****************************************************************");
    result[72] = PadText.getInstance(  11,"!  The used ReturnCode/ReasonCode values");
    result[73] = PadText.getInstance(  11,"!  ");
    result[74] = PadText.getInstance(  12,"!  NOTE: ");
    result[75] = PadText.getInstance(  12,"!  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[76] = PadText.getInstance(  12,"!  Set the return and reason codes below");
    result[77] = PadText.getInstance(  12,"!  ");
    result[78] = PadText.getInstance(  13,"!  SET loc dont_change_return_codes 1_ok TO 1 ");
    result[79] = PadText.getInstance(  14,"!  SET loc dont_change_return_codes n70_xml_error TO -70 ");
    result[80] = PadText.getInstance(  15,"!   ");
    result[81] = PadText.getInstance(  16,"!  SET loc dont_change_reason_codes 1_default TO 1 ");
    result[82] = PadText.getInstance(  17,"!   ");
    result[83] = PadText.getInstance(  18,"!  +->IF exp_error iyy1_component return_code >= loc dont_change_return_codes 1_ok");
    result[84] = PadText.getInstance(  19,"!  !  USE eyyy0411_xml_create");
    result[85] = PadText.getInstance(  19,"!  !     WHICH IMPORTS: Entity View imp type TO Entity View imp type");
    result[86] = PadText.getInstance(  19,"!  !     WHICH EXPORTS: Work View exp canam_xml FROM Work View exp canam_xml");
    result[87] = PadText.getInstance(  19,"!  !                    Work View exp_error canam_xml FROM Work View exp_error canam_xml")
      ;
    result[88] = PadText.getInstance(  20,"!  !  +->CASE OF exp_error canam_xml xml_return_code");
    result[89] = PadText.getInstance(  20, 1, "!  !  +> CASE \"OK\"");
    result[90] = PadText.getInstance(  21,"!  !  !  NOTE: ");
    result[91] = PadText.getInstance(  21,"!  !  !  ****************************************************************");
    result[92] = PadText.getInstance(  21,"!  !  !  OK");
    result[93] = PadText.getInstance(  21,"!  !  !   Successful.");
    result[94] = PadText.getInstance(  22,"!  !  !  SET exp_error iyy1_component return_code TO loc dont_change_return_codes 1_ok ")
      ;
    result[95] = PadText.getInstance(  23,
      "!  !  !  SET exp_error iyy1_component reason_code TO loc dont_change_reason_codes 1_default ");
    result[96] = PadText.getInstance(  20, 2, "!  !  +> OTHERWISE");
    result[97] = PadText.getInstance(  24,
      "!  !  !  SET exp_error iyy1_component return_code TO loc dont_change_return_codes n70_xml_error ");
    result[98] = PadText.getInstance(  25,
      "!  !  !  SET exp_error iyy1_component reason_code TO loc dont_change_reason_codes 1_default ");
    result[99] = PadText.getInstance(  26,"!  !  !  NOTE: ");
    result[100] = PadText.getInstance(  26,"...Check exp_error canam_xml for error details..");
    result[101] = PadText.getInstance(  26,"...       Work View   exp_error canam_xml (transient,export only)");
    result[102] = PadText.getInstance(  26,"...         xml_return_code ");
    result[103] = PadText.getInstance(  26,"...         xml_message ");
    result[104] = PadText.getInstance(  26,"...         xml_position ");
    result[105] = PadText.getInstance(  26,"...         xml_source ");
    result[106] = PadText.getInstance(  26,"...");
    result[107] = PadText.getInstance(  26,"...CASE OF  xml_return_code:");
    result[108] = PadText.getInstance(  26,"...EB");
    ...
    result[110] = PadText.getInstance(  26,"...it means that buffer is exhausted while more data was needed to be written out.");
    result[111] = PadText.getInstance(  26,"... ");
    result[112] = PadText.getInstance(  26,"...IC");
    ...
    result[114] = PadText.getInstance(  26,"...after attribute name.");
    result[115] = PadText.getInstance(  26,"... ");
    result[116] = PadText.getInstance(  26,"...MN");
    result[117] = PadText.getInstance(  26,"... Missing node. Occurs when a mandatory element or attribute is missing.");
    result[118] = PadText.getInstance(  26,"... ");
    result[119] = PadText.getInstance(  26,"...UN");
    ...
    result[122] = PadText.getInstance(  26,"...DA");
    ...
    result[125] = PadText.getInstance(  26,"...PE");
    ...
    result[128] = PadText.getInstance(  26,"...OV");
    ...
    result[131] = PadText.getInstance(  26,"...MD");
    result[132] = PadText.getInstance(  26,
      ...
      ;
    result[133] = PadText.getInstance(  26,"...Structure) can hold.");
    result[134] = PadText.getInstance(  26,"... ");
    result[135] = PadText.getInstance(  26,"...BP");
    result[136] = PadText.getInstance(  26,"... XML PARSE statement error.");
    result[137] = PadText.getInstance(  26,"... ");
    result[138] = PadText.getInstance(  26,"...ER");
    result[139] = PadText.getInstance(  26,"... Unknown error. Occurs when operation could not be completed for any other reason.");
    result[140] = PadText.getInstance(  26,"... ");
    result[141] = PadText.getInstance(  20,"!  !  +--");
    result[142] = PadText.getInstance(  18,"!  +--");
    result[143] = PadText.getInstance(  27,"!   ");
    result[144] = PadText.getInstance(  28,"!  +->IF exp_error iyy1_component return_code < loc dont_change_return_codes 1_ok");
    result[145] = PadText.getInstance(  29,"!  !  USE cyyy9141_context_string_set");
    result[146] = PadText.getInstance(  29,"!  !     WHICH IMPORTS: Group View  loc_group_context TO Group View imp_group_context");
    ...
    result[148] = PadText.getInstance(  29,
      "!  !                    Work View exp_error iyy1_component FROM Work View exp_context iyy1_component");
    result[149] = PadText.getInstance(  30,"!  !   ");
    result[150] = PadText.getInstance(  31,"!  !  +->IF loc_error iyy1_component return_code < loc dont_change_return_codes 1_ok");
    result[151] = PadText.getInstance(  32,"!  !  !  MOVE loc_error iyy1_component TO exp_error iyy1_component");
    result[152] = PadText.getInstance(  31,"!  !  +--");
    result[153] = PadText.getInstance(  33,"!  !  SET exp_error iyy1_component severity_code TO \"E\" ");
    result[154] = PadText.getInstance(  28,"!  +--");
  ...
  //       +->   CYYY0411_XML_CREATE               07/05/2023  15:09
  //       !       IMPORTS:
  ...
  //    19 !  !     WHICH IMPORTS: Entity View imp type TO Entity View imp type
  //    19 !  !     WHICH EXPORTS: Work View exp canam_xml FROM Work View exp canam_xml
  ...
  //    29 !  !     WHICH EXPORTS: Work View loc_error iyy1_component FROM Work View exp_error iyy1_component
  //    29 !  !                    Work View exp_error iyy1_component FROM Work View exp_context iyy1_component
  //    30 !  !   
  ...
  public void CYYY0411( Object in_runtime_parm1, 
  	...
  	throws ABException
  {
    ...
    if ( trace_ret_code != 8 )
    {
      w_la.LocGContextDontChangeTextText150[LocGroupContext_PS_001-1] = FixedStringAttr.valueOf("CYYY0411", (short)150);
      f_173015086_rgvc();
    }
  	...
  	throws ABException
  {
    ...
    if ( trace_ret_code != 8 )
    {
      ...
      eyyy0411_ia = (gen.ort.yyy.EYYY0411_IA)(iefRuntimeParm2.getInstance("gen.ort.yyy.EYYY0411_IA"));
      eyyy0411_oa = (gen.ort.yyy.EYYY0411_OA)(iefRuntimeParm2.getInstance("gen.ort.yyy.EYYY0411_OA"));
      eyyy0411_ia.ImpTypeTinstanceId = TimestampAttr.valueOf(w_ia.ImpTypeTinstanceId);
      eyyy0411_ia.ImpTypeTreferenceId = TimestampAttr.valueOf(w_ia.ImpTypeTreferenceId);
      eyyy0411_ia.ImpTypeTcreateUserId = FixedStringAttr.valueOf(w_ia.ImpTypeTcreateUserId, (short)8);
      eyyy0411_ia.ImpTypeTupdateUserId = FixedStringAttr.valueOf(w_ia.ImpTypeTupdateUserId, (short)8);
      eyyy0411_ia.ImpTypeTkeyAttrText = FixedStringAttr.valueOf(w_ia.ImpTypeTkeyAttrText, (short)4);
      eyyy0411_ia.ImpTypeTsearchAttrText = FixedStringAttr.valueOf(w_ia.ImpTypeTsearchAttrText, (short)20);
      eyyy0411_ia.ImpTypeTotherAttrText = FixedStringAttr.valueOf(w_ia.ImpTypeTotherAttrText, (short)2);
      eyyy0411_ia.ImpTypeTotherAttrDate = DateAttr.valueOf(w_ia.ImpTypeTotherAttrDate);
      eyyy0411_ia.ImpTypeTotherAttrTime = TimeAttr.valueOf(w_ia.ImpTypeTotherAttrTime);
      eyyy0411_ia.ImpTypeTotherAttrAmount = BigDecimalAttr.valueOf(w_ia.ImpTypeTotherAttrAmount);
      globdata.getErrorData().setErrorEncounteredSW( ErrorData.NO_ERROR_FOUND_SW );
      iefRuntimeParm2.useActionBlock("gen.ort.yyy.EYYY0411", "EYYY0411", eyyy0411_ia, eyyy0411_oa);
      if ( ((!(globdata.getErrorData().getStatus().equals( ErrorData.NONE_SF ))) || (globdata.getErrorData().getErrorEncounteredSW() 
        != ErrorData.NO_ERROR_FOUND_SW)) || (globdata.getErrorData().getViewOverflowSW() != ErrorData.NO_ERROR_FOUND_SW) )
      {
        throw new ABException();
      ...
      globdata.getStateData().setCurrentABName( "CYYY0411_XML_CREATE" );
      globdata.getStateData().setLastStatementNumber( "0000000019" );
      w_oa.ExpErrorCanamXmlXmlReturnCode = FixedStringAttr.valueOf(eyyy0411_oa.ExpErrorCanamXmlXmlReturnCode, (short)2);
      w_oa.ExpErrorCanamXmlXmlMessage = FixedStringAttr.valueOf(eyyy0411_oa.ExpErrorCanamXmlXmlMessage, (short)80);
      w_oa.ExpErrorCanamXmlXmlPosition = DoubleAttr.valueOf(eyyy0411_oa.ExpErrorCanamXmlXmlPosition);
      w_oa.ExpErrorCanamXmlXmlSource = FixedStringAttr.valueOf(eyyy0411_oa.ExpErrorCanamXmlXmlSource, (short)120);
      w_oa.ExpCanamXmlXmlBuffer = StringAttr.valueOf(eyyy0411_oa.ExpCanamXmlXmlBuffer, (short)4094);
      eyyy0411_ia.freeInstance();
      eyyy0411_ia = null;
      eyyy0411_oa.freeInstance();
      eyyy0411_oa = null;
    }
...
"                                                                                                                                                      "
  ...
  public void f_20971984()
  	throws ABException
  {
    func_0020971984_esc_flag = false;
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    //    **************************************************************  
    //    **                                                              
    //    OK                                                              
  ...
  public void f_20971983()
  	throws ABException
  {
    func_0020971983_esc_flag = false;
  ...
  public void f_22020269_localAlloc(String abname)
  {
    ...
    w_la = (gen.ort.yyy.CYYY0411_LA)(iefRuntimeParm2.getInstance("gen.ort.yyy.CYYY0411_LA"));
    if ( w_la == null )
    {
      globdata.getStateData().setCurrentABId( "0022020269" );
...
padview[0] = PadView.getInstance("IMPORT                          ", 0, 0, 0, (short)1, PadView.VT_BASE, PadView.DT_NONE, w_ia, 
    ...
    padview[4] = PadView.getInstance("TREFERENCE_ID                   ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_TIMESTAMP, w_ia, "ImpTypeTreferenceId");
    padview[5] = PadView.getInstance("TCREATE_USER_ID                 ", 8, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_ia, "ImpTypeTcreateUserId");
    padview[6] = PadView.getInstance("TUPDATE_USER_ID                 ", 8, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
    ...
    padview[32] = PadView.getInstance("LOCAL                           ", 0, 0, 0, (short)1, PadView.VT_BASE, PadView.DT_NONE, w_la, 
      "w_la");
    padview[33] = PadView.getInstance("LOC_GROUP_CONTEXT               ", 0, 0, 9, (short)2, PadView.VT_GROUP, PadView.DT_NONE, w_la,
       "LocGroupContext_MA");
    padview[34] = PadView.getInstance("LOC_G_CONTEXT                   ", 0, 0, 0, (short)3, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    padview[35] = PadView.getInstance("DONT_CHANGE_TEXT                ", 0, 0, 0, (short)4, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_la, null);
    padview[36] = PadView.getInstance("TEXT_150                        ", 150, 0, 0, (short)4, PadView.VT_PREDICATE, PadView.DT_TEXT,
    ...
    padview[37] = PadView.getInstance("LOC                             ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    padview[38] = PadView.getInstance("DONT_CHANGE_RETURN_CODES        ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_la, null);
    padview[39] = PadView.getInstance("1_OK                            ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocDontChangeReturnCodesQ1Ok");
    padview[40] = PadView.getInstance("N70_XML_ERROR                   ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
    ...
    padview[41] = PadView.getInstance("LOC                             ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    padview[42] = PadView.getInstance("DONT_CHANGE_REASON_CODES        ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_la, null);
    padview[43] = PadView.getInstance("1_DEFAULT                       ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
    ...
    padview[44] = PadView.getInstance("LOC_ERROR                       ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    padview[45] = PadView.getInstance("IYY1_COMPONENT                  ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_la, null);
    padview[46] = PadView.getInstance("SEVERITY_CODE                   ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocErrorIyy1ComponentSeverityCode");
    padview[47] = PadView.getInstance("ROLLBACK_INDICATOR              ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocErrorIyy1ComponentRollbackIndicator");
    padview[48] = PadView.getInstance("ORIGIN_SERVID                   ", 15, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocErrorIyy1ComponentOriginServid");
    padview[49] = PadView.getInstance("CONTEXT_STRING                  ", 512, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_VARCHAR, w_la, "LocErrorIyy1ComponentContextString");
    padview[50] = PadView.getInstance("RETURN_CODE                     ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocErrorIyy1ComponentReturnCode");
    padview[51] = PadView.getInstance("REASON_CODE                     ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocErrorIyy1ComponentReasonCode");
    padview[52] = PadView.getInstance("CHECKSUM                        ", 15, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocErrorIyy1ComponentChecksum");
    padview[53] = PadView.getInstance("LOC_CONTEXT                     ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    padview[54] = PadView.getInstance("IYY1_COMPONENT                  ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_la, null);
    ...
    padview[56] = PadView.getInstance("******** BOTTOM OF DATA ********", 0, 0, 0, (short)0, PadView.VT_END, PadView.DT_NONE, w_la, 
      null);
  }
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYYY0411_IA                      Date: 2023/07/05
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: CYYY0411_IA
 **/
public class CYYY0411_IA extends ViewBase implements IImportView, Serializable
{
  // Entity View: IMP
  //        Type: TYPE
  /**
  ...
  public CYYY0411_IA(CYYY0411_IA orig)
  {
    copyFrom(orig);
  }
  /**
  ...
  public static CYYY0411_IA getInstance()
  {
    return new CYYY0411_IA();
  }
  /**
  ...
  {
    this.copyFrom((CYYY0411_IA) orig);
  }
  
  /**
   * Sets the current instance based on the passed view.
   **/
  public void copyFrom(CYYY0411_IA orig)
  {
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYYY0411_LA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:09:49
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: CYYY0411_LA
 **/
public class CYYY0411_LA extends ViewBase implements ILocalView, Serializable
{
  ...
  public CYYY0411_LA(CYYY0411_LA orig)
  {
  ...
  public static CYYY0411_LA getInstance()
  {
    return new CYYY0411_LA();
  }
  /**
   * Static free instance method
   **/
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYYY0411_OA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:10:03
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 ...
 **/
public class CYYY0411_OA extends ViewBase implements IExportView, Serializable
{
  // Entity View: EXP
  //        Type: CANAM_XML
  /**

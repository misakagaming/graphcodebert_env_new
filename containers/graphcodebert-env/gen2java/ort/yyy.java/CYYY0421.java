...
//
//    Name: CYYY0421_XML_PARSE               Date: 2023/07/05
//    Target OS:   JVM                       Time: 15:09:51
...
public class CYYY0421 extends ABBase
{
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  ...
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  gen.ort.yyy.EYYY0421_IA eyyy0421_ia;
  gen.ort.yyy.EYYY0421_OA eyyy0421_oa;
  ...
  //    FOLLOW AS NEEDED:             
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  boolean func_0022020271_esc_flag;
  boolean func_0020972101_esc_flag;
  boolean func_0020972016_esc_flag;
  boolean func_0020972004_esc_flag;
  boolean func_0020972010_esc_flag;
  PadView padview[] = new PadView [54];
  int trace_ret_code;
  PadText padtext[] = initPadText();
  public PadText [] initPadText()
  {
    PadText [] result = new PadText [PADTEXT_SIZE];
    result[0] = PadText.getInstance(   0,"+->   CYYY0421_XML_PARSE                07/05/2023  15:09");
    ...
    result[5] = PadText.getInstance(   0,"!         Entity View exp type (Transient, Export only)");
    ...
    result[32] = PadText.getInstance(   0,"!           n70_xml_error");
    ...
    result[50] = PadText.getInstance(   1,"!  Check description for porpose");
    result[51] = PadText.getInstance(   1,"!  ");
    result[52] = PadText.getInstance(   2,"!  NOTE: ");
    result[53] = PadText.getInstance(   2,"!  RELEASE HISTORY");
    result[54] = PadText.getInstance(   2,"!  01_00 01-10-2009 New Release");
    result[55] = PadText.getInstance(   2,"!  ");
    result[56] = PadText.getInstance(   3,"!  USE cyyy9001_exception_hndlng_dflt");
    result[57] = PadText.getInstance(   3,
      "!     WHICH EXPORTS: Work View exp_error iyy1_component FROM Work View exp_error iyy1_component");
    result[58] = PadText.getInstance(   4,"!   ");
    result[59] = PadText.getInstance(   5,"!  NOTE: ");
    result[60] = PadText.getInstance(   5,"!  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[61] = PadText.getInstance(   5,"!  Change Action Block Name");
    result[62] = PadText.getInstance(   5,"!  ");
    result[63] = PadText.getInstance(   6,"!  SET SUBSCRIPT OF loc_group_context TO 1 ");
    result[64] = PadText.getInstance(   7,"!  SET loc_g_context dont_change_text text_150 TO \"CYYY0421\" ");
    result[65] = PadText.getInstance(   8,"!  SET SUBSCRIPT OF loc_group_context TO 2 ");
    result[66] = PadText.getInstance(   9,"!  SET loc_g_context dont_change_text text_150 TO \"XML CREATE\" ");
    result[67] = PadText.getInstance(  10,"!   ");
    result[68] = PadText.getInstance(  11,"!  NOTE: ");
    result[69] = PadText.getInstance(  11,"!  ****************************************************************");
    result[70] = PadText.getInstance(  11,"!  The used ReturnCode/ReasonCode values");
    result[71] = PadText.getInstance(  11,"!  ");
    result[72] = PadText.getInstance(  12,"!  NOTE: ");
    result[73] = PadText.getInstance(  12,"!  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[74] = PadText.getInstance(  12,"!  Set the return and reason codes below");
    result[75] = PadText.getInstance(  12,"!  ");
    result[76] = PadText.getInstance(  13,"!  SET loc dont_change_return_codes 1_ok TO 1 ");
    result[77] = PadText.getInstance(  14,"!  SET loc dont_change_return_codes n70_xml_error TO -70 ");
    result[78] = PadText.getInstance(  15,"!   ");
    result[79] = PadText.getInstance(  16,"!  SET loc dont_change_reason_codes 1_default TO 1 ");
    result[80] = PadText.getInstance(  17,"!  +->IF exp_error iyy1_component return_code >= loc dont_change_return_codes 1_ok");
    result[81] = PadText.getInstance(  18,"!  !  USE eyyy0421_xml_parse");
    result[82] = PadText.getInstance(  18,"!  !     WHICH IMPORTS: Work View imp canam_xml TO Work View imp canam_xml");
    result[83] = PadText.getInstance(  18,"!  !     WHICH EXPORTS: Entity View exp type FROM Entity View exp type");
    result[84] = PadText.getInstance(  18,"!  !                    Work View exp_error canam_xml FROM Work View exp_error canam_xml")
      ;
    result[85] = PadText.getInstance(  19,"!  !   ");
    result[86] = PadText.getInstance(  20,"!  !  +->CASE OF exp_error canam_xml xml_return_code");
    result[87] = PadText.getInstance(  20, 1, "!  !  +> CASE \"OK\"");
    result[88] = PadText.getInstance(  21,"!  !  !  NOTE: ");
    result[89] = PadText.getInstance(  21,"!  !  !  ****************************************************************");
    result[90] = PadText.getInstance(  21,"!  !  !  OK");
    result[91] = PadText.getInstance(  21,"!  !  !   Successful.");
    result[92] = PadText.getInstance(  22,"!  !  !  SET exp_error iyy1_component return_code TO loc dont_change_return_codes 1_ok ")
      ;
    result[93] = PadText.getInstance(  23,
      "!  !  !  SET exp_error iyy1_component reason_code TO loc dont_change_reason_codes 1_default ");
    result[94] = PadText.getInstance(  20, 2, "!  !  +> OTHERWISE");
    result[95] = PadText.getInstance(  24,
      "!  !  !  SET exp_error iyy1_component return_code TO loc dont_change_return_codes n70_xml_error ");
    result[96] = PadText.getInstance(  25,
      "!  !  !  SET exp_error iyy1_component reason_code TO loc dont_change_reason_codes 1_default ");
    result[97] = PadText.getInstance(  26,"!  !  !  NOTE: ");
    result[98] = PadText.getInstance(  26,"...Check exp_error canam_xml for error details..");
    result[99] = PadText.getInstance(  26,"...       Work View   exp_error canam_xml (transient,export only)");
    result[100] = PadText.getInstance(  26,"...         xml_return_code ");
    result[101] = PadText.getInstance(  26,"...         xml_message ");
    result[102] = PadText.getInstance(  26,"...         xml_position ");
    result[103] = PadText.getInstance(  26,"...         xml_source ");
    result[104] = PadText.getInstance(  26,"...");
    result[105] = PadText.getInstance(  26,"...CASE OF  xml_return_code:");
    result[106] = PadText.getInstance(  26,"...EB");
    ...
    result[108] = PadText.getInstance(  26,"...it means that buffer is exhausted while more data was needed to be written out.");
    result[109] = PadText.getInstance(  26,"... ");
    result[110] = PadText.getInstance(  26,"...IC");
    result[111] = PadText.getInstance(  26,
      "... Invalid character. Occurs when a character is encountered in the stream that was not expected. Such as, a missing “=”");
    result[112] = PadText.getInstance(  26,"...after attribute name.");
    result[113] = PadText.getInstance(  26,"... ");
    result[114] = PadText.getInstance(  26,"...MN");
    result[115] = PadText.getInstance(  26,"... Missing node. Occurs when a mandatory element or attribute is missing.");
    result[116] = PadText.getInstance(  26,"... ");
    result[117] = PadText.getInstance(  26,"...UN");
    result[118] = PadText.getInstance(  26,
    ...
    result[120] = PadText.getInstance(  26,"...DA");
    result[121] = PadText.getInstance(  26,
    ...
    result[123] = PadText.getInstance(  26,"...PE");
    result[124] = PadText.getInstance(  26,
    ...
    result[126] = PadText.getInstance(  26,"...OV");
    ...
    result[129] = PadText.getInstance(  26,"...MD");
    result[130] = PadText.getInstance(  26,
      "... More data warning. This is a warning message that means there is more data in XML document than the IDS (Interface Data")
      ;
    result[131] = PadText.getInstance(  26,"...Structure) can hold.");
    result[132] = PadText.getInstance(  26,"... ");
    result[133] = PadText.getInstance(  26,"...BP");
    result[134] = PadText.getInstance(  26,"... XML PARSE statement error.");
    result[135] = PadText.getInstance(  26,"... ");
    result[136] = PadText.getInstance(  26,"...ER");
    result[137] = PadText.getInstance(  26,"... Unknown error. Occurs when operation could not be completed for any other reason.");
    result[138] = PadText.getInstance(  26,"... ");
    result[139] = PadText.getInstance(  20,"!  !  +--");
    result[140] = PadText.getInstance(  17,"!  +--");
    result[141] = PadText.getInstance(  27,"!  +->IF exp_error iyy1_component return_code < loc dont_change_return_codes 1_ok");
    result[142] = PadText.getInstance(  28,"!  !  USE cyyy9141_context_string_set");
    result[143] = PadText.getInstance(  28,"!  !     WHICH IMPORTS: Group View  loc_group_context TO Group View imp_group_context");
    ...
    result[147] = PadText.getInstance(  30,"!  !  +->IF loc_error iyy1_component return_code < loc dont_change_return_codes 1_ok");
    result[148] = PadText.getInstance(  31,"!  !  !  MOVE loc_error iyy1_component TO exp_error iyy1_component");
    result[149] = PadText.getInstance(  30,"!  !  +--");
    result[150] = PadText.getInstance(  32,"!  !  SET exp_error iyy1_component severity_code TO \"E\" ");
    result[151] = PadText.getInstance(  27,"!  +--");
    result[152] = PadText.getInstance(   0,"+---");
    result[153] = PadText.getInstance(PadText.LASTLINE,"************************* BOTTOM OF DATA *************************");
    return result;
  }
  final static int PADTEXT_SIZE = 154;
  ...
  public void CYYY0421( Object in_runtime_parm1, 
  	...
  	throws ABException
  {
    ...
    if ( trace_ret_code != 8 )
    {
      w_la.LocGContextDontChangeTextText150[LocGroupContext_PS_001-1] = FixedStringAttr.valueOf("CYYY0421", (short)150);
      f_173015093_rgvc();
    }
    ...
    if ( trace_ret_code != 8 )
    {
      w_la.LocGContextDontChangeTextText150[LocGroupContext_PS_001-1] = FixedStringAttr.valueOf("XML CREATE", (short)150);
      f_173015093_rgvc();
    }
  	...
  	throws ABException
  {
    ...
    if ( trace_ret_code != 8 )
    {
      ...
      eyyy0421_ia = (gen.ort.yyy.EYYY0421_IA)(iefRuntimeParm2.getInstance("gen.ort.yyy.EYYY0421_IA"));
      eyyy0421_oa = (gen.ort.yyy.EYYY0421_OA)(iefRuntimeParm2.getInstance("gen.ort.yyy.EYYY0421_OA"));
      eyyy0421_ia.ImpCanamXmlXmlBuffer = StringAttr.valueOf(w_ia.ImpCanamXmlXmlBuffer, (short)4094);
      globdata.getErrorData().setErrorEncounteredSW( ErrorData.NO_ERROR_FOUND_SW );
      iefRuntimeParm2.useActionBlock("gen.ort.yyy.EYYY0421", "EYYY0421", eyyy0421_ia, eyyy0421_oa);
      if ( ((!(globdata.getErrorData().getStatus().equals( ErrorData.NONE_SF ))) || (globdata.getErrorData().getErrorEncounteredSW() 
        != ErrorData.NO_ERROR_FOUND_SW)) || (globdata.getErrorData().getViewOverflowSW() != ErrorData.NO_ERROR_FOUND_SW) )
      {
        throw new ABException();
      ...
      globdata.getStateData().setCurrentABName( "CYYY0421_XML_PARSE" );
      globdata.getStateData().setLastStatementNumber( "0000000018" );
      w_oa.ExpErrorCanamXmlXmlReturnCode = FixedStringAttr.valueOf(eyyy0421_oa.ExpErrorCanamXmlXmlReturnCode, (short)2);
      w_oa.ExpErrorCanamXmlXmlMessage = FixedStringAttr.valueOf(eyyy0421_oa.ExpErrorCanamXmlXmlMessage, (short)80);
      w_oa.ExpErrorCanamXmlXmlPosition = DoubleAttr.valueOf(eyyy0421_oa.ExpErrorCanamXmlXmlPosition);
      w_oa.ExpErrorCanamXmlXmlSource = FixedStringAttr.valueOf(eyyy0421_oa.ExpErrorCanamXmlXmlSource, (short)120);
      w_oa.ExpTypeTinstanceId = TimestampAttr.valueOf(eyyy0421_oa.ExpTypeTinstanceId);
      w_oa.ExpTypeTreferenceId = TimestampAttr.valueOf(eyyy0421_oa.ExpTypeTreferenceId);
      w_oa.ExpTypeTcreateUserId = FixedStringAttr.valueOf(eyyy0421_oa.ExpTypeTcreateUserId, (short)8);
      w_oa.ExpTypeTupdateUserId = FixedStringAttr.valueOf(eyyy0421_oa.ExpTypeTupdateUserId, (short)8);
      w_oa.ExpTypeTkeyAttrText = FixedStringAttr.valueOf(eyyy0421_oa.ExpTypeTkeyAttrText, (short)4);
      w_oa.ExpTypeTsearchAttrText = FixedStringAttr.valueOf(eyyy0421_oa.ExpTypeTsearchAttrText, (short)20);
      w_oa.ExpTypeTotherAttrText = FixedStringAttr.valueOf(eyyy0421_oa.ExpTypeTotherAttrText, (short)2);
      w_oa.ExpTypeTotherAttrDate = DateAttr.valueOf(eyyy0421_oa.ExpTypeTotherAttrDate);
      w_oa.ExpTypeTotherAttrTime = TimeAttr.valueOf(eyyy0421_oa.ExpTypeTotherAttrTime);
      w_oa.ExpTypeTotherAttrAmount = BigDecimalAttr.valueOf(eyyy0421_oa.ExpTypeTotherAttrAmount);
      eyyy0421_ia.freeInstance();
      eyyy0421_ia = null;
      eyyy0421_oa.freeInstance();
      eyyy0421_oa = null;
    }
...
"                                                                                                                                                      "
  ...
  public void f_20972004()
  	throws ABException
  {
    func_0020972004_esc_flag = false;
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    //    **************************************************************  
    //    **                                                              
    //    OK                                                              
  ...
  public void f_20972010()
  	throws ABException
  {
    func_0020972010_esc_flag = false;
  ...
  public void f_22020271_localAlloc(String abname)
  {
    ...
    w_la = (gen.ort.yyy.CYYY0421_LA)(iefRuntimeParm2.getInstance("gen.ort.yyy.CYYY0421_LA"));
    if ( w_la == null )
    {
      globdata.getStateData().setCurrentABId( "0022020271" );
...
padview[4] = PadView.getInstance("EXPORT                          ", 0, 0, 0, (short)1, PadView.VT_BASE, PadView.DT_NONE, w_oa, 
    ...
    padview[5] = PadView.getInstance("EXP                             ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_oa, 
      null);
    padview[6] = PadView.getInstance("TYPE                            ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, w_oa,
       null);
    ...
    padview[32] = PadView.getInstance("LOCAL                           ", 0, 0, 0, (short)1, PadView.VT_BASE, PadView.DT_NONE, w_la, 
      "w_la");
    padview[33] = PadView.getInstance("LOC                             ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    padview[34] = PadView.getInstance("DONT_CHANGE_RETURN_CODES        ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_la, null);
    padview[35] = PadView.getInstance("1_OK                            ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocDontChangeReturnCodesQ1Ok");
    padview[36] = PadView.getInstance("N70_XML_ERROR                   ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
    ...
    padview[53] = PadView.getInstance("******** BOTTOM OF DATA ********", 0, 0, 0, (short)0, PadView.VT_END, PadView.DT_NONE, w_la, 
      null);
  }
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYYY0421_IA                      Date: 2023/07/05
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: CYYY0421_IA
 **/
public class CYYY0421_IA extends ViewBase implements IImportView, Serializable
{
  // Entity View: IMP
  //        Type: CANAM_XML
  /**
  ...
  public CYYY0421_IA(CYYY0421_IA orig)
  {
    copyFrom(orig);
  }
  /**
  ...
  public static CYYY0421_IA getInstance()
  {
    return new CYYY0421_IA();
  }
  /**
  ...
  {
    this.copyFrom((CYYY0421_IA) orig);
  }
  
  /**
   * Sets the current instance based on the passed view.
   **/
  public void copyFrom(CYYY0421_IA orig)
  {
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYYY0421_LA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:09:51
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: CYYY0421_LA
 **/
public class CYYY0421_LA extends ViewBase implements ILocalView, Serializable
{
  // Entity View: LOC
  ...
  public CYYY0421_LA(CYYY0421_LA orig)
  {
  ...
  public static CYYY0421_LA getInstance()
  {
    return new CYYY0421_LA();
  }
  /**
   * Static free instance method
   **/
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYYY0421_OA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:10:04
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: CYYY0421_OA
 **/
public class CYYY0421_OA extends ViewBase implements IExportView, Serializable
{
  // Entity View: EXP
  //        Type: TYPE
  /**
  ...
  public CYYY0421_OA(CYYY0421_OA orig)
  {
    copyFrom(orig);
  }
  /**
  ...
  public static CYYY0421_OA getInstance()
  {
    return new CYYY0421_OA();
  }
  /**
   * Static free instance method
   **/
  ...
  {
    this.copyFrom((CYYY0421_OA) orig);
  }
  
  /**
   * Sets the current instance based on the passed view.
   **/
  public void copyFrom(CYYY0421_OA orig)
  {

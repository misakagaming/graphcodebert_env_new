...
//
//    Name: DYYY0311_TYPE_CREATE             Date: 2023/07/05
//    Target OS:   JVM                       Time: 15:09:21
...
public class DYYY0311 extends ABBase
{
  // * * * * * * * * * * * * * * * * * * *
  ...
  // * * * * * * * * * * * * * * * * * * *
  String cr_26214403 = ErrorData.NONE_FL_LS;
  String Type_es;
  String Type_001cd;
  String Type_lk;
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
   ...
   **/
  public class DYYY0311_EA extends ViewBase implements IEntityActionView, Serializable
  {
    // Entity View: 
    //        Type: TYPE
    /**
  ...
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  DYYY0311_EA w_ea = new DYYY0311_EA();
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  ...
  //    FOLLOW AS NEEDED:             
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  boolean func_0022020272_esc_flag;
  PreparedStatement hstmt_0026214403_1;
  ResultSet hstmt_0026214403_1_rs;
  ...
  public PadText [] initPadText()
  {
    ...
    result[0] = PadText.getInstance(   0,"+->   DYYY0311_TYPE_CREATE              07/05/2023  15:09");
    ...
    result[16] = PadText.getInstance(   0,"!           tsearch_attr_text");
    result[17] = PadText.getInstance(   0,"!           tother_attr_text");
    result[18] = PadText.getInstance(   0,"!           tother_attr_date");
    result[19] = PadText.getInstance(   0,"!           tother_attr_time");
    result[20] = PadText.getInstance(   0,"!           tother_attr_amount");
    result[21] = PadText.getInstance(   0,"!       EXPORTS:");
    result[22] = PadText.getInstance(   0,"!         Entity View exp type (Transient, Export only)");
    ...
    result[33] = PadText.getInstance(   0,"!         Entity View type");
    result[34] = PadText.getInstance(   0,"!           tinstance_id");
    result[35] = PadText.getInstance(   0,"!           treference_id");
    result[36] = PadText.getInstance(   0,"!           tcreate_user_id");
    result[37] = PadText.getInstance(   0,"!           tupdate_user_id");
    ...
    result[47] = PadText.getInstance(   0,"!           n40_obj_create_failed");
    result[48] = PadText.getInstance(   0,"!         Work View loc dont_change_reason_codes");
    result[49] = PadText.getInstance(   0,"!           1_default");
    result[50] = PadText.getInstance(   0,"!           142_type_already_exist");
    result[51] = PadText.getInstance(   0,"!           143_type_attr_value_invalid");
    ...
    result[75] = PadText.getInstance(  11,"!  SET loc dont_change_reason_codes 142_type_already_exist TO 142 ");
    result[76] = PadText.getInstance(  12,"!  SET loc dont_change_reason_codes 143_type_attr_value_invalid TO 143 ");
    result[77] = PadText.getInstance(  13,"!   ");
    result[78] = PadText.getInstance(  14,"!  +->CREATE type");
    result[79] = PadText.getInstance(  15,"!  !  SET tinstance_id TO imp type tinstance_id ");
    result[80] = PadText.getInstance(  16,"!  !  SET treference_id TO imp_reference iyy1_server_data reference_id ");
    result[81] = PadText.getInstance(  17,"!  !  SET tcreate_user_id TO imp_reference iyy1_server_data userid ");
    result[82] = PadText.getInstance(  18,"!  !  SET tupdate_user_id TO imp_reference iyy1_server_data userid ");
    result[83] = PadText.getInstance(  19,"!  !  SET tkey_attr_text TO imp type tkey_attr_text ");
    result[84] = PadText.getInstance(  20,"!  !  SET tsearch_attr_text TO imp type tsearch_attr_text ");
    result[85] = PadText.getInstance(  21,"!  !  SET tother_attr_text TO imp type tother_attr_text ");
    result[86] = PadText.getInstance(  22,"!  !  SET tother_attr_date TO imp type tother_attr_date ");
    result[87] = PadText.getInstance(  23,"!  !  SET tother_attr_time TO imp type tother_attr_time ");
    result[88] = PadText.getInstance(  24,"!  !  SET tother_attr_amount TO imp type tother_attr_amount ");
    result[89] = PadText.getInstance(  14, 1, "!  +> WHEN successful");
    result[90] = PadText.getInstance(  25,"!  !  MOVE  type TO exp type");
    result[91] = PadText.getInstance(  14, 2, "!  +> WHEN already exists");
    result[92] = PadText.getInstance(  26,
    ...
    result[94] = PadText.getInstance(  14, 3, "!  +> WHEN permitted value violation");
    result[95] = PadText.getInstance(  28,
      "!  !  SET exp_error iyy1_component return_code TO loc dont_change_return_codes n40_obj_create_failed ");
    result[96] = PadText.getInstance(  29,
      "!  !  SET exp_error iyy1_component reason_code TO loc dont_change_reason_codes 143_type_attr_value_invalid ");
    result[97] = PadText.getInstance(  14,"!  +--");
    result[98] = PadText.getInstance(   0,"+---");
    result[99] = PadText.getInstance(PadText.LASTLINE,"************************* BOTTOM OF DATA *************************");
    return result;
  }
  final static int PADTEXT_SIZE = 100;
  ...
  public void DYYY0311( Object in_runtime_parm1, 
  	...
  	throws ABException
  {
    ...
    if ( trace_ret_code != 8 )
    {
      w_la.LocDontChangeReasonCodesQ143TypeAttrValueInvalid = IntAttr.valueOf((int)TIRD2DEC.TIRD2DC1(143, 0, TIRD2DEC.ROUND_NONE, 5))
        ;
    }
    ...
    if ( trace_ret_code != 8 )
    {
      w_ea.TypeTinstanceId = TimestampAttr.valueOf(w_ia.ImpTypeTinstanceId);
      w_ea.TypeTreferenceId = TimestampAttr.valueOf(w_ia.ImpReferenceIyy1ServerDataReferenceId);
      w_ea.TypeTcreateUserId = FixedStringAttr.valueOf(w_ia.ImpReferenceIyy1ServerDataUserid, (short)8);
      w_ea.TypeTupdateUserId = FixedStringAttr.valueOf(w_ia.ImpReferenceIyy1ServerDataUserid, (short)8);
      w_ea.TypeTkeyAttrText = FixedStringAttr.valueOf(w_ia.ImpTypeTkeyAttrText, (short)4);
      ...
      valChkDBError = false;
      f_26214403();
      if ( cr_26214403.equals( ErrorData.SUCCEEDS_FL_LS ) == true )
      {
      ...
      else if ( cr_26214403.equals( ErrorData.DUPLICATE_FOUND_FL_LS ) == true )
      {
      ...
      else if ( cr_26214403.equals( ErrorData.INVALID_DATAB_PERM_FL_LS ) == true )
      {
  ...
  public void f_22020272_localAlloc(String abname)
  {
    ...
    w_la = (gen.ort.yyy.DYYY0311_LA)(iefRuntimeParm2.getInstance("gen.ort.yyy.DYYY0311_LA"));
    if ( w_la == null )
    {
      globdata.getStateData().setCurrentABId( "0022020272" );
...
padview[0] = PadView.getInstance("IMPORT                          ", 0, 0, 0, (short)1, PadView.VT_BASE, PadView.DT_NONE, w_ia, 
    ...
    padview[17] = PadView.getInstance("TKEY_ATTR_TEXT                  ", 4, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_ia, "ImpTypeTkeyAttrText");
    padview[18] = PadView.getInstance("TSEARCH_ATTR_TEXT               ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_ia, "ImpTypeTsearchAttrText");
    padview[19] = PadView.getInstance("TOTHER_ATTR_TEXT                ", 2, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_ia, "ImpTypeTotherAttrText");
    padview[20] = PadView.getInstance("TOTHER_ATTR_DATE                ", 8, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_DATE, 
      w_ia, "ImpTypeTotherAttrDate");
    padview[21] = PadView.getInstance("TOTHER_ATTR_TIME                ", 6, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TIME, 
      w_ia, "ImpTypeTotherAttrTime");
    padview[22] = PadView.getInstance("TOTHER_ATTR_AMOUNT              ", 17, 2, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_FIXED,
       w_ia, "ImpTypeTotherAttrAmount");
    padview[23] = PadView.getInstance("EXPORT                          ", 0, 0, 0, (short)1, PadView.VT_BASE, PadView.DT_NONE, w_oa, 
      "w_oa");
    padview[24] = PadView.getInstance("EXP                             ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_oa, 
      null);
    padview[25] = PadView.getInstance("TYPE                            ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_oa, null);
    padview[26] = PadView.getInstance("TREFERENCE_ID                   ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, 
    ...
    padview[40] = PadView.getInstance("TREFERENCE_ID                   ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, 
    ...
    padview[53] = PadView.getInstance("N40_OBJ_CREATE_FAILED           ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
    ...
    padview[57] = PadView.getInstance("142_TYPE_ALREADY_EXIST          ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocDontChangeReasonCodesQ142TypeAlreadyExist");
    padview[58] = PadView.getInstance("143_TYPE_ATTR_VALUE_INVALID     ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
  ...
  {
    tinstance_id_012EN = TIRVW2S.TIRVW2S(globdata, "IEFDB", w_ea.TypeTinstanceId);
    treference_id_014EN = TIRVW2S.TIRVW2S(globdata, "IEFDB", w_ea.TypeTreferenceId);
    tcreate_userid_008EN = w_ea.TypeTcreateUserId;
    tupdate_userid_010EN = w_ea.TypeTupdateUserId;
    tkey_attr_002EN = w_ea.TypeTkeyAttrText;
    tsearch_attr_004EN = w_ea.TypeTsearchAttrText;
    tother_attr_006EN = w_ea.TypeTotherAttrText;
    tother_date_016EN = TIRVW2D.TIRVW2D(globdata, "IEFDB", w_ea.TypeTotherAttrDate);
    tother_time_018EN = TIRVW2T.TIRVW2T(globdata, "IEFDB", w_ea.TypeTotherAttrTime);
    tother_amount_020EN = TIRBDRND.roundToBigDecimal(w_ea.TypeTotherAttrAmount,2);
  }
  public void f_26214403()
  	throws ABException
  {
    cr_26214403 = ErrorData.SUCCEEDS_FL_LS;
    Type_001cd = ABBase.PV_CREATE;
    f_26214403_moveb();
    ...
    if ( cr_26214403.equals( ErrorData.SUCCEEDS_FL_LS ) == true )
    {
      ...
      try {
        ...
        SQLStatement.append("?");
        SQLStatement.append(")");
        hstmt_0026214403_1 = globdata.getDBMSData().getDBMSManager().getStatement(globdata, iefRuntimeParm2, "IEFDB", 
          SQLStatement.toString());
        globdata.getDBMSData().getDBMSManager().bindParameterString("IEFDB", hstmt_0026214403_1, 1, tkey_attr_002EN);
        globdata.getDBMSData().getDBMSManager().bindParameterString("IEFDB", hstmt_0026214403_1, 2, tsearch_attr_004EN);
        globdata.getDBMSData().getDBMSManager().bindParameterString("IEFDB", hstmt_0026214403_1, 3, tother_attr_006EN);
        globdata.getDBMSData().getDBMSManager().bindParameterString("IEFDB", hstmt_0026214403_1, 4, tcreate_userid_008EN);
        globdata.getDBMSData().getDBMSManager().bindParameterString("IEFDB", hstmt_0026214403_1, 5, tupdate_userid_010EN);
        hstmt_0026214403_1.setTimestamp(6, tinstance_id_012EN);
        hstmt_0026214403_1.setTimestamp(7, treference_id_014EN);
        hstmt_0026214403_1.setDate(8, tother_date_016EN);
        hstmt_0026214403_1.setTime(9, tother_time_018EN);
        hstmt_0026214403_1.setBigDecimal(10, tother_amount_020EN);
        hstmt_0026214403_1.execute();
        hstmt_0026214403_1_rs = hstmt_0026214403_1.getResultSet();
        hstmt_0026214403_1_cnt = hstmt_0026214403_1.getUpdateCount();
      } catch( SQLException e ) {
        sqlException = e;
      }
      if ( globdata.getDBMSData().getDBMSManager().wasSuccessful(sqlException) )
      {
        tkey_attr_001EF = tkey_attr_002EN;
        tsearch_attr_003EF = tsearch_attr_004EN;
        tother_attr_005EF = tother_attr_006EN;
        tcreate_userid_007EF = tcreate_userid_008EN;
        tupdate_userid_009EF = tupdate_userid_010EN;
        tinstance_id_011EF = tinstance_id_012EN;
        treference_id_013EF = treference_id_014EN;
        tother_date_015EF = tother_date_016EN;
        tother_time_017EF = tother_time_018EN;
        tother_amount_019EF = tother_amount_020EN;
    ...
    else if ( cr_26214403.equals( ErrorData.INVALID_DATAB_PERM_FL_LS ) == false )
    {
  ...
  public void f_26214403_jdbc_dberror()
  	throws ABException
  {
    globdata.getErrorData().setStatus( ErrorData.FATAL_ERROR_FL_LS );
    globdata.getDBMSData().setActionId( 14 );
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: DYYY0311_IA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:09:21
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 ...
 **/
public class DYYY0311_IA extends ViewBase implements IImportView, Serializable
{
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: DYYY0311_LA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:09:21
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: DYYY0311_LA
 **/
public class DYYY0311_LA extends ViewBase implements ILocalView, Serializable
{
  // Entity View: LOC
  ...
  public DYYY0311_LA(DYYY0311_LA orig)
  {
  ...
  public static DYYY0311_LA getInstance()
  {
    return new DYYY0311_LA();
  }
  /**
   * Static free instance method
   **/
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: DYYY0311_OA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:09:21
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: DYYY0311_OA
 **/
public class DYYY0311_OA extends ViewBase implements IExportView, Serializable
{
  // Entity View: EXP
  //        Type: TYPE
  /**
  ...
  public DYYY0311_OA(DYYY0311_OA orig)
  {
    copyFrom(orig);
  }
  /**
  ...
  public static DYYY0311_OA getInstance()
  {
    return new DYYY0311_OA();
  }
  /**
   * Static free instance method
   **/
  ...
  {
    this.copyFrom((DYYY0311_OA) orig);
  }
  
  /**
   * Sets the current instance based on the passed view.
   **/
  public void copyFrom(DYYY0311_OA orig)
  {

...
//
//    Name: CYY1S071_TYPE_MAINTAIN           Date: 2023/07/05
//    Target OS:   JVM                       Time: 15:09:10
...
public class CYY1S071 extends ABBase
{
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  ...
  gen.ort.yyy.CYYY0311_IA cyyy0311_ia;
  gen.ort.yyy.CYYY0311_OA cyyy0311_oa;
  gen.ort.yyy.CYYY0321_IA cyyy0321_ia;
  gen.ort.yyy.CYYY0321_OA cyyy0321_oa;
  gen.ort.yyy.CYYY0331_IA cyyy0331_ia;
  gen.ort.yyy.CYYY0331_OA cyyy0331_oa;
  gen.ort.yyy.CYYY0341_IA cyyy0341_ia;
  gen.ort.yyy.CYYY0341_OA cyyy0341_oa;
  ...
  boolean ImpGroupTrans_FL_002;
  int ImpGroupTrans_PS_002;
  boolean ImpGroupTrans_RF_002;
  public final static int ImpGroupTrans_MM_002 = 30;
  ...
  //    FOLLOW AS NEEDED:             
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  boolean func_0022020345_esc_flag;
  boolean func_0020972919_esc_flag;
  boolean func_0020972568_esc_flag;
  boolean func_0020972109_esc_flag;
  boolean func_0020972115_esc_flag;
  boolean func_0020972215_esc_flag;
  boolean func_0020972226_esc_flag;
  boolean func_0020972302_esc_flag;
  boolean func_0020972479_esc_flag;
  boolean func_0020972534_esc_flag;
  boolean func_0020972535_esc_flag;
  boolean func_0020972633_esc_flag;
  boolean func_0020972637_esc_flag;
  PadView padview[] = new PadView [110];
  int trace_ret_code;
  PadText padtext[] = initPadText();
  public PadText [] initPadText()
  {
    PadText [] result = new PadText [PADTEXT_SIZE];
    result[0] = PadText.getInstance(   0,"+->   CYY1S071_TYPE_MAINTAIN            07/05/2023  15:09");
    ...
    result[23] = PadText.getInstance(   0,"!         Work View exp_reference iyy1_server_data (Transient, Export only)");
    result[24] = PadText.getInstance(   0,"!           server_date");
    result[25] = PadText.getInstance(   0,"!           server_time");
    result[26] = PadText.getInstance(   0,"!           reference_id");
    result[27] = PadText.getInstance(   0,"!         Entity View exp isc1_authorization_info (Transient, Export only)");
    result[28] = PadText.getInstance(   0,"!           token_id");
    result[29] = PadText.getInstance(   0,"!           authority_ind");
    result[30] = PadText.getInstance(   0,"!           authority_status_r");
    result[31] = PadText.getInstance(   0,"!           authority_status_u");
    result[32] = PadText.getInstance(   0,"!           authority_status_d");
    result[33] = PadText.getInstance(   0,"!           authority_status_l");
    result[34] = PadText.getInstance(   0,"!         Entity View exp_all type (Transient, Export only)");
    ...
    result[45] = PadText.getInstance(   0,"!         Entity View exp_ts type (Transient, Export only)");
    result[46] = PadText.getInstance(   0,"!           tinstance_id");
    result[47] = PadText.getInstance(   0,"!           treference_id");
    ...
    result[87] = PadText.getInstance(   0,"!         Work View loc dont_change_return_codes");
    result[88] = PadText.getInstance(   0,"!           1_ok");
    result[89] = PadText.getInstance(   0,"!           n1110_unauthorized_operation");
    result[90] = PadText.getInstance(   0,"!           n1120_invalid_command");
    result[91] = PadText.getInstance(   0,"!         Work View loc dont_change_reason_codes");
    result[92] = PadText.getInstance(   0,"!           1_default");
    ...
    result[100] = PadText.getInstance(   3,"!  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[101] = PadText.getInstance(   3,"!  Review Pre-Post Conditiona and Return/Reason Codes.");
    result[102] = PadText.getInstance(   3,"!  ");
    result[103] = PadText.getInstance(   4,"!  NOTE: ");
    result[104] = PadText.getInstance(   4,"!  PRE-CONDITION:");
    result[105] = PadText.getInstance(   4,"!  Init command, user data is submitted.");
    result[106] = PadText.getInstance(   4,"!  POST-CONDITION:");
    result[107] = PadText.getInstance(   4,"!  Security check results are produced.");
    result[108] = PadText.getInstance(   4,"!  RETURN CODE = 1, REASON CODE = 1");
    result[109] = PadText.getInstance(   5,"!   ");
    result[110] = PadText.getInstance(   6,"!  NOTE: ");
    result[111] = PadText.getInstance(   6,"!  PRE-CONDITION:");
    result[112] = PadText.getInstance(   6,"!  READ command, key fields are submitted.");
    result[113] = PadText.getInstance(   6,"!  POST-CONDITION:");
    result[114] = PadText.getInstance(   6,"!  The record is read, EXP_ALL and EXP_TS are produced.");
    result[115] = PadText.getInstance(   6,"!  RETURN CODE = 1, REASON CODE = 1");
    result[116] = PadText.getInstance(   7,"!   ");
    result[117] = PadText.getInstance(   8,"!  NOTE: ");
    result[118] = PadText.getInstance(   8,"!  PRE-CONDITION:");
    result[119] = PadText.getInstance(   8,"!  UPDATE command, all fields are submitted.");
    result[120] = PadText.getInstance(   8,"!  POST-CONDITION:");
    result[121] = PadText.getInstance(   8,"!  The record is read and updated, EXP_TS are produced.");
    result[122] = PadText.getInstance(   8,"!  RETURN CODE = 1, REASON CODE = 1");
    result[123] = PadText.getInstance(   9,"!   ");
    result[124] = PadText.getInstance(  10,"!  NOTE: ");
    result[125] = PadText.getInstance(  10,"!  PRE-CONDITION:");
    result[126] = PadText.getInstance(  10,"!  DELETE command, key fields and last update date are submitted.");
    result[127] = PadText.getInstance(  10,"!  POST-CONDITION:");
    result[128] = PadText.getInstance(  10,"!  The record is read and deleted.");
    result[129] = PadText.getInstance(  10,"!  RETURN CODE = 1, REASON CODE = 1");
    result[130] = PadText.getInstance(  11,"!   ");
    result[131] = PadText.getInstance(  12,"!  NOTE: ");
    result[132] = PadText.getInstance(  12,"!  PRE-CONDITION:");
    result[133] = PadText.getInstance(  12,"!  CREATE command, all fields are submitted.");
    result[134] = PadText.getInstance(  12,"!  POST-CONDITION:");
    result[135] = PadText.getInstance(  12,"!  The record is created, EXP_TS are produced.");
    result[136] = PadText.getInstance(  12,"!  RETURN CODE = 1, REASON CODE = 1");
    result[137] = PadText.getInstance(  13,"!   ");
    result[138] = PadText.getInstance(  14,"!  NOTE: ");
    result[139] = PadText.getInstance(  14,"!  PRE-CONDITION:");
    result[140] = PadText.getInstance(  14,"!  Any command but listed above is submitted.");
    result[141] = PadText.getInstance(  14,"!  POST-CONDITION:");
    result[142] = PadText.getInstance(  14,"!  No results are produced.");
    result[143] = PadText.getInstance(  14,"!  RETURN CODE = -1120, REASON CODE = 1");
    result[144] = PadText.getInstance(  14,"!  ");
    result[145] = PadText.getInstance(  15,"!  NOTE: ");
    result[146] = PadText.getInstance(  15,"!  PRE-CONDITION:");
    result[147] = PadText.getInstance(  15,"!  The user is not authorized for performing the operation.");
    result[148] = PadText.getInstance(  15,"!  POST-CONDITION:");
    result[149] = PadText.getInstance(  15,"!  No results are produced.");
    result[150] = PadText.getInstance(  15,"!  RETURN CODE = -1110, REASON CODE = 1");
    result[151] = PadText.getInstance(  16,"!   ");
    result[152] = PadText.getInstance(  17,"!  NOTE: ");
    result[153] = PadText.getInstance(  17,"!  RETURN / REASON  CODES");
    result[154] = PadText.getInstance(  17,"!  +1/1 Normal");
    result[155] = PadText.getInstance(  17,"!  -1110/1 Unauthorized operation");
    result[156] = PadText.getInstance(  17,"!  -1120/1 Erroneous command");
    result[157] = PadText.getInstance(  18,"!   ");
    result[158] = PadText.getInstance(  19,"!  NOTE: ");
    result[159] = PadText.getInstance(  19,"!  RELEASE HISTORY");
    result[160] = PadText.getInstance(  19,"!  01_00 23-02-1998 New release");
    result[161] = PadText.getInstance(  20,"!   ");
    result[162] = PadText.getInstance(  21,"!  USE cyyy9001_exception_hndlng_dflt");
    result[163] = PadText.getInstance(  21,
      "!     WHICH EXPORTS: Work View exp_error iyy1_component FROM Work View exp_error iyy1_component");
    result[164] = PadText.getInstance(  22,"!   ");
    result[165] = PadText.getInstance(  23,"!  NOTE: ");
    result[166] = PadText.getInstance(  23,"!  **************************************************************");
    result[167] = PadText.getInstance(  23,"!  Return/Reason code values");
    result[168] = PadText.getInstance(  23,"!  ");
    result[169] = PadText.getInstance(  24,"!  NOTE: ");
    result[170] = PadText.getInstance(  24,"!  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[171] = PadText.getInstance(  24,"!  Set the values of used return codes/reason codes.");
    result[172] = PadText.getInstance(  24,"!  ");
    result[173] = PadText.getInstance(  25,"!  SET loc dont_change_return_codes 1_ok TO 1 ");
    result[174] = PadText.getInstance(  26,"!  SET loc dont_change_return_codes n1110_unauthorized_operation TO -1110 ");
    result[175] = PadText.getInstance(  27,"!  SET loc dont_change_return_codes n1120_invalid_command TO -1120 ");
    result[176] = PadText.getInstance(  28,"!   ");
    result[177] = PadText.getInstance(  29,"!  SET loc dont_change_reason_codes 1_default TO 1 ");
    result[178] = PadText.getInstance(  30,"!   ");
    result[179] = PadText.getInstance(  31,"!  NOTE: ");
    result[180] = PadText.getInstance(  31,"!  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[181] = PadText.getInstance(  31,"!  Please rename the procedure name below.");
    result[182] = PadText.getInstance(  31,"!  ");
    result[183] = PadText.getInstance(  32,"!  SET SUBSCRIPT OF loc_group_context TO 1 ");
    result[184] = PadText.getInstance(  33,"!  SET loc_g_context dont_change_text text_150 TO \"CYY1S071\" ");
    result[185] = PadText.getInstance(  34,"!  SET SUBSCRIPT OF loc_group_context TO 2 ");
    result[186] = PadText.getInstance(  35,
      "!  SET loc_g_context dont_change_text text_150 TO imp_command iyy1_component send_command ");
    result[187] = PadText.getInstance(  36,"!   ");
    result[188] = PadText.getInstance(  37,"!  USE cyy1a131_server_init");
    result[189] = PadText.getInstance(  37,
      "!     WHICH EXPORTS: Work View loc_reference iyy1_server_data FROM Work View exp_reference iyy1_server_data");
    result[190] = PadText.getInstance(  38,"!  MOVE loc_reference iyy1_server_data TO exp_reference iyy1_server_data");
    result[191] = PadText.getInstance(  39,"!   ");
    result[192] = PadText.getInstance(  40,"!  NOTE: ");
    result[193] = PadText.getInstance(  40,"!  ****************************************************************");
    result[194] = PadText.getInstance(  40,"!  Security check");
    result[195] = PadText.getInstance(  40,"!  ");
    result[196] = PadText.getInstance(  41,"!  USE isc1z021_o_authorization_check_s");
    result[197] = PadText.getInstance(  41,
    ...
    result[199] = PadText.getInstance(  41,
      "!                    Work View loc_error isc1_component FROM Work View exp_error isc1_component");
    result[200] = PadText.getInstance(  42,"!   ");
    result[201] = PadText.getInstance(  43,"!  +->IF loc_error isc1_component return_code < loc dont_change_return_codes 1_ok");
    result[202] = PadText.getInstance(  44,"!  !  USE cyyy9831_mv_sc1_to_yy1");
    result[203] = PadText.getInstance(  44,
      "!  !     WHICH IMPORTS: Work View loc_error isc1_component TO Work View imp_error isc1_component");
    result[204] = PadText.getInstance(  44,
      "!  !     WHICH EXPORTS: Work View exp_error iyy1_component FROM Work View exp_error iyy1_component");
    result[205] = PadText.getInstance(  43,"!  +--");
    result[206] = PadText.getInstance(  45,"!   ");
    result[207] = PadText.getInstance(  46,"!  NOTE: ");
    result[208] = PadText.getInstance(  46,"!  ****************************************************************");
    result[209] = PadText.getInstance(  46,"!  All the necessary checking for the server is performed.");
    result[210] = PadText.getInstance(  46,"!  ");
    result[211] = PadText.getInstance(  47,"!  +->IF exp_error iyy1_component return_code = loc dont_change_return_codes 1_ok");
    result[212] = PadText.getInstance(  48,"!  !   ");
    result[213] = PadText.getInstance(  49,"!  !  NOTE: ");
    result[214] = PadText.getInstance(  49,"!  !  ****************************************************************");
    result[215] = PadText.getInstance(  49,"!  !  Check the required operation..");
    result[216] = PadText.getInstance(  49,"!  !  ");
    result[217] = PadText.getInstance(  50,"!  !  SET loc_reference iyy1_server_data userid TO imp isc1_authorization_info userid ")
      ;
    result[218] = PadText.getInstance(  51,"!  !   ");
    result[219] = PadText.getInstance(  52,"!  !  +->CASE OF imp_command iyy1_component send_command");
    result[220] = PadText.getInstance(  52, 1, "!  !  +> CASE \"INIT\"");
    result[221] = PadText.getInstance(  52, 2, "!  !  +> CASE \"CREATE\"");
    result[222] = PadText.getInstance(  53,"!  !  !  +->IF exp isc1_authorization_info authority_status_u ^= \"Y\"");
    result[223] = PadText.getInstance(  54,
      "!  !  !  !  SET exp_error iyy1_component return_code TO loc dont_change_return_codes n1110_unauthorized_operation ");
    result[224] = PadText.getInstance(  55,
      "!  !  !  !  SET exp_error iyy1_component reason_code TO loc dont_change_reason_codes 1_default ");
    result[225] = PadText.getInstance(  56,"!  !  !  !  SET SUBSCRIPT OF loc_group_context TO 3 ");
    result[226] = PadText.getInstance(  57,"!  !  !  !  SET loc_g_context dont_change_text text_150 TO CLIENT_USER_ID ");
    result[227] = PadText.getInstance(  53,"!  !  !  +--");
    result[228] = PadText.getInstance(  52, 3, "!  !  +> CASE \"READ\"");
    result[229] = PadText.getInstance(  58,"!  !  !  +->IF exp isc1_authorization_info authority_status_r ^= \"Y\"");
    result[230] = PadText.getInstance(  59,
      "!  !  !  !  SET exp_error iyy1_component return_code TO loc dont_change_return_codes n1110_unauthorized_operation ");
    result[231] = PadText.getInstance(  60,
      "!  !  !  !  SET exp_error iyy1_component reason_code TO loc dont_change_reason_codes 1_default ");
    result[232] = PadText.getInstance(  61,"!  !  !  !  SET SUBSCRIPT OF loc_group_context TO 3 ");
    result[233] = PadText.getInstance(  62,"!  !  !  !  SET loc_g_context dont_change_text text_150 TO CLIENT_USER_ID ");
    result[234] = PadText.getInstance(  58,"!  !  !  +--");
    result[235] = PadText.getInstance(  52, 4, "!  !  +> CASE \"UPDATE\"");
    result[236] = PadText.getInstance(  63,"!  !  !  +->IF exp isc1_authorization_info authority_status_u ^= \"Y\"");
    result[237] = PadText.getInstance(  64,
      "!  !  !  !  SET exp_error iyy1_component return_code TO loc dont_change_return_codes n1110_unauthorized_operation ");
    result[238] = PadText.getInstance(  65,
      "!  !  !  !  SET exp_error iyy1_component reason_code TO loc dont_change_reason_codes 1_default ");
    result[239] = PadText.getInstance(  66,"!  !  !  !  SET SUBSCRIPT OF loc_group_context TO 3 ");
    result[240] = PadText.getInstance(  67,"!  !  !  !  SET loc_g_context dont_change_text text_150 TO CLIENT_USER_ID ");
    result[241] = PadText.getInstance(  63,"!  !  !  +--");
    result[242] = PadText.getInstance(  52, 5, "!  !  +> CASE \"DELETE\"");
    result[243] = PadText.getInstance(  68,"!  !  !  +->IF exp isc1_authorization_info authority_status_d ^= \"Y\"");
    result[244] = PadText.getInstance(  69,
      "!  !  !  !  SET exp_error iyy1_component return_code TO loc dont_change_return_codes n1110_unauthorized_operation ");
    result[245] = PadText.getInstance(  70,
      "!  !  !  !  SET exp_error iyy1_component reason_code TO loc dont_change_reason_codes 1_default ");
    result[246] = PadText.getInstance(  71,"!  !  !  !  SET SUBSCRIPT OF loc_group_context TO 3 ");
    result[247] = PadText.getInstance(  72,"!  !  !  !  SET loc_g_context dont_change_text text_150 TO CLIENT_USER_ID ");
    result[248] = PadText.getInstance(  68,"!  !  !  +--");
    result[249] = PadText.getInstance(  52, 6, "!  !  +> OTHERWISE");
    result[250] = PadText.getInstance(  73,
    ...
    result[251] = PadText.getInstance(  74,
      "!  !  !  SET exp_error iyy1_component reason_code TO loc dont_change_reason_codes 1_default ");
    result[252] = PadText.getInstance(  75,"!  !  !  SET SUBSCRIPT OF loc_group_context TO 3 ");
    result[253] = PadText.getInstance(  76,
      "!  !  !  SET loc_g_context dont_change_text text_150 TO imp_command iyy1_component send_command ");
    result[254] = PadText.getInstance(  52,"!  !  +--");
    result[255] = PadText.getInstance(  77,"!  !   ");
    result[256] = PadText.getInstance(  78,"!  !  NOTE: ");
    result[257] = PadText.getInstance(  78,"!  !  ****************************************************************");
    result[258] = PadText.getInstance(  78,"!  !  All of the checking process is OK. Form the context string.");
    result[259] = PadText.getInstance(  78,"!  !  ");
    result[260] = PadText.getInstance(  79,"!  !  NOTE: ");
    result[261] = PadText.getInstance(  79,"!  !  ****************************************************************");
    result[262] = PadText.getInstance(  79,"!  !  Form the context string whether there is error or not. ");
    result[263] = PadText.getInstance(  79,"!  !  For non error situations there is a message returned.");
    result[264] = PadText.getInstance(  79,"!  !  ");
    result[265] = PadText.getInstance(  80,"!  !  USE cyyy9141_context_string_set");
    result[266] = PadText.getInstance(  80,"!  !     WHICH IMPORTS: Group View  loc_group_context TO Group View imp_group_context");
    result[267] = PadText.getInstance(  80,
      "!  !     WHICH EXPORTS: Work View loc_error iyy1_component FROM Work View exp_error iyy1_component");
    result[268] = PadText.getInstance(  80,
      "!  !                    Work View loc_context iyy1_component FROM Work View exp_context iyy1_component");
    result[269] = PadText.getInstance(  81,"!  !  +->IF loc_error iyy1_component return_code < loc dont_change_return_codes 1_ok");
    result[270] = PadText.getInstance(  82,"!  !  !  MOVE loc_error iyy1_component TO exp_error iyy1_component");
    result[271] = PadText.getInstance(  81, 1, "!  !  +> ELSE");
    ...
    result[273] = PadText.getInstance(  81,"!  !  +--");
    result[274] = PadText.getInstance(  47,"!  +--");
    result[275] = PadText.getInstance(  84,"!   ");
    result[276] = PadText.getInstance(  85,"!  NOTE: ");
    result[277] = PadText.getInstance(  85,"!  ****************************************************************");
    result[278] = PadText.getInstance(  85,"!  All of the checking process is OK.");
    result[279] = PadText.getInstance(  85,"!  ");
    result[280] = PadText.getInstance(  86,"!  +->IF exp_error iyy1_component return_code = loc dont_change_return_codes 1_ok");
    result[281] = PadText.getInstance(  87,"!  !   ");
    result[282] = PadText.getInstance(  88,"!  !  +->CASE OF imp_command iyy1_component send_command");
    result[283] = PadText.getInstance(  88, 1, "!  !  +> CASE \"INIT\"");
    result[284] = PadText.getInstance(  89,"!  !  !   ");
    result[285] = PadText.getInstance(  90,"!  !  !  NOTE: ");
    result[286] = PadText.getInstance(  90,"!  !  !  ****************************************************************");
    result[287] = PadText.getInstance(  90,"!  !  !  When server is called for the first time, things to be done.");
    result[288] = PadText.getInstance(  90,"!  !  !  ");
    result[289] = PadText.getInstance(  91,"!  !  !  NOTE: ");
    result[290] = PadText.getInstance(  91,"!  !  !  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[291] = PadText.getInstance(  91,"!  !  !  When server is called for the first time, insert code for things to be done.");
    result[292] = PadText.getInstance(  91,"!  !  !  ");
    result[293] = PadText.getInstance(  88, 2, "!  !  +> CASE \"CREATE\"");
    result[294] = PadText.getInstance(  92,"!  !  !  USE cyyy0311_type_create");
    result[295] = PadText.getInstance(  92,
      "!  !  !     WHICH IMPORTS: Work View loc_reference iyy1_server_data TO Work View imp_reference iyy1_server_data");
    result[296] = PadText.getInstance(  92,"!  !  !                    Entity View imp type TO Entity View imp type");
    result[297] = PadText.getInstance(  92,"!  !  !     WHICH EXPORTS: Entity View exp_ts type FROM Entity View exp type");
    result[298] = PadText.getInstance(  92,
      "!  !  !                    Work View loc_error iyy1_component FROM Work View exp_error iyy1_component");
    result[299] = PadText.getInstance(  93,"!  !  !   ");
    result[300] = PadText.getInstance(  94,"!  !  !  +->IF loc_error iyy1_component return_code < loc dont_change_return_codes 1_ok")
      ;
    result[301] = PadText.getInstance(  95,"!  !  !  !  NOTE: ");
    result[302] = PadText.getInstance(  95,"!  !  !  !  ****************************************************************");
    result[303] = PadText.getInstance(  95,"!  !  !  !  If the function raised an error..");
    result[304] = PadText.getInstance(  95,"!  !  !  !  ");
    result[305] = PadText.getInstance(  96,"!  !  !  !  MOVE loc_error iyy1_component TO exp_error iyy1_component");
    result[306] = PadText.getInstance(  94,"!  !  !  +--");
    result[307] = PadText.getInstance(  88, 3, "!  !  +> CASE \"READ\"");
    result[308] = PadText.getInstance(  97,"!  !  !  USE cyyy0321_type_read");
    result[309] = PadText.getInstance(  97,"!  !  !     WHICH IMPORTS: Entity View imp type TO Entity View imp type");
    result[310] = PadText.getInstance(  97,"!  !  !     WHICH EXPORTS: Entity View exp_all type FROM Entity View exp type");
    result[311] = PadText.getInstance(  97,
      "!  !  !                    Work View loc_error iyy1_component FROM Work View exp_error iyy1_component");
    result[312] = PadText.getInstance(  98,"!  !  !   ");
    result[313] = PadText.getInstance(  99,"!  !  !  MOVE exp_all type TO exp_ts type");
    result[314] = PadText.getInstance( 100,"!  !  !   ");
    result[315] = PadText.getInstance( 101,"!  !  !  +->IF loc_error iyy1_component return_code < loc dont_change_return_codes 1_ok")
      ;
    result[316] = PadText.getInstance( 102,"!  !  !  !  NOTE: ");
    result[317] = PadText.getInstance( 102,"!  !  !  !  ****************************************************************");
    result[318] = PadText.getInstance( 102,"!  !  !  !  If the function raised an error..");
    result[319] = PadText.getInstance( 102,"!  !  !  !  ");
    result[320] = PadText.getInstance( 103,"!  !  !  !  MOVE loc_error iyy1_component TO exp_error iyy1_component");
    result[321] = PadText.getInstance( 101,"!  !  !  +--");
    result[322] = PadText.getInstance(  88, 4, "!  !  +> CASE \"UPDATE\"");
    result[323] = PadText.getInstance( 104,"!  !  !  USE cyyy0331_type_update");
    result[324] = PadText.getInstance( 104,
      "!  !  !     WHICH IMPORTS: Work View loc_reference iyy1_server_data TO Work View imp_reference iyy1_server_data");
    result[325] = PadText.getInstance( 104,"!  !  !                    Entity View imp type TO Entity View imp type");
    result[326] = PadText.getInstance( 104,"!  !  !     WHICH EXPORTS: Entity View exp_ts type FROM Entity View exp type");
    result[327] = PadText.getInstance( 104,
      "!  !  !                    Work View loc_error iyy1_component FROM Work View exp_error iyy1_component");
    result[328] = PadText.getInstance( 105,"!  !  !   ");
    result[329] = PadText.getInstance( 106,"!  !  !  +->IF loc_error iyy1_component return_code < loc dont_change_return_codes 1_ok")
      ;
    result[330] = PadText.getInstance( 107,"!  !  !  !  NOTE: ");
    result[331] = PadText.getInstance( 107,"!  !  !  !  ****************************************************************");
    result[332] = PadText.getInstance( 107,"!  !  !  !  If the function raised an error..");
    result[333] = PadText.getInstance( 107,"!  !  !  !  ");
    result[334] = PadText.getInstance( 108,"!  !  !  !  MOVE loc_error iyy1_component TO exp_error iyy1_component");
    result[335] = PadText.getInstance( 106,"!  !  !  +--");
    result[336] = PadText.getInstance(  88, 5, "!  !  +> CASE \"DELETE\"");
    result[337] = PadText.getInstance( 109,"!  !  !  USE cyyy0341_type_delete");
    result[338] = PadText.getInstance( 109,
      "!  !  !     WHICH IMPORTS: Work View loc_reference iyy1_server_data TO Work View imp_reference iyy1_server_data");
    result[339] = PadText.getInstance( 109,"!  !  !                    Entity View imp type TO Entity View imp type");
    result[340] = PadText.getInstance( 109,
      "!  !  !     WHICH EXPORTS: Work View loc_error iyy1_component FROM Work View exp_error iyy1_component");
    result[341] = PadText.getInstance( 110,"!  !  !   ");
    result[342] = PadText.getInstance( 111,"!  !  !  +->IF loc_error iyy1_component return_code < loc dont_change_return_codes 1_ok")
      ;
    result[343] = PadText.getInstance( 112,"!  !  !  !  NOTE: ");
    result[344] = PadText.getInstance( 112,"!  !  !  !  ****************************************************************");
    result[345] = PadText.getInstance( 112,"!  !  !  !  If the function raised an error..");
    result[346] = PadText.getInstance( 112,"!  !  !  !  ");
    result[347] = PadText.getInstance( 113,"!  !  !  !  MOVE loc_error iyy1_component TO exp_error iyy1_component");
    result[348] = PadText.getInstance( 111,"!  !  !  +--");
    result[349] = PadText.getInstance(  88,"!  !  +--");
    result[350] = PadText.getInstance(  86,"!  +--");
    result[351] = PadText.getInstance( 114,"!   ");
    result[352] = PadText.getInstance( 115,"!  USE cyy1a121_server_termination");
    result[353] = PadText.getInstance( 115,
      "!     WHICH IMPORTS: Work View imp_dialect iyy1_component TO Work View imp_dialect iyy1_component");
    result[354] = PadText.getInstance( 115,
      "!                    Work View exp_error iyy1_component TO Work View imp_error iyy1_component");
    result[355] = PadText.getInstance( 115,
      "!     WHICH EXPORTS: Work View exp_error iyy1_component FROM Work View exp_error iyy1_component");
    result[356] = PadText.getInstance( 115,
      "!                    Work View exp_msg iyy1_component FROM Work View exp_error_msg iyy1_component");
    result[357] = PadText.getInstance(   0,"+---");
    result[358] = PadText.getInstance(PadText.LASTLINE,"************************* BOTTOM OF DATA *************************");
    return result;
  }
  final static int PADTEXT_SIZE = 359;
  ...
  public void CYY1S071( Object in_runtime_parm1, 
  	...
  	throws ABException
  {
    ...
    //    PRE-CONDITION:                                                  
    //    DELETE command,                                                 
    //    key fields and last update date are submitted.                  
    //    POST-CONDITION:                                                 
    ...
    if ( trace_ret_code != 8 )
    {
      w_la.LocGContextDontChangeTextText150[LocGroupContext_PS_001-1] = FixedStringAttr.valueOf("CYY1S071", (short)150);
      f_173015194_rgvc();
    }
...
"                                                                                                                                                      "
  ...
  public void f_20972302()
  	throws ABException
  {
    func_0020972302_esc_flag = false;
  ...
  public void f_20972479()
  	throws ABException
  {
    func_0020972479_esc_flag = false;
    ...
    //    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  
    //    !!                                                              
    //    When server is called for the first time,                       
    //    insert code for things to be done.                              
    //                                                                    
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  }
  	...
  	throws ABException
  {
    ...
    if ( trace_ret_code != 8 )
    {
      ...
      cyyy0311_ia = (gen.ort.yyy.CYYY0311_IA)(iefRuntimeParm2.getInstance("gen.ort.yyy.CYYY0311_IA"));
      cyyy0311_oa = (gen.ort.yyy.CYYY0311_OA)(iefRuntimeParm2.getInstance("gen.ort.yyy.CYYY0311_OA"));
      cyyy0311_ia.ImpTypeTkeyAttrText = FixedStringAttr.valueOf(w_ia.ImpTypeTkeyAttrText, (short)4);
      cyyy0311_ia.ImpTypeTsearchAttrText = FixedStringAttr.valueOf(w_ia.ImpTypeTsearchAttrText, (short)20);
      cyyy0311_ia.ImpTypeTotherAttrText = FixedStringAttr.valueOf(w_ia.ImpTypeTotherAttrText, (short)2);
      cyyy0311_ia.ImpTypeTotherAttrDate = DateAttr.valueOf(w_ia.ImpTypeTotherAttrDate);
      cyyy0311_ia.ImpTypeTotherAttrTime = TimeAttr.valueOf(w_ia.ImpTypeTotherAttrTime);
      cyyy0311_ia.ImpTypeTotherAttrAmount = BigDecimalAttr.valueOf(w_ia.ImpTypeTotherAttrAmount);
      cyyy0311_ia.ImpReferenceIyy1ServerDataUserid = FixedStringAttr.valueOf(w_la.LocReferenceIyy1ServerDataUserid, (short)8);
      cyyy0311_ia.ImpReferenceIyy1ServerDataReferenceId = TimestampAttr.valueOf(w_la.LocReferenceIyy1ServerDataReferenceId);
      globdata.getErrorData().setErrorEncounteredSW( ErrorData.NO_ERROR_FOUND_SW );
      iefRuntimeParm2.useActionBlock("gen.ort.yyy.CYYY0311", "CYYY0311", cyyy0311_ia, cyyy0311_oa);
      if ( ((!(globdata.getErrorData().getStatus().equals( ErrorData.NONE_SF ))) || (globdata.getErrorData().getErrorEncounteredSW() 
        != ErrorData.NO_ERROR_FOUND_SW)) || (globdata.getErrorData().getViewOverflowSW() != ErrorData.NO_ERROR_FOUND_SW) )
      {
        throw new ABException();
      ...
      globdata.getStateData().setCurrentABName( "CYY1S071_TYPE_MAINTAIN" );
      globdata.getStateData().setLastStatementNumber( "0000000092" );
      w_la.LocErrorIyy1ComponentSeverityCode = FixedStringAttr.valueOf(cyyy0311_oa.ExpErrorIyy1ComponentSeverityCode, (short)1);
      w_la.LocErrorIyy1ComponentRollbackIndicator = FixedStringAttr.valueOf(cyyy0311_oa.ExpErrorIyy1ComponentRollbackIndicator, (
        short)1);
      w_la.LocErrorIyy1ComponentOriginServid = DoubleAttr.valueOf(cyyy0311_oa.ExpErrorIyy1ComponentOriginServid);
      w_la.LocErrorIyy1ComponentContextString = StringAttr.valueOf(cyyy0311_oa.ExpErrorIyy1ComponentContextString, (short)512);
      w_la.LocErrorIyy1ComponentReturnCode = IntAttr.valueOf(cyyy0311_oa.ExpErrorIyy1ComponentReturnCode);
      w_la.LocErrorIyy1ComponentReasonCode = IntAttr.valueOf(cyyy0311_oa.ExpErrorIyy1ComponentReasonCode);
      w_la.LocErrorIyy1ComponentChecksum = FixedStringAttr.valueOf(cyyy0311_oa.ExpErrorIyy1ComponentChecksum, (short)15);
      w_oa.ExpTsTypeTinstanceId = TimestampAttr.valueOf(cyyy0311_oa.ExpTypeTinstanceId);
      w_oa.ExpTsTypeTreferenceId = TimestampAttr.valueOf(cyyy0311_oa.ExpTypeTreferenceId);
      cyyy0311_ia.freeInstance();
      cyyy0311_ia = null;
      cyyy0311_oa.freeInstance();
      cyyy0311_oa = null;
    }
  	...
  	throws ABException
  {
    ...
    if ( trace_ret_code != 8 )
    {
      ...
      cyyy0321_ia.ImpTypeTinstanceId = TimestampAttr.valueOf(w_ia.ImpTypeTinstanceId);
      cyyy0321_ia.ImpTypeTkeyAttrText = FixedStringAttr.valueOf(w_ia.ImpTypeTkeyAttrText, (short)4);
      globdata.getErrorData().setErrorEncounteredSW( ErrorData.NO_ERROR_FOUND_SW );
      ...
      w_oa.ExpAllTypeTotherAttrDate = DateAttr.valueOf(cyyy0321_oa.ExpTypeTotherAttrDate);
      w_oa.ExpAllTypeTotherAttrTime = TimeAttr.valueOf(cyyy0321_oa.ExpTypeTotherAttrTime);
      w_oa.ExpAllTypeTotherAttrAmount = BigDecimalAttr.valueOf(cyyy0321_oa.ExpTypeTotherAttrAmount);
    ...
    if ( trace_ret_code != 8 )
    {
      w_oa.ExpTsTypeTinstanceId = TimestampAttr.valueOf(w_oa.ExpAllTypeTinstanceId);
      w_oa.ExpTsTypeTreferenceId = TimestampAttr.valueOf(w_oa.ExpAllTypeTreferenceId);
    }
  	...
  	throws ABException
  {
    ...
    if ( trace_ret_code != 8 )
    {
      ...
      cyyy0331_ia = (gen.ort.yyy.CYYY0331_IA)(iefRuntimeParm2.getInstance("gen.ort.yyy.CYYY0331_IA"));
      cyyy0331_oa = (gen.ort.yyy.CYYY0331_OA)(iefRuntimeParm2.getInstance("gen.ort.yyy.CYYY0331_OA"));
      cyyy0331_ia.ImpTypeTinstanceId = TimestampAttr.valueOf(w_ia.ImpTypeTinstanceId);
      cyyy0331_ia.ImpTypeTreferenceId = TimestampAttr.valueOf(w_ia.ImpTypeTreferenceId);
      cyyy0331_ia.ImpTypeTkeyAttrText = FixedStringAttr.valueOf(w_ia.ImpTypeTkeyAttrText, (short)4);
      cyyy0331_ia.ImpTypeTsearchAttrText = FixedStringAttr.valueOf(w_ia.ImpTypeTsearchAttrText, (short)20);
      cyyy0331_ia.ImpTypeTotherAttrText = FixedStringAttr.valueOf(w_ia.ImpTypeTotherAttrText, (short)2);
      cyyy0331_ia.ImpTypeTotherAttrDate = DateAttr.valueOf(w_ia.ImpTypeTotherAttrDate);
      cyyy0331_ia.ImpTypeTotherAttrTime = TimeAttr.valueOf(w_ia.ImpTypeTotherAttrTime);
      cyyy0331_ia.ImpTypeTotherAttrAmount = BigDecimalAttr.valueOf(w_ia.ImpTypeTotherAttrAmount);
      cyyy0331_ia.ImpReferenceIyy1ServerDataUserid = FixedStringAttr.valueOf(w_la.LocReferenceIyy1ServerDataUserid, (short)8);
      cyyy0331_ia.ImpReferenceIyy1ServerDataReferenceId = TimestampAttr.valueOf(w_la.LocReferenceIyy1ServerDataReferenceId);
      globdata.getErrorData().setErrorEncounteredSW( ErrorData.NO_ERROR_FOUND_SW );
      iefRuntimeParm2.useActionBlock("gen.ort.yyy.CYYY0331", "CYYY0331", cyyy0331_ia, cyyy0331_oa);
      if ( ((!(globdata.getErrorData().getStatus().equals( ErrorData.NONE_SF ))) || (globdata.getErrorData().getErrorEncounteredSW() 
        != ErrorData.NO_ERROR_FOUND_SW)) || (globdata.getErrorData().getViewOverflowSW() != ErrorData.NO_ERROR_FOUND_SW) )
      {
        throw new ABException();
      ...
      globdata.getStateData().setCurrentABName( "CYY1S071_TYPE_MAINTAIN" );
      globdata.getStateData().setLastStatementNumber( "0000000104" );
      w_la.LocErrorIyy1ComponentSeverityCode = FixedStringAttr.valueOf(cyyy0331_oa.ExpErrorIyy1ComponentSeverityCode, (short)1);
      w_la.LocErrorIyy1ComponentRollbackIndicator = FixedStringAttr.valueOf(cyyy0331_oa.ExpErrorIyy1ComponentRollbackIndicator, (
        short)1);
      w_la.LocErrorIyy1ComponentOriginServid = DoubleAttr.valueOf(cyyy0331_oa.ExpErrorIyy1ComponentOriginServid);
      w_la.LocErrorIyy1ComponentContextString = StringAttr.valueOf(cyyy0331_oa.ExpErrorIyy1ComponentContextString, (short)512);
      w_la.LocErrorIyy1ComponentReturnCode = IntAttr.valueOf(cyyy0331_oa.ExpErrorIyy1ComponentReturnCode);
      w_la.LocErrorIyy1ComponentReasonCode = IntAttr.valueOf(cyyy0331_oa.ExpErrorIyy1ComponentReasonCode);
      w_la.LocErrorIyy1ComponentChecksum = FixedStringAttr.valueOf(cyyy0331_oa.ExpErrorIyy1ComponentChecksum, (short)15);
      w_oa.ExpTsTypeTreferenceId = TimestampAttr.valueOf(cyyy0331_oa.ExpTypeTreferenceId);
      cyyy0331_ia.freeInstance();
      cyyy0331_ia = null;
      cyyy0331_oa.freeInstance();
      cyyy0331_oa = null;
    }
  	...
  	throws ABException
  {
    ...
    if ( trace_ret_code != 8 )
    {
      ...
      cyyy0341_ia = (gen.ort.yyy.CYYY0341_IA)(iefRuntimeParm2.getInstance("gen.ort.yyy.CYYY0341_IA"));
      cyyy0341_oa = (gen.ort.yyy.CYYY0341_OA)(iefRuntimeParm2.getInstance("gen.ort.yyy.CYYY0341_OA"));
      cyyy0341_ia.ImpTypeTinstanceId = TimestampAttr.valueOf(w_ia.ImpTypeTinstanceId);
      cyyy0341_ia.ImpTypeTreferenceId = TimestampAttr.valueOf(w_ia.ImpTypeTreferenceId);
      cyyy0341_ia.ImpTypeTkeyAttrText = FixedStringAttr.valueOf(w_ia.ImpTypeTkeyAttrText, (short)4);
      cyyy0341_ia.ImpReferenceIyy1ServerDataUserid = FixedStringAttr.valueOf(w_la.LocReferenceIyy1ServerDataUserid, (short)8);
      cyyy0341_ia.ImpReferenceIyy1ServerDataReferenceId = TimestampAttr.valueOf(w_la.LocReferenceIyy1ServerDataReferenceId);
      globdata.getErrorData().setErrorEncounteredSW( ErrorData.NO_ERROR_FOUND_SW );
      iefRuntimeParm2.useActionBlock("gen.ort.yyy.CYYY0341", "CYYY0341", cyyy0341_ia, cyyy0341_oa);
      if ( ((!(globdata.getErrorData().getStatus().equals( ErrorData.NONE_SF ))) || (globdata.getErrorData().getErrorEncounteredSW() 
        != ErrorData.NO_ERROR_FOUND_SW)) || (globdata.getErrorData().getViewOverflowSW() != ErrorData.NO_ERROR_FOUND_SW) )
      {
        throw new ABException();
      ...
      globdata.getStateData().setCurrentABName( "CYY1S071_TYPE_MAINTAIN" );
      globdata.getStateData().setLastStatementNumber( "0000000109" );
      w_la.LocErrorIyy1ComponentSeverityCode = FixedStringAttr.valueOf(cyyy0341_oa.ExpErrorIyy1ComponentSeverityCode, (short)1);
      w_la.LocErrorIyy1ComponentRollbackIndicator = FixedStringAttr.valueOf(cyyy0341_oa.ExpErrorIyy1ComponentRollbackIndicator, (
        short)1);
      w_la.LocErrorIyy1ComponentOriginServid = DoubleAttr.valueOf(cyyy0341_oa.ExpErrorIyy1ComponentOriginServid);
      w_la.LocErrorIyy1ComponentContextString = StringAttr.valueOf(cyyy0341_oa.ExpErrorIyy1ComponentContextString, (short)512);
      w_la.LocErrorIyy1ComponentReturnCode = IntAttr.valueOf(cyyy0341_oa.ExpErrorIyy1ComponentReturnCode);
      w_la.LocErrorIyy1ComponentReasonCode = IntAttr.valueOf(cyyy0341_oa.ExpErrorIyy1ComponentReasonCode);
      w_la.LocErrorIyy1ComponentChecksum = FixedStringAttr.valueOf(cyyy0341_oa.ExpErrorIyy1ComponentChecksum, (short)15);
      cyyy0341_ia.freeInstance();
      cyyy0341_ia = null;
      cyyy0341_oa.freeInstance();
      cyyy0341_oa = null;
    }
  ...
  public void f_22020345_localAlloc(String abname)
  {
    ...
    w_la = (gen.ort.yyy.CYY1S071_LA)(iefRuntimeParm2.getInstance("gen.ort.yyy.CYY1S071_LA"));
    if ( w_la == null )
    {
      globdata.getStateData().setCurrentABId( "0022020345" );
  	...
  	throws ABException
  {
    ...
    w_oa.ExpAllTypeTotherAttrDate = 00000000;
    w_oa.ExpAllTypeTotherAttrTime = 00000000;
    w_oa.ExpAllTypeTotherAttrAmount = BigDecimalAttr.getDefaultValue();
    w_oa.ExpTsTypeTinstanceId = "00000000000000000000";
    w_oa.ExpTsTypeTreferenceId = "00000000000000000000";
...
padview[0] = PadView.getInstance("IMPORT                          ", 0, 0, 0, (short)1, PadView.VT_BASE, PadView.DT_NONE, w_ia, 
    ...
    padview[19] = PadView.getInstance("TKEY_ATTR_TEXT                  ", 4, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_ia, "ImpTypeTkeyAttrText");
    padview[20] = PadView.getInstance("TSEARCH_ATTR_TEXT               ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_ia, "ImpTypeTsearchAttrText");
    padview[21] = PadView.getInstance("TOTHER_ATTR_TEXT                ", 2, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_ia, "ImpTypeTotherAttrText");
    padview[22] = PadView.getInstance("TOTHER_ATTR_DATE                ", 8, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_DATE, 
      w_ia, "ImpTypeTotherAttrDate");
    padview[23] = PadView.getInstance("TOTHER_ATTR_TIME                ", 6, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TIME, 
      w_ia, "ImpTypeTotherAttrTime");
    padview[24] = PadView.getInstance("TOTHER_ATTR_AMOUNT              ", 17, 2, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_FIXED,
       w_ia, "ImpTypeTotherAttrAmount");
    padview[25] = PadView.getInstance("EXPORT                          ", 0, 0, 0, (short)1, PadView.VT_BASE, PadView.DT_NONE, w_oa, 
      "w_oa");
    padview[26] = PadView.getInstance("EXP_REFERENCE                   ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_oa, 
      null);
    padview[27] = PadView.getInstance("IYY1_SERVER_DATA                ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_oa, null);
    padview[28] = PadView.getInstance("SERVER_DATE                     ", 8, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_DATE, 
      w_oa, "ExpReferenceIyy1ServerDataServerDate");
    padview[29] = PadView.getInstance("SERVER_TIME                     ", 6, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TIME, 
      w_oa, "ExpReferenceIyy1ServerDataServerTime");
    padview[30] = PadView.getInstance("REFERENCE_ID                    ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_TIMESTAMP, w_oa, "ExpReferenceIyy1ServerDataReferenceId");
    padview[31] = PadView.getInstance("EXP                             ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_oa, 
      null);
    padview[32] = PadView.getInstance("ISC1_AUTHORIZATION_INFO         ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_oa, null);
    padview[33] = PadView.getInstance("TOKEN_ID                        ", 32, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpIsc1AuthorizationInfoTokenId");
    padview[34] = PadView.getInstance("AUTHORITY_IND                   ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpIsc1AuthorizationInfoAuthorityInd");
    padview[35] = PadView.getInstance("AUTHORITY_STATUS_R              ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpIsc1AuthorizationInfoAuthorityStatusR");
    padview[36] = PadView.getInstance("AUTHORITY_STATUS_U              ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpIsc1AuthorizationInfoAuthorityStatusU");
    padview[37] = PadView.getInstance("AUTHORITY_STATUS_D              ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpIsc1AuthorizationInfoAuthorityStatusD");
    padview[38] = PadView.getInstance("AUTHORITY_STATUS_L              ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpIsc1AuthorizationInfoAuthorityStatusL");
    padview[39] = PadView.getInstance("EXP_ALL                         ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_oa, 
      null);
    ...
    padview[44] = PadView.getInstance("TUPDATE_USER_ID                 ", 8, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpAllTypeTupdateUserId");
    padview[45] = PadView.getInstance("TKEY_ATTR_TEXT                  ", 4, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpAllTypeTkeyAttrText");
    padview[46] = PadView.getInstance("TSEARCH_ATTR_TEXT               ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpAllTypeTsearchAttrText");
    padview[47] = PadView.getInstance("TOTHER_ATTR_TEXT                ", 2, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_oa, "ExpAllTypeTotherAttrText");
    padview[48] = PadView.getInstance("TOTHER_ATTR_DATE                ", 8, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_DATE, 
      w_oa, "ExpAllTypeTotherAttrDate");
    padview[49] = PadView.getInstance("TOTHER_ATTR_TIME                ", 6, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TIME, 
      w_oa, "ExpAllTypeTotherAttrTime");
    padview[50] = PadView.getInstance("TOTHER_ATTR_AMOUNT              ", 17, 2, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_FIXED,
       w_oa, "ExpAllTypeTotherAttrAmount");
    padview[51] = PadView.getInstance("EXP_TS                          ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_oa, 
      null);
    ...
    padview[53] = PadView.getInstance("TINSTANCE_ID                    ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_TIMESTAMP, w_oa, "ExpTsTypeTinstanceId");
    padview[54] = PadView.getInstance("TREFERENCE_ID                   ", 20, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_TIMESTAMP, w_oa, "ExpTsTypeTreferenceId");
    ...
    padview[76] = PadView.getInstance("LOC_ERROR                       ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    padview[77] = PadView.getInstance("ISC1_COMPONENT                  ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_la, null);
    padview[78] = PadView.getInstance("SEVERITY_CODE                   ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocErrorIsc1ComponentSeverityCode");
    padview[79] = PadView.getInstance("ROLLBACK_INDICATOR              ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocErrorIsc1ComponentRollbackIndicator");
    padview[80] = PadView.getInstance("ORIGIN_SERVID                   ", 15, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocErrorIsc1ComponentOriginServid");
    padview[81] = PadView.getInstance("CONTEXT_STRING                  ", 512, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_VARCHAR, w_la, "LocErrorIsc1ComponentContextString");
    padview[82] = PadView.getInstance("RETURN_CODE                     ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocErrorIsc1ComponentReturnCode");
    padview[83] = PadView.getInstance("REASON_CODE                     ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocErrorIsc1ComponentReasonCode");
    padview[84] = PadView.getInstance("CHECKSUM                        ", 15, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocErrorIsc1ComponentChecksum");
    padview[85] = PadView.getInstance("LOC_GROUP_CONTEXT               ", 0, 0, 9, (short)2, PadView.VT_GROUP, PadView.DT_NONE, w_la,
       "LocGroupContext_MA");
    padview[86] = PadView.getInstance("LOC_G_CONTEXT                   ", 0, 0, 0, (short)3, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    padview[87] = PadView.getInstance("DONT_CHANGE_TEXT                ", 0, 0, 0, (short)4, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_la, null);
    padview[88] = PadView.getInstance("TEXT_150                        ", 150, 0, 0, (short)4, PadView.VT_PREDICATE, PadView.DT_TEXT,
       w_la, "LocGContextDontChangeTextText150");
    padview[89] = PadView.getInstance("LOC_ERROR                       ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    padview[90] = PadView.getInstance("IYY1_COMPONENT                  ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_la, null);
    padview[91] = PadView.getInstance("SEVERITY_CODE                   ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocErrorIyy1ComponentSeverityCode");
    padview[92] = PadView.getInstance("ROLLBACK_INDICATOR              ", 1, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocErrorIyy1ComponentRollbackIndicator");
    padview[93] = PadView.getInstance("ORIGIN_SERVID                   ", 15, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocErrorIyy1ComponentOriginServid");
    padview[94] = PadView.getInstance("CONTEXT_STRING                  ", 512, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_VARCHAR, w_la, "LocErrorIyy1ComponentContextString");
    padview[95] = PadView.getInstance("RETURN_CODE                     ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocErrorIyy1ComponentReturnCode");
    padview[96] = PadView.getInstance("REASON_CODE                     ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocErrorIyy1ComponentReasonCode");
    padview[97] = PadView.getInstance("CHECKSUM                        ", 15, 0, 0, (short)3, PadView.VT_PREDICATE, PadView.DT_TEXT, 
      w_la, "LocErrorIyy1ComponentChecksum");
    padview[98] = PadView.getInstance("LOC_CONTEXT                     ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_la, 
      null);
    ...
    padview[104] = PadView.getInstance("N1110_UNAUTHORIZED_OPERATION    ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocDontChangeReturnCodesN1110UnauthorizedOperation");
    padview[105] = PadView.getInstance("N1120_INVALID_COMMAND           ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocDontChangeReturnCodesN1120InvalidCommand");
    padview[106] = PadView.getInstance("LOC                             ", 0, 0, 0, (short)2, PadView.VT_VIEW, PadView.DT_NONE, w_la,
       null);
    padview[107] = PadView.getInstance("DONT_CHANGE_REASON_CODES        ", 0, 0, 0, (short)3, PadView.VT_ENTITY, PadView.DT_NONE, 
      w_la, null);
    padview[108] = PadView.getInstance("1_DEFAULT                       ", 5, 0, 0, (short)3, PadView.VT_PREDICATE, 
      PadView.DT_NUMERIC, w_la, "LocDontChangeReasonCodesQ1Default");
    padview[109] = PadView.getInstance("******** BOTTOM OF DATA ********", 0, 0, 0, (short)0, PadView.VT_END, PadView.DT_NONE, w_la, 
      null);
  }
...
/**
 * Contains the export request data returned from the 'CYY1S071_TYPE_MAINTAIN' server.
 * @see Cyy1s071TypeMaintain
 **/
@javax.xml.bind.annotation.XmlType(name="Cyy1s071TypeMaintainExport",
          propOrder={"command",
            "exitState",
            "exitStateType",
            "exitStateMessage",
...
public class Cyy1s071TypeMaintainExport  implements Externalizable, Cloneable
{
  private final static long serialVersionUID = 427823702L;
  /**
   * Default Constructor.
   **/
  public Cyy1s071TypeMaintainExport()
  {
  }
  /**
  ...
  public void setTrustClients(boolean value) {
    ...
    _ExpTsType.setTrustClients(_TrustClients);
  ...
  /**
   * Internal storage for ExpTsType entity view property.
   **/
  private ExpTsType _ExpTsType = new ExpTsType(_TrustClients);
  /**
   * Gets the ExpTsType property
   * 
   * @return a ExpTsType
   **/
  @javax.xml.bind.annotation.XmlElement(name="ExpTsType")
  public ExpTsType getExpTsType(){
    return(_ExpTsType);
  }
  
  /**
   * Sets the ExpTsType property
   * 
   * @param value the ExpTsType value
   **/
  public void setExpTsType(ExpTsType value){
    _ExpTsType = value;
  }
  ...
  {
    Cyy1s071TypeMaintainExport copy = new Cyy1s071TypeMaintainExport();
    ...
    copy._ExpTsType = (ExpTsType)_ExpTsType.clone();
  ...
  /**
   * Resets the Cyy1s071TypeMaintainExport class properties to all of their default values.
   **/
  public void reset()
  {
    _TrustClients = false;
  ...
  /**
   * Unserializes the Cyy1s071TypeMaintainExport class from the ObjectInput.
  	...
  	throws IOException
  {
    ...
    _ExpTsType.readExternal(in);
    _ExpMsgIyy1Component.readExternal(in);
    _ExpErrorIyy1Component.readExternal(in);
  }
  
  /**
   * Serializes the Cyy1s071TypeMaintainExport class to the ObjectOutput.
   * @throws IOException Thrown If an I/O error has occurred.
   **/
  ...
  @Override public String toString()
  {
    ...
    result.append(", ExpTsType (" + _ExpTsType + ")");
  ...
  static public class ExpAllType  implements Externalizable, Cloneable
  {
    ...
    private  void checkTotherAttrDate( java.sql.Date value ) throws IllegalArgumentException 
    {
      if ( value == null )
      {
        throw new IllegalArgumentException("Property ExpAllType.TotherAttrDate is required and cannot be zero or empty");
      }
    }
    ...
    private  void checkTotherAttrTime( java.sql.Time value ) throws IllegalArgumentException 
    {
      if ( value == null )
      {
        throw new IllegalArgumentException("Property ExpAllType.TotherAttrTime is required and cannot be zero or empty");
      }
    }
    ...
    private  void checkTotherAttrAmount( BigDecimal value ) throws IllegalArgumentException 
    {
      if ( value.scale() > 2 )
      {
        throw new IllegalArgumentException("Property ExpAllType.TotherAttrAmount cannot be more than 2 fractional digits");
      }
      if ( (value.precision() - value.scale()) > 15 )
      {
        throw new IllegalArgumentException("Property ExpAllType.TotherAttrAmount cannot be more than 15 integral digits");
      }
      if ( value.signum() == 0 )
      {
        throw new IllegalArgumentException("Property ExpAllType.TotherAttrAmount is required and cannot be zero or empty");
      }
    }
  ...
  /**
   * Contains the data for the ExpTsType entity view.
   **/
  @javax.xml.bind.annotation.XmlType(name="",
            propOrder={          "tinstanceId",
            "treferenceId"}
  )
  static public class ExpTsType  implements Externalizable, Cloneable
  {
    /**
     * Default Constructor.
     **/
     ...
     * Constructor.
     **/
    public ExpTsType(boolean TrustClients)
    {
      _TrustClients = TrustClients;
    }
    /**
    ...
    private  void checkTinstanceId( java.sql.Timestamp value ) throws IllegalArgumentException 
    {
      if ( value == null )
      {
        throw new IllegalArgumentException("Property ExpTsType.TinstanceId is required and cannot be zero or empty");
      }
    }
    ...
    private  void checkTreferenceId( java.sql.Timestamp value ) throws IllegalArgumentException 
    {
      if ( value == null )
      {
        throw new IllegalArgumentException("Property ExpTsType.TreferenceId is required and cannot be zero or empty");
      }
    }
    ...
    /**
     * Resets the ExpTsType class properties to all of their default values.
     **/
    public void reset()
    {
      resetTinstanceId();
    ...
    @Override public Object clone()
    {
      ExpTsType copy = new ExpTsType(_TrustClients);
      copy._TinstanceId = _TinstanceId;
      copy._TreferenceId = _TreferenceId;
      return(copy);
    }
    ...
    /**
     * Unserializes the ExpTsType Entity View class from the ObjectInput.
     * @throws IOException Thrown If an I/O error has occurred.
     **/
    public void readExternal(ObjectInput in)
    	throws IOException
    ...
    /**
     * Serializes the ExpTsType Entity View class from the ObjectOutput.
     * @throws IOException Thrown If an I/O error has occurred.
     **/
    public void writeExternal(ObjectOutput out)
    	throws IOException
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: Cyy1s071TypeMaintainExportWrapper Date: 2023/07/05
//    User: HakanBal                         Time: 15:09:06
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
/**
 * Wraps a Cyy1s071TypeMaintainExport class as an IExportWrapper. Allows for the generic access by runtimes and conversions. 
 * @see IExportWrapper
 * @see Cyy1s071TypeMaintainExport
 * @see CYY1S071_OA
 **/
public class Cyy1s071TypeMaintainExportWrapper  implements IExportWrapper, Serializable
{
  /**
   * Returns a Cyy1s071TypeMaintainExportWrapper instance, wrapping a default Cyy1s071TypeMaintainExport.
   **/
  public Cyy1s071TypeMaintainExportWrapper()
  {
  }
  
  /**
   * Returns a Cyy1s071TypeMaintainExportWrapper instance, wrapping the Cyy1s071TypeMaintainExport instance parameter.
   **/
  public Cyy1s071TypeMaintainExportWrapper(Object exportView)
  {
    setExport((Cyy1s071TypeMaintainExport)exportView);
  }
  
  /**
   * Returns a Cyy1s071TypeMaintainExportWrapper instance, wrapping a Cyy1s071TypeMaintainExport instance initialized with the 
    parameters.
   **/
  public Cyy1s071TypeMaintainExportWrapper(IExportView oa, String command, int exitStateType, int exitState, String exitStateMessage)
   ...
   **/
  private Cyy1s071TypeMaintainExport exportView = null;
  /**
  ...
  public Object getExport()
  {
    if ( exportView == null )
    {
      exportView = new Cyy1s071TypeMaintainExport();
    }
    return(exportView);
  }
  ...
  {
    exportView = (Cyy1s071TypeMaintainExport)value;
  }
  ...
  public String getCommand()
  {
    Cyy1s071TypeMaintainExport exportView = (Cyy1s071TypeMaintainExport)getExport();
  ...
  /**
   * Returns a CYY1S071_OA instance based on the Cyy1s071TypeMaintainExport export view instance.
   * No validation is performed during the mapping.
   **/
  public IExportView getOA()
  {
    CYY1S071_OA result = CYY1S071_OA.getInstance();
    ...
    result.ExpAllTypeTotherAttrDate = DateAttr.valueOf(exportView.getExpAllType().getTotherAttrDate());
    result.ExpAllTypeTotherAttrTime = TimeAttr.valueOf(exportView.getExpAllType().getTotherAttrTime());
    result.ExpAllTypeTotherAttrAmount = BigDecimalAttr.valueOf(exportView.getExpAllType().getTotherAttrAmount());
    result.ExpTsTypeTinstanceId = TimestampAttr.valueOf(exportView.getExpTsType().getTinstanceId());
    result.ExpTsTypeTreferenceId = TimestampAttr.valueOf(exportView.getExpTsType().getTreferenceId());
  ...
  /**
   * Based on the CYY1S071_OA instance set the Cyy1s071TypeMaintainExport export view instance.
   * No validation is performed during the mapping.
   **/
  public void setOA(IExportView value)
  {
    CYY1S071_OA view = (CYY1S071_OA)value;
    ...
    exportView.getExpAllType().setTotherAttrDate(DateAttr.toSQLDate(view.ExpAllTypeTotherAttrDate));
    exportView.getExpAllType().setTotherAttrTime(TimeAttr.toSQLTime(view.ExpAllTypeTotherAttrTime));
    exportView.getExpAllType().setTotherAttrAmount(BigDecimalAttr.toBigDecimal(view.ExpAllTypeTotherAttrAmount));
    exportView.getExpTsType().setTinstanceId(TimestampAttr.toSQLTimestamp(view.ExpTsTypeTinstanceId));
    exportView.getExpTsType().setTreferenceId(TimestampAttr.toSQLTimestamp(view.ExpTsTypeTreferenceId));
...
/**
 * Contains the import request data for the 'CYY1S071_TYPE_MAINTAIN' server.
 * @see Cyy1s071TypeMaintain
 **/
@javax.xml.bind.annotation.XmlType(name="Cyy1s071TypeMaintainImport",
          propOrder={"command",
            "clientId",
            "clientPassword",
            "nextLocation",
...
public class Cyy1s071TypeMaintainImport  implements Externalizable, Cloneable
{
  private final static long serialVersionUID = 423628996L;
  /**
   * Default Constructor.
   **/
  public Cyy1s071TypeMaintainImport()
  {
  }
  /**
   * Internal storage for TrustClients property.
  ...
  @Override public Object clone()
  {
    Cyy1s071TypeMaintainImport copy = new Cyy1s071TypeMaintainImport();
    copy._TrustClients = _TrustClients;
    copy._Command = _Command;
  ...
  /**
   * Resets the Cyy1s071TypeMaintainImport class properties to all of their default values.
   **/
  public void reset()
  {
    _TrustClients = false;
  ...
  /**
   * Unserializes the Cyy1s071TypeMaintainImport class from the ObjectInput.
   * @throws IOException Thrown If an I/O error has occurred.
   **/
  public void readExternal(ObjectInput in)
  	throws IOException
  ...
  /**
   * Serializes the Cyy1s071TypeMaintainImport class to the ObjectOutput.
   * @throws IOException Thrown If an I/O error has occurred.
   **/
  public void writeExternal(ObjectOutput out)
  	throws IOException
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: Cyy1s071TypeMaintainImportWrapper Date: 2023/07/05
//    User: HakanBal                         Time: 15:09:06
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
/**
 * Wraps a Cyy1s071TypeMaintainImport class as an IImportWrapper. Allows for the generic access by runtimes and conversions. 
 * @see IImportWrapper
 * @see Cyy1s071TypeMaintainImport
 * @see CYY1S071_IA
 **/
public class Cyy1s071TypeMaintainImportWrapper  implements IImportWrapper, Serializable
{
  /**
   * Returns a Cyy1s071TypeMaintainImportWrapper instance, wrapping a default Cyy1s071TypeMaintainImport.
   **/
  public Cyy1s071TypeMaintainImportWrapper()
  {
  }
  
  /**
   * Returns a Cyy1s071TypeMaintainImportWrapper instance, wrapping the Cyy1s071TypeMaintainImport instance parameter.
   **/
  public Cyy1s071TypeMaintainImportWrapper(Object importView)
  {
    setImport((Cyy1s071TypeMaintainImport)importView);
  }
  
  /**
   * Returns a Cyy1s071TypeMaintainImportWrapper instance, wrapping a Cyy1s071TypeMaintainImport instance initialized with the 
    parameters.
   **/
  public Cyy1s071TypeMaintainImportWrapper(IImportView ia, String command, String nextLocation, String clientId, String 
   ...
   **/
  private Cyy1s071TypeMaintainImport importView = null;
  /**
  ...
  public Object getImport()
  {
    if ( importView == null )
    {
      importView = new Cyy1s071TypeMaintainImport();
    }
    return(importView);
  }
  ...
  {
    importView = (Cyy1s071TypeMaintainImport)value;
  }
  ...
  public String getCommand()
  {
    Cyy1s071TypeMaintainImport importView = (Cyy1s071TypeMaintainImport)getImport();
  ...
  /**
   * Returns a CYY1S071_IA instance based on the Cyy1s071TypeMaintainImport import view instance.
   * No validation is performed during the mapping.
   **/
  public IImportView getIA()
  {
    CYY1S071_IA result = CYY1S071_IA.getInstance();
  ...
  /**
   * Based on the CYY1S071_IA instance set the Cyy1s071TypeMaintainImport import view instance.
   * No validation is performed during the mapping.
   **/
  public void setIA(IImportView value)
  {
    ...
    boolean saveTrustClients = importView.getTrustClients();
    importView.setTrustClients(true);
    if (value instanceof CYY1S071_IA) {
      view = (CYY1S071_IA)value;
    }
    else {
      view = CYY1S071_IA.getInstance();
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYY1S071_IA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:09:10
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 ...
 **/
public class CYY1S071_IA extends ViewBase implements IImportView, Serializable
{
    ...
    if ( localVdf == null )
    {
      VDFEntry [] vdfEntries = {
        ...
        new VDFEntry((int)10, "", "ImpType", "Type", "TreferenceId", VDFEntry.TYPE_TIMESTAMP, (short)1, (short)0, 20, (short)0, null)
          , 
        new VDFEntry((int)11, "", "ImpType", "Type", "TkeyAttrText", VDFEntry.TYPE_STRING, (short)1, (short)0, 4, (short)0, null), 
        new VDFEntry((int)12, "", "ImpType", "Type", "TsearchAttrText", VDFEntry.TYPE_STRING, (short)1, (short)0, 20, (short)0, null)
          , 
        new VDFEntry((int)13, "", "ImpType", "Type", "TotherAttrText", VDFEntry.TYPE_STRING, (short)1, (short)0, 2, (short)0, null), 
          
        new VDFEntry((int)14, "", "ImpType", "Type", "TotherAttrDate", VDFEntry.TYPE_DATE, (short)1, (short)0, 8, (short)0, null), 
        new VDFEntry((int)15, "", "ImpType", "Type", "TotherAttrTime", VDFEntry.TYPE_TIME, (short)1, (short)0, 6, (short)0, null), 
        new VDFEntry((int)16, "", "ImpType", "Type", "TotherAttrAmount", VDFEntry.TYPE_FIXED, (short)1, (short)0, 17, (short)2, null)
          , 
      };
  ...
  public VDF getVDF()
  {
    ...
    // predicate view item
    vdf.getEntries()[10].getDataValue().setObject(ImpTypeTkeyAttrText);
    // predicate view item
    vdf.getEntries()[11].getDataValue().setObject(ImpTypeTsearchAttrText);
    // predicate view item
    vdf.getEntries()[12].getDataValue().setObject(ImpTypeTotherAttrText);
    // predicate view item
    vdf.getEntries()[13].getDataValue().setObject(new Integer(ImpTypeTotherAttrDate));
    // predicate view item
    vdf.getEntries()[14].getDataValue().setObject(new Integer(ImpTypeTotherAttrTime));
    // predicate view item
    vdf.getEntries()[15].getDataValue().setObject(ImpTypeTotherAttrAmount);
    return(vdf);
  }
  ...
  public void setFromVDF(VDF vdf)
  {
    ...
    {
      ImpTypeTkeyAttrText = ((String)vdf.getEntries()[10].getDataValue().getObject());
    }
    else 
    {
      ImpTypeTkeyAttrText = "    ";
    ...
    {
      ImpTypeTsearchAttrText = ((String)vdf.getEntries()[11].getDataValue().getObject());
    }
    else 
    {
      ImpTypeTsearchAttrText = "                    ";
    ...
    {
      ImpTypeTotherAttrText = ((String)vdf.getEntries()[12].getDataValue().getObject());
    }
    else 
    {
      ImpTypeTotherAttrText = "  ";
    ...
    {
      ImpTypeTotherAttrDate = ((Integer)vdf.getEntries()[13].getDataValue().getObject()).intValue();
    }
    else 
    {
      ImpTypeTotherAttrDate = 00000000;
    ...
    {
      ImpTypeTotherAttrTime = ((Integer)vdf.getEntries()[14].getDataValue().getObject()).intValue();
    }
    else 
    {
      ImpTypeTotherAttrTime = 00000000;
    ...
    {
      ImpTypeTotherAttrAmount = ((BigDecimal)vdf.getEntries()[15].getDataValue().getObject());
    }
    else 
    {
      ImpTypeTotherAttrAmount = BigDecimalAttr.getDefaultValue();
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYY1S071_LA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:09:10
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: CYY1S071_LA
 **/
public class CYY1S071_LA extends ViewBase implements ILocalView, Serializable
{
  ...
  public CYY1S071_LA(CYY1S071_LA orig)
  {
  ...
  public static CYY1S071_LA getInstance()
  {
    return new CYY1S071_LA();
  }
  /**
   * Static free instance method
   **/
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYY1S071_OA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:09:10
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 ...
 **/
public class CYY1S071_OA extends ViewBase implements IExportView, Serializable
{
  static VDF localVdf = null;
   ...
   * Decimal Precision: Y
   **/
  public BigDecimal ExpAllTypeTotherAttrAmount;
  // Entity View: EXP_TS
  //        Type: TYPE
  /**
  ...
  public void reset()
  {
    ...
    ExpAllTypeTotherAttrAmount = BigDecimalAttr.getDefaultValue();
    ...
    if ( localVdf == null )
    {
      VDFEntry [] vdfEntries = {
        ...
        new VDFEntry((int)9, "", "ExpIsc1AuthorizationInfo", "Isc1AuthorizationInfo", "AuthorityStatusL", VDFEntry.TYPE_STRING, (
          short)1, (short)0, 1, (short)0, null), 
        new VDFEntry((int)10, "", "ExpAllType", "Type", "TinstanceId", VDFEntry.TYPE_TIMESTAMP, (short)1, (short)0, 20, (short)0, 
          null), 
        new VDFEntry((int)11, "", "ExpAllType", "Type", "TreferenceId", VDFEntry.TYPE_TIMESTAMP, (short)1, (short)0, 20, (short)0, 
          null), 
        new VDFEntry((int)12, "", "ExpAllType", "Type", "TcreateUserId", VDFEntry.TYPE_STRING, (short)1, (short)0, 8, (short)0, null)
          , 
        new VDFEntry((int)13, "", "ExpAllType", "Type", "TupdateUserId", VDFEntry.TYPE_STRING, (short)1, (short)0, 8, (short)0, null)
          , 
        new VDFEntry((int)14, "", "ExpAllType", "Type", "TkeyAttrText", VDFEntry.TYPE_STRING, (short)1, (short)0, 4, (short)0, null),
           
        new VDFEntry((int)15, "", "ExpAllType", "Type", "TsearchAttrText", VDFEntry.TYPE_STRING, (short)1, (short)0, 20, (short)0, 
          null), 
        new VDFEntry((int)16, "", "ExpAllType", "Type", "TotherAttrText", VDFEntry.TYPE_STRING, (short)1, (short)0, 2, (short)0, 
          null), 
        new VDFEntry((int)17, "", "ExpAllType", "Type", "TotherAttrDate", VDFEntry.TYPE_DATE, (short)1, (short)0, 8, (short)0, null),
           
        new VDFEntry((int)18, "", "ExpAllType", "Type", "TotherAttrTime", VDFEntry.TYPE_TIME, (short)1, (short)0, 6, (short)0, null),
           
        new VDFEntry((int)19, "", "ExpAllType", "Type", "TotherAttrAmount", VDFEntry.TYPE_FIXED, (short)1, (short)0, 17, (short)2, 
          null), 
        new VDFEntry((int)20, "", "ExpTsType", "Type", "TinstanceId", VDFEntry.TYPE_TIMESTAMP, (short)1, (short)0, 20, (short)0, 
          null), 
        new VDFEntry((int)21, "", "ExpTsType", "Type", "TreferenceId", VDFEntry.TYPE_TIMESTAMP, (short)1, (short)0, 20, (short)0, 
          null), 
  ...
  public void setFromVDF(VDF vdf)
  {
    ...
    if ( vdf.getEntries()[9].getDataValue().getObject() != null )
    {
      ExpAllTypeTinstanceId = ((String)vdf.getEntries()[9].getDataValue().getObject());
    }
    else 
    {
      ExpAllTypeTinstanceId = "00000000000000000000";
    ...
    if ( vdf.getEntries()[10].getDataValue().getObject() != null )
    {
      ExpAllTypeTreferenceId = ((String)vdf.getEntries()[10].getDataValue().getObject());
    }
    else 
    {
      ExpAllTypeTreferenceId = "00000000000000000000";
    ...
    if ( vdf.getEntries()[11].getDataValue().getObject() != null )
    {
      ExpAllTypeTcreateUserId = ((String)vdf.getEntries()[11].getDataValue().getObject());
    }
    else 
    {
      ExpAllTypeTcreateUserId = "        ";
    ...
    if ( vdf.getEntries()[12].getDataValue().getObject() != null )
    {
      ExpAllTypeTupdateUserId = ((String)vdf.getEntries()[12].getDataValue().getObject());
    }
    else 
    {
      ExpAllTypeTupdateUserId = "        ";
    ...
    if ( vdf.getEntries()[13].getDataValue().getObject() != null )
    {
      ExpAllTypeTkeyAttrText = ((String)vdf.getEntries()[13].getDataValue().getObject());
    }
    else 
    {
      ExpAllTypeTkeyAttrText = "    ";
    ...
    if ( vdf.getEntries()[14].getDataValue().getObject() != null )
    {
      ExpAllTypeTsearchAttrText = ((String)vdf.getEntries()[14].getDataValue().getObject());
    }
    else 
    {
      ExpAllTypeTsearchAttrText = "                    ";
    ...
    if ( vdf.getEntries()[15].getDataValue().getObject() != null )
    {
      ExpAllTypeTotherAttrText = ((String)vdf.getEntries()[15].getDataValue().getObject());
    }
    else 
    {
      ExpAllTypeTotherAttrText = "  ";
    ...
    {
      ExpAllTypeTotherAttrDate = ((Integer)vdf.getEntries()[16].getDataValue().getObject()).intValue();
    }
    else 
    {
      ExpAllTypeTotherAttrDate = 00000000;
    ...
    {
      ExpAllTypeTotherAttrTime = ((Integer)vdf.getEntries()[17].getDataValue().getObject()).intValue();
    }
    else 
    {
      ExpAllTypeTotherAttrTime = 00000000;
    ...
    {
      ExpAllTypeTotherAttrAmount = ((BigDecimal)vdf.getEntries()[18].getDataValue().getObject());
    }
    else 
    {
      ExpAllTypeTotherAttrAmount = BigDecimalAttr.getDefaultValue();
    ...
    {
      ExpTsTypeTinstanceId = ((String)vdf.getEntries()[19].getDataValue().getObject());
    }
    else 
    {
      ExpTsTypeTinstanceId = "00000000000000000000";
    ...
    {
      ExpTsTypeTreferenceId = ((String)vdf.getEntries()[20].getDataValue().getObject());
    }
    else 
    {
      ExpTsTypeTreferenceId = "00000000000000000000";
  ...
  public VDF getVDF()
  {
    ...
    // predicate view item
    vdf.getEntries()[9].getDataValue().setObject(ExpAllTypeTinstanceId);
    // predicate view item
    vdf.getEntries()[10].getDataValue().setObject(ExpAllTypeTreferenceId);
    // predicate view item
    vdf.getEntries()[11].getDataValue().setObject(ExpAllTypeTcreateUserId);
    // predicate view item
    vdf.getEntries()[12].getDataValue().setObject(ExpAllTypeTupdateUserId);
    // predicate view item
    vdf.getEntries()[13].getDataValue().setObject(ExpAllTypeTkeyAttrText);
    // predicate view item
    vdf.getEntries()[14].getDataValue().setObject(ExpAllTypeTsearchAttrText);
    // predicate view item
    vdf.getEntries()[15].getDataValue().setObject(ExpAllTypeTotherAttrText);
    // predicate view item
    vdf.getEntries()[16].getDataValue().setObject(new Integer(ExpAllTypeTotherAttrDate));
    // predicate view item
    vdf.getEntries()[17].getDataValue().setObject(new Integer(ExpAllTypeTotherAttrTime));
    // predicate view item
    vdf.getEntries()[18].getDataValue().setObject(ExpAllTypeTotherAttrAmount);
    // predicate view item
    vdf.getEntries()[19].getDataValue().setObject(ExpTsTypeTinstanceId);
    // predicate view item
    vdf.getEntries()[20].getDataValue().setObject(ExpTsTypeTreferenceId);
    // predicate view item
...
// Generated Bean Interface for procedure step: CYY1S071_TYPE_MAINTAIN
// EJBName: CYY1S071_TYPE_MAINTAIN_Bean Date:       2023 Time: 15:09:06
...
@Stateless(name = "CYY1S071_TYPE_MAINTAIN")
public class CYY1S071_TYPE_MAINTAIN_Bean
 implements CYY1S071_TYPE_MAINTAIN_Local,
            CYY1S071_TYPE_MAINTAIN_Remote {
  
  private EJBProcedureStepContext psctx;
  @Resource public SessionContext context;
  private EJBRMIResponse execute(EJBRMIRequest rs, CYY1S071_IA iv)
  	throws Exception
  {
    if ( null == psctx )
    {
    ...
    return(psctx.execute( rs, "gen.ort.yyy.CYY1S071", "CYY1S071", iv, "gen.ort.yyy.CYY1S071_OA"));
  }
  
  public EJBRMIResponse call(EJBRMIRequest rs, CYY1S071_IA iv)
  	throws Exception
  {
    return(execute( rs, iv ));
  }
  
  // External Import and Export view call for CYY1S071_TYPE_MAINTAIN
  public Cyy1s071TypeMaintainExport call(Cyy1s071TypeMaintainImport in)
  	throws Exception
  {
    Cyy1s071TypeMaintainImportWrapper iw = new Cyy1s071TypeMaintainImportWrapper(in);
    EJBRMIRequest rs = new EJBRMIRequest( iw.getCommand(), "YY07", iw.getNextLocation(), iw.getExitState(), iw.getDialect(), 
      iw.getClientId(), iw.getClientPassword(), null);
    EJBRMIResponse rq;
    rq = execute(rs, (CYY1S071_IA)iw.getIA());
    if (rq.isErrorEncountered() || rq.wasAbortRequested()) {
      throw new Exception(rq.createExceptionStr());
    }
    Cyy1s071TypeMaintainExportWrapper xw = new Cyy1s071TypeMaintainExportWrapper( rq.getResponseView(), rq.getCommand(), 
      rq.getExitStateType(), rq.getExitState(), rq.getExitInfoMsg() );
    return (Cyy1s071TypeMaintainExport)xw.getExport();
  }
  
  // External Import and Export view call for CYY1S071_TYPE_MAINTAIN
  public Cyy1s071TypeMaintainExport Cyy1s071TypeMaintaincall(Cyy1s071TypeMaintainImport in)
  	throws Exception
  {
    Cyy1s071TypeMaintainImportWrapper iw = new Cyy1s071TypeMaintainImportWrapper(in);
    EJBRMIRequest rs = new EJBRMIRequest( iw.getCommand(), "YY07", iw.getNextLocation(), iw.getExitState(), iw.getDialect(), 
...
// CA Gen Enterprise Java Beans
// Generated Local Interface for procedure step:  CYY1S071_TYPE_MAINTAIN
// EJBName: CYY1S071_TYPE_MAINTAIN_Local Date:       2023 Time: 15:09:06

import javax.ejb.Local;
import com.ca.gen.odc.coopflow.ejbrmi.EJBRMIRequest;
import com.ca.gen.odc.coopflow.ejbrmi.EJBRMIResponse;

@Local public interface CYY1S071_TYPE_MAINTAIN_Local 
{
  public EJBRMIResponse call(EJBRMIRequest rs, CYY1S071_IA iv)
  	throws Exception
  ;
...
// CA Gen Enterprise Java Beans
// Generated Remote Interface for procedure step:  CYY1S071_TYPE_MAINTAIN
// EJBName: CYY1S071_TYPE_MAINTAIN_Remote Date:       2023 Time: 15:09:06

import javax.ejb.Remote;

@Remote public interface CYY1S071_TYPE_MAINTAIN_Remote 
{
  public Cyy1s071TypeMaintainExport Cyy1s071TypeMaintaincall(Cyy1s071TypeMaintainImport in)
  	throws Exception
  ;

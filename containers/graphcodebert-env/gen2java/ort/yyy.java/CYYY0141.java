...
//
//    Name: CYYY0141_PARENT_DELETE           Date: 2023/07/05
//    Target OS:   JVM                       Time: 15:08:14
...
public class CYYY0141 extends ABBase
{
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  ...
  gen.ort.yyy.DYYY0141_IA dyyy0141_ia;
  gen.ort.yyy.DYYY0141_OA dyyy0141_oa;
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  ...
  //    FOLLOW AS NEEDED:             
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  boolean func_0022020343_esc_flag;
  boolean func_0020972421_esc_flag;
  boolean func_0020972397_esc_flag;
  boolean func_0020972425_esc_flag;
  ...
  public PadText [] initPadText()
  {
    ...
    result[0] = PadText.getInstance(   0,"+->   CYYY0141_PARENT_DELETE            07/05/2023  15:08");
    ...
    result[38] = PadText.getInstance(   1,"!  See the description for the purpose.");
    ...
    result[49] = PadText.getInstance(   5,"!  Name the method below");
    result[50] = PadText.getInstance(   5,"!  ");
    result[51] = PadText.getInstance(   6,"!  SET SUBSCRIPT OF loc_group_context TO 1 ");
    result[52] = PadText.getInstance(   7,"!  SET loc_g_context dont_change_text text_150 TO \"CYYY0141\" ");
    ...
    result[58] = PadText.getInstance(  11,"!  The used ReturnCode/ReasonCode values");
    result[59] = PadText.getInstance(  11,"!  ");
    result[60] = PadText.getInstance(  12,"!  NOTE: ");
    result[61] = PadText.getInstance(  12,"!  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    result[62] = PadText.getInstance(  12,"!  Set the return and reason codes below");
    ...
    result[69] = PadText.getInstance(  18,"!  !  USE dyyy0141_parent_delete");
    ...
    result[72] = PadText.getInstance(  18,"!  !                    Entity View imp parent TO Entity View imp parent");
    result[73] = PadText.getInstance(  18,
      "!  !     WHICH EXPORTS: Work View loc_error iyy1_component FROM Work View exp_error iyy1_component");
    result[74] = PadText.getInstance(  19,"!  !  +->IF loc_error iyy1_component return_code < loc dont_change_return_codes 1_ok");
    result[75] = PadText.getInstance(  20,"!  !  !  MOVE loc_error iyy1_component TO exp_error iyy1_component");
    result[76] = PadText.getInstance(  21,"!  !  !  NOTE: ");
    result[77] = PadText.getInstance(  21,"!  !  !  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    ...
    result[80] = PadText.getInstance(  22,"! <------ESCAPE");
    result[81] = PadText.getInstance(  19,"!  !  +--");
    result[82] = PadText.getInstance(  17,"!  +--");
    result[83] = PadText.getInstance(  23,"!   ");
    result[84] = PadText.getInstance(  24,"!  +->IF exp_error iyy1_component return_code < loc dont_change_return_codes 1_ok");
    result[85] = PadText.getInstance(  25,"!  !  USE cyyy9141_context_string_set");
    result[86] = PadText.getInstance(  25,"!  !     WHICH IMPORTS: Group View  loc_group_context TO Group View imp_group_context");
    ...
    result[90] = PadText.getInstance(  27,"!  !  +->IF loc_error iyy1_component return_code < loc dont_change_return_codes 1_ok");
    result[91] = PadText.getInstance(  28,"!  !  !  MOVE loc_error iyy1_component TO exp_error iyy1_component");
    result[92] = PadText.getInstance(  27,"!  !  +--");
    result[93] = PadText.getInstance(  29,"!  !  SET exp_error iyy1_component severity_code TO \"E\" ");
  ...
  //       +->   CYYY0141_PARENT_DELETE            07/05/2023  15:08
  //       !       IMPORTS:
  ...
  //     7 !  SET loc_g_context dont_change_text text_150 TO "CYYY0141" 
  ...
  public CYYY0141()
  {
    ...
    iefCGenTime = "15:08:14";
    iefCGenEncy = "9.2.A6";
    iefCGenUserId = "HakanBal";
    iefCGenModel = "N8I_ORT_YYY_0112_TEMPLATE";
    iefCGenSubset = "ALL";
    iefCGenName = "CYYY0141_PARENT_DELETE";
    nestingLevel = 0;
  ...
  public void CYYY0141( Object in_runtime_parm1, 
  	IRuntimePStepContext in_runtime_parm2, 
  	GlobData in_globdata, 
  	CYYY0141_IA import_view, 
  	CYYY0141_OA export_view )
  {
  ...
  private void _CYYY0141()
  {
    
    f_22020343_localAlloc("CYYY0141_PARENT_DELETE");
  ...
  public void f_22020343()
  	throws ABException
  {
    func_0022020343_esc_flag = false;
    globdata.getStateData().setCurrentABId( "0022020343" );
    globdata.getStateData().setCurrentABName( "CYYY0141_PARENT_DELETE" );
    padview_init();
    ...
    f_0022020343_esctag: 
    {
      ...
      if ( trace_ret_code != 8 )
      {
        w_la.LocGContextDontChangeTextText150[LocGroupContext_PS_001-1] = FixedStringAttr.valueOf("CYYY0141", (short)150);
        f_173015106_rgvc();
      }
      ...
      if ( func_0022020343_esc_flag )
      {
        break f_0022020343_esctag;
      }
  ...
  public void f_20972421()
  	throws ABException
  {
    func_0020972421_esc_flag = false;
    f_0020972421_esctag: 
    {
      ...
      if ( trace_ret_code != 8 )
      {
        ...
        dyyy0141_ia = (gen.ort.yyy.DYYY0141_IA)(iefRuntimeParm2.getInstance("gen.ort.yyy.DYYY0141_IA"));
        dyyy0141_oa = (gen.ort.yyy.DYYY0141_OA)(iefRuntimeParm2.getInstance("gen.ort.yyy.DYYY0141_OA"));
        dyyy0141_ia.ImpParentPinstanceId = TimestampAttr.valueOf(w_ia.ImpParentPinstanceId);
        dyyy0141_ia.ImpParentPreferenceId = TimestampAttr.valueOf(w_ia.ImpParentPreferenceId);
        dyyy0141_ia.ImpParentPkeyAttrText = FixedStringAttr.valueOf(w_ia.ImpParentPkeyAttrText, (short)5);
        dyyy0141_ia.ImpReferenceIyy1ServerDataUserid = FixedStringAttr.valueOf(w_ia.ImpReferenceIyy1ServerDataUserid, (short)8);
        dyyy0141_ia.ImpReferenceIyy1ServerDataReferenceId = TimestampAttr.valueOf(w_ia.ImpReferenceIyy1ServerDataReferenceId);
        dyyy0141_ia.ImpErrorIyy1ComponentSeverityCode = FixedStringAttr.valueOf(w_oa.ExpErrorIyy1ComponentSeverityCode, (short)1);
        dyyy0141_ia.ImpErrorIyy1ComponentRollbackIndicator = FixedStringAttr.valueOf(w_oa.ExpErrorIyy1ComponentRollbackIndicator, (
          short)1);
        dyyy0141_ia.ImpErrorIyy1ComponentOriginServid = DoubleAttr.valueOf(w_oa.ExpErrorIyy1ComponentOriginServid);
        dyyy0141_ia.ImpErrorIyy1ComponentContextString = StringAttr.valueOf(w_oa.ExpErrorIyy1ComponentContextString, (short)512);
        dyyy0141_ia.ImpErrorIyy1ComponentReturnCode = IntAttr.valueOf(w_oa.ExpErrorIyy1ComponentReturnCode);
        dyyy0141_ia.ImpErrorIyy1ComponentReasonCode = IntAttr.valueOf(w_oa.ExpErrorIyy1ComponentReasonCode);
        dyyy0141_ia.ImpErrorIyy1ComponentChecksum = FixedStringAttr.valueOf(w_oa.ExpErrorIyy1ComponentChecksum, (short)15);
        globdata.getErrorData().setErrorEncounteredSW( ErrorData.NO_ERROR_FOUND_SW );
        iefRuntimeParm2.useActionBlock("gen.ort.yyy.DYYY0141", "DYYY0141", dyyy0141_ia, dyyy0141_oa);
        if ( ((!(globdata.getErrorData().getStatus().equals( ErrorData.NONE_SF ))) || (globdata.getErrorData().getErrorEncounteredSW(
          ) != ErrorData.NO_ERROR_FOUND_SW)) || (globdata.getErrorData().getViewOverflowSW() != ErrorData.NO_ERROR_FOUND_SW) )
        {
          throw new ABException();
        ...
        globdata.getStateData().setCurrentABName( "CYYY0141_PARENT_DELETE" );
        globdata.getStateData().setLastStatementNumber( "0000000018" );
        w_la.LocErrorIyy1ComponentSeverityCode = FixedStringAttr.valueOf(dyyy0141_oa.ExpErrorIyy1ComponentSeverityCode, (short)1);
        w_la.LocErrorIyy1ComponentRollbackIndicator = FixedStringAttr.valueOf(dyyy0141_oa.ExpErrorIyy1ComponentRollbackIndicator, (
          short)1);
        w_la.LocErrorIyy1ComponentOriginServid = DoubleAttr.valueOf(dyyy0141_oa.ExpErrorIyy1ComponentOriginServid);
        w_la.LocErrorIyy1ComponentContextString = StringAttr.valueOf(dyyy0141_oa.ExpErrorIyy1ComponentContextString, (short)512);
        w_la.LocErrorIyy1ComponentReturnCode = IntAttr.valueOf(dyyy0141_oa.ExpErrorIyy1ComponentReturnCode);
        w_la.LocErrorIyy1ComponentReasonCode = IntAttr.valueOf(dyyy0141_oa.ExpErrorIyy1ComponentReasonCode);
        w_la.LocErrorIyy1ComponentChecksum = FixedStringAttr.valueOf(dyyy0141_oa.ExpErrorIyy1ComponentChecksum, (short)15);
        dyyy0141_ia.freeInstance();
        dyyy0141_ia = null;
        dyyy0141_oa.freeInstance();
        dyyy0141_oa = null;
      }
  ...
  public void f_20972397()
  	throws ABException
  {
    func_0020972397_esc_flag = false;
...
"                                                                                                                                                      "
  ...
  public void f_20972425()
  	throws ABException
  {
    func_0020972425_esc_flag = false;
    f_0020972425_esctag: 
    {
      ...
      if ( trace_ret_code != 8 )
      {
        func_0020972425_esc_flag = true;
        func_0020972421_esc_flag = true;
      }
    }
  }
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  ...
  public void f_22020343_localAlloc(String abname)
  {
    // Request localview allocation 
    w_la = (gen.ort.yyy.CYYY0141_LA)(iefRuntimeParm2.getInstance("gen.ort.yyy.CYYY0141_LA"));
    if ( w_la == null )
    {
      globdata.getStateData().setCurrentABId( "0022020343" );
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYYY0141_IA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:08:14
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 ...
 **/
public class CYYY0141_IA extends ViewBase implements IImportView, Serializable
{
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYYY0141_LA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:08:14
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: CYYY0141_LA
 **/
public class CYYY0141_LA extends ViewBase implements ILocalView, Serializable
{
  ...
  public CYYY0141_LA(CYYY0141_LA orig)
  {
  ...
  public static CYYY0141_LA getInstance()
  {
    return new CYYY0141_LA();
  }
  /**
   * Static free instance method
   **/
...
//    Copyright (c) 2023 CA Technologies. All rights reserved.
//
//    Name: CYYY0141_OA                      Date: 2023/07/05
//    User: HakanBal                         Time: 15:08:14
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: CYYY0141_OA
 **/
public class CYYY0141_OA extends ViewBase implements IExportView, Serializable
{
  ...
  public CYYY0141_OA(CYYY0141_OA orig)
  {
    copyFrom(orig);
  }
  /**
  ...
  public static CYYY0141_OA getInstance()
  {
    return new CYYY0141_OA();
  }
  /**
   * Static free instance method
   **/
  ...
  {
    this.copyFrom((CYYY0141_OA) orig);
  }
  
  /**
   * Sets the current instance based on the passed view.
   **/
  public void copyFrom(CYYY0141_OA orig)
  {

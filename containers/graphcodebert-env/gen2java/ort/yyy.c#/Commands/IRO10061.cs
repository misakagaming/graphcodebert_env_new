namespace GEN.ORT.YYY
{
  ...
  //
  //    Name: IRO10061_CMPNT_NM_AND_PRMS_GET_S Date: 2024/01/09
  ...
  public class IRO10061 : ABBase
  {
    ...
    //    FOLLOW AS NEEDED:             
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    //       +->   IRO10061_CMPNT_NM_AND_PRMS_GET_S  01/09/2024  13:41
    //       !       IMPORTS:
    //       !         Work View in_data iro1_component (Transient, Optional,
    //       !                     Import only)
    //       !           specification_id
    //       !           implementation_id
    //       !           origin_servid
    ...
    //    11 !  NOTE: 
    //    11 !  PRE-CONDITION:
    //    11 !  Input valid Specification, Implementation and/or Origin
    //    11 !  Server Identifiers.
    //    11 !  POST-CONDITION:
    //    11 !  Component ID and description returned
    //    12 !   
    //    13 !  NOTE: 
    //    13 !  RETURN / REASON  CODES
    //    13 !  
    //    13 !  + 0001/0001            All OK
    //    13 !  - 0010/0016            Specification not found               
    //    13 !  - 0010/0017            Implementation not found              
    //    13 !  - 0010/0018            Origin Server not found      
    //       +---
    ...
    public IRO10061(  )
    {
      ...
      IefCGenSubset = "ALL";
      IefCGenName = "IRO10061_CMPNT_NM_AND_PRMS_GET_S";
      NestingLevel = 0;
    ...
    public void Execute( Object in_runtime_parm1, 
    	...
    	IRO10061_IA import_view, 
    	IRO10061_OA export_view )
    {

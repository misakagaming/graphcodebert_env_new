namespace GEN.ORT.YYY
{
  ...
  //
  //    Name: CYYY0221_CHILD_READ              Date: 2024/01/09
  //    Target OS:   CLR                       Time: 13:41:02
  ...
  public class CYYY0221 : ABBase
  {
    ...
    GEN.ORT.YYY.DYYY0221_IA Dyyy0221Ia;
    GEN.ORT.YYY.DYYY0221_OA Dyyy0221Oa;
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    ...
    //    FOLLOW AS NEEDED:             
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    bool func_0022020121_esc_flag;
    bool func_0020972878_esc_flag;
    bool func_0020971899_esc_flag;
    bool func_0020972882_esc_flag;
    //       +->   CYYY0221_CHILD_READ               01/09/2024  13:41
    //       !       IMPORTS:
    ...
    //    18 !  !                    Entity View imp child TO Entity View imp
    //    18 !  !              child
    //    18 !  !     WHICH EXPORTS: Entity View exp child FROM Entity View
    //    18 !  !              exp child
    ...
    public void f_22020121(  )
    {
      ...
      Globdata.GetStateData().SetCurrentABName( "CYYY0221_CHILD_READ" );
      {
        ...
        WLa.LocGContextDontChangeTextText150[LocGroupContext_PS_001-1] = FixedStringAttr.ValueOf("CYYY0221", 150);
        f_173015149_rgvc(  );
    ...
    public void f_20972878(  )
    {
      func_0020972878_esc_flag = false;
      {
        ...
        Dyyy0221Ia = (GEN.ORT.YYY.DYYY0221_IA)(IefRuntimeParm2.GetInstance( typeof(GEN.ORT.YYY.DYYY0221).Assembly,
        	"GEN.ORT.YYY.DYYY0221_IA" ));
        Dyyy0221Oa = (GEN.ORT.YYY.DYYY0221_OA)(IefRuntimeParm2.GetInstance( typeof(GEN.ORT.YYY.DYYY0221).Assembly,
        	"GEN.ORT.YYY.DYYY0221_OA" ));
        Dyyy0221Ia.ImpChildCinstanceId = TimestampAttr.ValueOf(WIa.ImpChildCinstanceId);
        Dyyy0221Ia.ImpChildCparentPkeyAttrText = FixedStringAttr.ValueOf(WIa.ImpChildCparentPkeyAttrText, 5);
        Dyyy0221Ia.ImpChildCkeyAttrNum = IntAttr.ValueOf(WIa.ImpChildCkeyAttrNum);
        Dyyy0221Ia.ImpErrorIyy1ComponentSeverityCode = FixedStringAttr.ValueOf(WOa.ExpErrorIyy1ComponentSeverityCode, 1);
        Dyyy0221Ia.ImpErrorIyy1ComponentRollbackIndicator = FixedStringAttr.ValueOf(WOa.ExpErrorIyy1ComponentRollbackIndicator, 1);
        Dyyy0221Ia.ImpErrorIyy1ComponentOriginServid = DoubleAttr.ValueOf(WOa.ExpErrorIyy1ComponentOriginServid);
        Dyyy0221Ia.ImpErrorIyy1ComponentContextString = StringAttr.ValueOf(WOa.ExpErrorIyy1ComponentContextString, 512);
        Dyyy0221Ia.ImpErrorIyy1ComponentReturnCode = IntAttr.ValueOf(WOa.ExpErrorIyy1ComponentReturnCode);
        Dyyy0221Ia.ImpErrorIyy1ComponentReasonCode = IntAttr.ValueOf(WOa.ExpErrorIyy1ComponentReasonCode);
        Dyyy0221Ia.ImpErrorIyy1ComponentChecksum = FixedStringAttr.ValueOf(WOa.ExpErrorIyy1ComponentChecksum, 15);
        Globdata.GetErrorData().SetErrorEncountered( ErrorData.ErrorEncounteredNoErrorFound );
        IefRuntimeParm2.UseActionBlock( typeof(GEN.ORT.YYY.DYYY0221).Assembly,
        	"GEN.ORT.YYY.DYYY0221",
        	"Execute",
        	Dyyy0221Ia,
        	Dyyy0221Oa );
        if ( ((Globdata.GetErrorData().GetStatus() != ErrorData.StatusNone) || (Globdata.GetErrorData().GetErrorEncountered() != 
        ...
        Globdata.GetStateData().SetCurrentABName( "CYYY0221_CHILD_READ" );
        Globdata.GetStateData().SetLastStatementNumber( "0000000018" );
        WLa.LocErrorIyy1ComponentSeverityCode = FixedStringAttr.ValueOf(Dyyy0221Oa.ExpErrorIyy1ComponentSeverityCode, 1);
        WLa.LocErrorIyy1ComponentRollbackIndicator = FixedStringAttr.ValueOf(Dyyy0221Oa.ExpErrorIyy1ComponentRollbackIndicator, 1);
        WLa.LocErrorIyy1ComponentOriginServid = DoubleAttr.ValueOf(Dyyy0221Oa.ExpErrorIyy1ComponentOriginServid);
        WLa.LocErrorIyy1ComponentContextString = StringAttr.ValueOf(Dyyy0221Oa.ExpErrorIyy1ComponentContextString, 512);
        WLa.LocErrorIyy1ComponentReturnCode = IntAttr.ValueOf(Dyyy0221Oa.ExpErrorIyy1ComponentReturnCode);
        WLa.LocErrorIyy1ComponentReasonCode = IntAttr.ValueOf(Dyyy0221Oa.ExpErrorIyy1ComponentReasonCode);
        WLa.LocErrorIyy1ComponentChecksum = FixedStringAttr.ValueOf(Dyyy0221Oa.ExpErrorIyy1ComponentChecksum, 15);
        WOa.ExpChildCinstanceId = TimestampAttr.ValueOf(Dyyy0221Oa.ExpChildCinstanceId);
        WOa.ExpChildCreferenceId = TimestampAttr.ValueOf(Dyyy0221Oa.ExpChildCreferenceId);
        WOa.ExpChildCcreateUserId = FixedStringAttr.ValueOf(Dyyy0221Oa.ExpChildCcreateUserId, 8);
        WOa.ExpChildCupdateUserId = FixedStringAttr.ValueOf(Dyyy0221Oa.ExpChildCupdateUserId, 8);
        WOa.ExpChildCparentPkeyAttrText = FixedStringAttr.ValueOf(Dyyy0221Oa.ExpChildCparentPkeyAttrText, 5);
        WOa.ExpChildCkeyAttrNum = IntAttr.ValueOf(Dyyy0221Oa.ExpChildCkeyAttrNum);
        WOa.ExpChildCsearchAttrText = FixedStringAttr.ValueOf(Dyyy0221Oa.ExpChildCsearchAttrText, 25);
        WOa.ExpChildCotherAttrText = FixedStringAttr.ValueOf(Dyyy0221Oa.ExpChildCotherAttrText, 25);
        Dyyy0221Ia.FreeInstance(  );
        Dyyy0221Ia = null;
        Dyyy0221Oa.FreeInstance(  );
        Dyyy0221Oa = null;
...
"                                                                                                                                                      "
    ...
    public void f_22020121_localAlloc( String abname )
    {
      ...
      WLa = (GEN.ORT.YYY.CYYY0221_LA)(IefRuntimeParm2.GetInstance( GetType().Assembly,
      	"GEN.ORT.YYY.CYYY0221_LA" ));
      if ( WLa == null )
      {
        Globdata.GetStateData().SetCurrentABId( "0022020121" );

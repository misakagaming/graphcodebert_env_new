namespace GEN.ORT.YYY
{
  ...
  //
  //    Name: CYYY0121_PARENT_READ             Date: 2024/01/09
  ...
  public class CYYY0121 : ABBase
  {
    ...
    GEN.ORT.YYY.DYYY0121_IA Dyyy0121Ia;
    GEN.ORT.YYY.DYYY0121_OA Dyyy0121Oa;
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    ...
    //    FOLLOW AS NEEDED:             
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    bool func_0022020342_esc_flag;
    bool func_0020972066_esc_flag;
    bool func_0020972328_esc_flag;
    bool func_0020972161_esc_flag;
    //       +->   CYYY0121_PARENT_READ              01/09/2024  13:40
    //       !       IMPORTS:
    ...
    //    18 !  !                    Entity View imp parent TO Entity View imp
    //    18 !  !              parent
    //    18 !  !     WHICH EXPORTS: Entity View exp parent FROM Entity View
    //    18 !  !              exp parent
    //    18 !  !                    Work View loc_error iyy1_component FROM
    //    18 !  !              Work View exp_error iyy1_component
    //    19 !  !  +->IF loc_error iyy1_component return_code < loc
    //    19 !  !  !        dont_change_return_codes 1_ok
    //    20 !  !  !  MOVE loc_error iyy1_component TO exp_error
    //    20 !  !  !              iyy1_component
    //    21 !  !  !  NOTE: 
    //    21 ...!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    //    21 ...!!!!!!!!!!!
    //    21 ...!! WARNING: In D AB, if there' s a need for generating
    //    21 ...context string, must exit from ESCAPE AB.
    //    21 ...
    //    22 ! <------ESCAPE
    //    19 !  !  +--
    //    17 !  +--
    ...
    //    25 !  !     WHICH IMPORTS: Group View  loc_group_context TO Group
    //    25 !  !              View imp_group_context
    //    25 !  !     WHICH EXPORTS: Work View loc_error iyy1_component FROM
    //    25 !  !              Work View exp_error iyy1_component
    //    25 !  !                    Work View exp_error iyy1_component FROM
    //    25 !  !              Work View exp_context iyy1_component
    //    26 !  !   
    //    27 !  !  +->IF loc_error iyy1_component return_code < loc
    //    27 !  !  !        dont_change_return_codes 1_ok
    //    28 !  !  !  MOVE loc_error iyy1_component TO exp_error
    //    28 !  !  !              iyy1_component
    //    27 !  !  +--
    ...
    public void f_22020342(  )
    {
      ...
      Globdata.GetStateData().SetCurrentABName( "CYYY0121_PARENT_READ" );
      {
        ...
        WLa.LocGContextDontChangeTextText150[LocGroupContext_PS_001-1] = FixedStringAttr.ValueOf("CYYY0121", 150);
        f_173015067_rgvc(  );
    ...
    public void f_20972066(  )
    {
      func_0020972066_esc_flag = false;
      {
        ...
        Dyyy0121Ia = (GEN.ORT.YYY.DYYY0121_IA)(IefRuntimeParm2.GetInstance( typeof(GEN.ORT.YYY.DYYY0121).Assembly,
        	"GEN.ORT.YYY.DYYY0121_IA" ));
        Dyyy0121Oa = (GEN.ORT.YYY.DYYY0121_OA)(IefRuntimeParm2.GetInstance( typeof(GEN.ORT.YYY.DYYY0121).Assembly,
        	"GEN.ORT.YYY.DYYY0121_OA" ));
        Dyyy0121Ia.ImpParentPinstanceId = TimestampAttr.ValueOf(WIa.ImpParentPinstanceId);
        Dyyy0121Ia.ImpParentPkeyAttrText = FixedStringAttr.ValueOf(WIa.ImpParentPkeyAttrText, 5);
        Dyyy0121Ia.ImpErrorIyy1ComponentSeverityCode = FixedStringAttr.ValueOf(WOa.ExpErrorIyy1ComponentSeverityCode, 1);
        Dyyy0121Ia.ImpErrorIyy1ComponentRollbackIndicator = FixedStringAttr.ValueOf(WOa.ExpErrorIyy1ComponentRollbackIndicator, 1);
        Dyyy0121Ia.ImpErrorIyy1ComponentOriginServid = DoubleAttr.ValueOf(WOa.ExpErrorIyy1ComponentOriginServid);
        Dyyy0121Ia.ImpErrorIyy1ComponentContextString = StringAttr.ValueOf(WOa.ExpErrorIyy1ComponentContextString, 512);
        Dyyy0121Ia.ImpErrorIyy1ComponentReturnCode = IntAttr.ValueOf(WOa.ExpErrorIyy1ComponentReturnCode);
        Dyyy0121Ia.ImpErrorIyy1ComponentReasonCode = IntAttr.ValueOf(WOa.ExpErrorIyy1ComponentReasonCode);
        Dyyy0121Ia.ImpErrorIyy1ComponentChecksum = FixedStringAttr.ValueOf(WOa.ExpErrorIyy1ComponentChecksum, 15);
        Globdata.GetErrorData().SetErrorEncountered( ErrorData.ErrorEncounteredNoErrorFound );
        IefRuntimeParm2.UseActionBlock( typeof(GEN.ORT.YYY.DYYY0121).Assembly,
        	"GEN.ORT.YYY.DYYY0121",
        	"Execute",
        	Dyyy0121Ia,
        	Dyyy0121Oa );
        if ( ((Globdata.GetErrorData().GetStatus() != ErrorData.StatusNone) || (Globdata.GetErrorData().GetErrorEncountered() != 
        ...
        Globdata.GetStateData().SetCurrentABName( "CYYY0121_PARENT_READ" );
        Globdata.GetStateData().SetLastStatementNumber( "0000000018" );
        WLa.LocErrorIyy1ComponentSeverityCode = FixedStringAttr.ValueOf(Dyyy0121Oa.ExpErrorIyy1ComponentSeverityCode, 1);
        WLa.LocErrorIyy1ComponentRollbackIndicator = FixedStringAttr.ValueOf(Dyyy0121Oa.ExpErrorIyy1ComponentRollbackIndicator, 1);
        WLa.LocErrorIyy1ComponentOriginServid = DoubleAttr.ValueOf(Dyyy0121Oa.ExpErrorIyy1ComponentOriginServid);
        WLa.LocErrorIyy1ComponentContextString = StringAttr.ValueOf(Dyyy0121Oa.ExpErrorIyy1ComponentContextString, 512);
        WLa.LocErrorIyy1ComponentReturnCode = IntAttr.ValueOf(Dyyy0121Oa.ExpErrorIyy1ComponentReturnCode);
        WLa.LocErrorIyy1ComponentReasonCode = IntAttr.ValueOf(Dyyy0121Oa.ExpErrorIyy1ComponentReasonCode);
        WLa.LocErrorIyy1ComponentChecksum = FixedStringAttr.ValueOf(Dyyy0121Oa.ExpErrorIyy1ComponentChecksum, 15);
        WOa.ExpParentPinstanceId = TimestampAttr.ValueOf(Dyyy0121Oa.ExpParentPinstanceId);
        WOa.ExpParentPreferenceId = TimestampAttr.ValueOf(Dyyy0121Oa.ExpParentPreferenceId);
        WOa.ExpParentPcreateUserId = FixedStringAttr.ValueOf(Dyyy0121Oa.ExpParentPcreateUserId, 8);
        WOa.ExpParentPupdateUserId = FixedStringAttr.ValueOf(Dyyy0121Oa.ExpParentPupdateUserId, 8);
        WOa.ExpParentPkeyAttrText = FixedStringAttr.ValueOf(Dyyy0121Oa.ExpParentPkeyAttrText, 5);
        WOa.ExpParentPsearchAttrText = FixedStringAttr.ValueOf(Dyyy0121Oa.ExpParentPsearchAttrText, 25);
        WOa.ExpParentPotherAttrText = FixedStringAttr.ValueOf(Dyyy0121Oa.ExpParentPotherAttrText, 25);
        WOa.ExpParentPtypeTkeyAttrText = FixedStringAttr.ValueOf(Dyyy0121Oa.ExpParentPtypeTkeyAttrText, 4);
        Dyyy0121Ia.FreeInstance(  );
        Dyyy0121Ia = null;
        Dyyy0121Oa.FreeInstance(  );
        Dyyy0121Oa = null;
...
"                                                                                                                                                      "
    ...
    public void f_22020342_localAlloc( String abname )
    {
      ...
      WLa = (GEN.ORT.YYY.CYYY0121_LA)(IefRuntimeParm2.GetInstance( GetType().Assembly,
      	"GEN.ORT.YYY.CYYY0121_LA" ));
      if ( WLa == null )
      {
        Globdata.GetStateData().SetCurrentABId( "0022020342" );

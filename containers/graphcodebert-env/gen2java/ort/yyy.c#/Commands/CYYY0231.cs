namespace GEN.ORT.YYY
{
  ...
  //
  //    Name: CYYY0231_CHILD_UPDATE            Date: 2024/01/09
  //    Target OS:   CLR                       Time: 13:41:03
  ...
  public class CYYY0231 : ABBase
  {
    ...
    GEN.ORT.YYY.DYYY0231_IA Dyyy0231Ia;
    GEN.ORT.YYY.DYYY0231_OA Dyyy0231Oa;
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    ...
    //    FOLLOW AS NEEDED:             
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    bool func_0022020114_esc_flag;
    bool func_0020972457_esc_flag;
    bool func_0020972964_esc_flag;
    bool func_0020971904_esc_flag;
    bool func_0020971673_esc_flag;
    bool func_0020972377_esc_flag;
    bool func_0020972454_esc_flag;
    bool func_0020973004_esc_flag;
    //       +->   CYYY0231_CHILD_UPDATE             01/09/2024  13:41
    //       !       IMPORTS:
    ...
    //    26 !  !  +->IF loc_imp child cparent_pkey_attr_text <= loc_empty
    //    26 !  !  !        child cparent_pkey_attr_text
    ...
    //    28 !  !  !              124_child_parent_key_attr_mand 
    //    29 ! <------ESCAPE
    //    26 !  !  +--
    //    30 !  !  +->IF loc_imp child ckey_attr_num <= loc_empty child
    //    30 !  !  !        ckey_attr_num
    //    31 !  !  !  SET exp_error iyy1_component return_code TO loc
    //    31 !  !  !              dont_change_return_codes
    //    31 !  !  !              n20_mandatory_import_missing 
    //    32 !  !  !  SET exp_error iyy1_component reason_code TO loc
    //    32 !  !  !              dont_change_reason_codes
    //    32 !  !  !              125_child_key_attr_mand 
    //    33 ! <------ESCAPE
    //    30 !  !  +--
    //    34 !  !  +->IF loc_imp child csearch_attr_text <= loc_empty child
    //    34 !  !  !        csearch_attr_text
    ...
    //    41 !  !     WHICH IMPORTS: Work View exp_error iyy1_component TO
    //    41 !  !              Work View imp_error iyy1_component
    //    41 !  !                    Work View imp_reference iyy1_server_data
    //    41 !  !              TO Work View imp_reference iyy1_server_data
    //    41 !  !                    Entity View loc_imp child TO Entity View
    //    41 !  !              imp child
    //    41 !  !     WHICH EXPORTS: Entity View exp child FROM Entity View
    //    41 !  !              exp child
    //    41 !  !                    Work View loc_error iyy1_component FROM
    ...
    //    44 ...!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    //    44 ...!!!!!!!!!!!
    //    44 ...!! WARNING: In D AB, if there' s a need for generating
    //    44 ...context string, must exit from ESCAPE AB.
    //    44 ...
    //    45 ! <------ESCAPE
    //    42 !  !  +--
    //    40 !  +--
    ...
    //    48 !  !     WHICH EXPORTS: Work View loc_error iyy1_component FROM
    //    48 !  !              Work View exp_error iyy1_component
    //    48 !  !                    Work View exp_error iyy1_component FROM
    //    48 !  !              Work View exp_context iyy1_component
    //    49 !  !   
    //    50 !  !  +->IF loc_error iyy1_component return_code < loc
    ...
    public void f_22020114(  )
    {
      ...
      Globdata.GetStateData().SetCurrentABName( "CYYY0231_CHILD_UPDATE" );
      {
        ...
        WLa.LocGContextDontChangeTextText150[LocGroupContext_PS_001-1] = FixedStringAttr.ValueOf("CYYY0231", 150);
        f_173015131_rgvc(  );
        ...
        WLa.LocImpChildCinstanceId = TimestampAttr.ValueOf(WIa.ImpChildCinstanceId);
        WLa.LocImpChildCreferenceId = TimestampAttr.ValueOf(WIa.ImpChildCreferenceId);
    ...
    public void f_20972964(  )
    {
      func_0020972964_esc_flag = false;
      {
        ...
        Dyyy0231Ia = (GEN.ORT.YYY.DYYY0231_IA)(IefRuntimeParm2.GetInstance( typeof(GEN.ORT.YYY.DYYY0231).Assembly,
        	"GEN.ORT.YYY.DYYY0231_IA" ));
        Dyyy0231Oa = (GEN.ORT.YYY.DYYY0231_OA)(IefRuntimeParm2.GetInstance( typeof(GEN.ORT.YYY.DYYY0231).Assembly,
        	"GEN.ORT.YYY.DYYY0231_OA" ));
        Dyyy0231Ia.ImpChildCinstanceId = TimestampAttr.ValueOf(WLa.LocImpChildCinstanceId);
        Dyyy0231Ia.ImpChildCreferenceId = TimestampAttr.ValueOf(WLa.LocImpChildCreferenceId);
        Dyyy0231Ia.ImpChildCparentPkeyAttrText = FixedStringAttr.ValueOf(WLa.LocImpChildCparentPkeyAttrText, 5);
        Dyyy0231Ia.ImpChildCkeyAttrNum = IntAttr.ValueOf(WLa.LocImpChildCkeyAttrNum);
        Dyyy0231Ia.ImpChildCsearchAttrText = FixedStringAttr.ValueOf(WLa.LocImpChildCsearchAttrText, 25);
        Dyyy0231Ia.ImpChildCotherAttrText = FixedStringAttr.ValueOf(WLa.LocImpChildCotherAttrText, 25);
        Dyyy0231Ia.ImpReferenceIyy1ServerDataUserid = FixedStringAttr.ValueOf(WIa.ImpReferenceIyy1ServerDataUserid, 8);
        Dyyy0231Ia.ImpReferenceIyy1ServerDataReferenceId = TimestampAttr.ValueOf(WIa.ImpReferenceIyy1ServerDataReferenceId);
        Dyyy0231Ia.ImpErrorIyy1ComponentSeverityCode = FixedStringAttr.ValueOf(WOa.ExpErrorIyy1ComponentSeverityCode, 1);
        Dyyy0231Ia.ImpErrorIyy1ComponentRollbackIndicator = FixedStringAttr.ValueOf(WOa.ExpErrorIyy1ComponentRollbackIndicator, 1);
        Dyyy0231Ia.ImpErrorIyy1ComponentOriginServid = DoubleAttr.ValueOf(WOa.ExpErrorIyy1ComponentOriginServid);
        Dyyy0231Ia.ImpErrorIyy1ComponentContextString = StringAttr.ValueOf(WOa.ExpErrorIyy1ComponentContextString, 512);
        Dyyy0231Ia.ImpErrorIyy1ComponentReturnCode = IntAttr.ValueOf(WOa.ExpErrorIyy1ComponentReturnCode);
        Dyyy0231Ia.ImpErrorIyy1ComponentReasonCode = IntAttr.ValueOf(WOa.ExpErrorIyy1ComponentReasonCode);
        Dyyy0231Ia.ImpErrorIyy1ComponentChecksum = FixedStringAttr.ValueOf(WOa.ExpErrorIyy1ComponentChecksum, 15);
        Globdata.GetErrorData().SetErrorEncountered( ErrorData.ErrorEncounteredNoErrorFound );
        IefRuntimeParm2.UseActionBlock( typeof(GEN.ORT.YYY.DYYY0231).Assembly,
        	"GEN.ORT.YYY.DYYY0231",
        	"Execute",
        	Dyyy0231Ia,
        	Dyyy0231Oa );
        if ( ((Globdata.GetErrorData().GetStatus() != ErrorData.StatusNone) || (Globdata.GetErrorData().GetErrorEncountered() != 
        ...
        Globdata.GetStateData().SetCurrentABName( "CYYY0231_CHILD_UPDATE" );
        Globdata.GetStateData().SetLastStatementNumber( "0000000041" );
        WLa.LocErrorIyy1ComponentSeverityCode = FixedStringAttr.ValueOf(Dyyy0231Oa.ExpErrorIyy1ComponentSeverityCode, 1);
        WLa.LocErrorIyy1ComponentRollbackIndicator = FixedStringAttr.ValueOf(Dyyy0231Oa.ExpErrorIyy1ComponentRollbackIndicator, 1);
        WLa.LocErrorIyy1ComponentOriginServid = DoubleAttr.ValueOf(Dyyy0231Oa.ExpErrorIyy1ComponentOriginServid);
        WLa.LocErrorIyy1ComponentContextString = StringAttr.ValueOf(Dyyy0231Oa.ExpErrorIyy1ComponentContextString, 512);
        WLa.LocErrorIyy1ComponentReturnCode = IntAttr.ValueOf(Dyyy0231Oa.ExpErrorIyy1ComponentReturnCode);
        WLa.LocErrorIyy1ComponentReasonCode = IntAttr.ValueOf(Dyyy0231Oa.ExpErrorIyy1ComponentReasonCode);
        WLa.LocErrorIyy1ComponentChecksum = FixedStringAttr.ValueOf(Dyyy0231Oa.ExpErrorIyy1ComponentChecksum, 15);
        WOa.ExpChildCreferenceId = TimestampAttr.ValueOf(Dyyy0231Oa.ExpChildCreferenceId);
        Dyyy0231Ia.FreeInstance(  );
        Dyyy0231Ia = null;
        Dyyy0231Oa.FreeInstance(  );
        Dyyy0231Oa = null;
...
"                                                                                                                                                      "
    ...
    public void f_22020114_localAlloc( String abname )
    {
      ...
      WLa = (GEN.ORT.YYY.CYYY0231_LA)(IefRuntimeParm2.GetInstance( GetType().Assembly,
      	"GEN.ORT.YYY.CYYY0231_LA" ));
      if ( WLa == null )
      {
        Globdata.GetStateData().SetCurrentABId( "0022020114" );

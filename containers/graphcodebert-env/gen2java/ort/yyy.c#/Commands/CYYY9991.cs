namespace GEN.ORT.YYY
{
  ...
  //
  //    Name: CYYY9991_SETSERVID               Date: 2024/01/09
  ...
  public class CYYY9991 : ABBase
  {
    ...
    //    FOLLOW AS NEEDED:             
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    bool func_0022020332_esc_flag;
    //       +->   CYYY9991_SETSERVID                01/09/2024  13:40
    //       !       EXPORTS:
    //       !         Work View exp_servid iyy1_component (Transient, Export
    //       !                     only)
    //       !           origin_servid
    //       !
    ...
    public void f_22020332(  )
    {
      ...
      WOa.ExpServidIyy1ComponentOriginServid = DoubleAttr.ValueOf(TIRD2DEC.Execute1(9001.0, 0, TIRD2DEC.ROUND_NONE, 15));
    ...
    public void f_22020332_init(  )
    {
      ...
      WOa.ExpServidIyy1ComponentOriginServid = 0.0;
    }
  }// end class

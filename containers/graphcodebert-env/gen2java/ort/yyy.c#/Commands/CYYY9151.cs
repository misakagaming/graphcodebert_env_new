namespace GEN.ORT.YYY
{
  ...
  //
  //    Name: CYYY9151_CHECKSUM_GENERATE       Date: 2024/01/09
  ...
  public class CYYY9151 : ABBase
  {
    ...
    //    FOLLOW AS NEEDED:             
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    bool func_0022020180_esc_flag;
    bool func_0020972114_esc_flag;
    //       +->   CYYY9151_CHECKSUM_GENERATE        01/09/2024  13:41
    //       !       EXPORTS:
    ...
    //     5 !  
    //     6 !  SET SUBSCRIPT OF loc_group_context_s TO 1 
    //     7 !  SET loc_g_context dont_change_text text_150 TO "CYYY9151" 
    //     8 !  SET SUBSCRIPT OF loc_group_context_s TO 2 
    ...
    //    11 !  
    //    12 !  SET exp_checksum iyy1_component checksum TO "ABC_123_DEF_456" 
    //    13 !   
    //    14 !  +->IF exp_error iyy1_component return_code < 1
    //    15 !  !  USE cyyy9141_context_string_set
    //    15 !  !     WHICH IMPORTS: Group View  loc_group_context_s TO Group
    //    15 !  !              View imp_group_context
    //    15 !  !     WHICH EXPORTS: Work View loc_error iyy1_component FROM
    //    15 !  !              Work View exp_error iyy1_component
    //    15 !  !                    Work View exp_error iyy1_component FROM
    //    15 !  !              Work View exp_context iyy1_component
    //    16 !  !   
    //    17 !  !  +->IF loc_error iyy1_component return_code < 1
    //    18 !  !  !  MOVE loc_error iyy1_component TO exp_error
    //    18 !  !  !              iyy1_component
    //    17 !  !  +--
    //    19 !  !  SET exp_error iyy1_component severity_code TO "E" 
    //    14 !  +--
    //       +---
    ...
    public CYYY9151(  )
    {
      ...
      IefCGenSubset = "ALL";
      IefCGenName = "CYYY9151_CHECKSUM_GENERATE";
      NestingLevel = 0;
    ...
    private void _Execute()
    {
      ...
      f_22020180_localAlloc( "CYYY9151_CHECKSUM_GENERATE" );
    ...
    public void f_22020180(  )
    {
      func_0022020180_esc_flag = false;
      Globdata.GetStateData().SetCurrentABId( "0022020180" );
      Globdata.GetStateData().SetCurrentABName( "CYYY9151_CHECKSUM_GENERATE" );
      // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
      ...
      WLa.LocGContextDontChangeTextText150[LocGroupContextS_PS_001-1] = FixedStringAttr.ValueOf("CYYY9151", 150);
      f_173015045_rgvc(  );
      ...
      WLa.LocGContextDontChangeTextText150[LocGroupContextS_PS_001-1] = FixedStringAttr.ValueOf("CHKSUM", 150);
      f_173015045_rgvc(  );
      ...
      WOa.ExpChecksumIyy1ComponentChecksum = FixedStringAttr.ValueOf("ABC_123_DEF_456", 15);
    ...
    public void f_20972114(  )
    {
      func_0020972114_esc_flag = false;
...
"                                                                                                                                                      "
    ...
    public void f_22020180_localAlloc( String abname )
    {
      // Request localview allocation 
      WLa = (GEN.ORT.YYY.CYYY9151_LA)(IefRuntimeParm2.GetInstance( GetType().Assembly,
      	"GEN.ORT.YYY.CYYY9151_LA" ));
      if ( WLa == null )
      {
        Globdata.GetStateData().SetCurrentABId( "0022020180" );

namespace GEN.ORT.YYY
{
  ...
  //
  //    Name: CYYY0241_CHILD_DELETE            Date: 2024/01/09
  ...
  public class CYYY0241 : ABBase
  {
    ...
    GEN.ORT.YYY.DYYY0241_IA Dyyy0241Ia;
    GEN.ORT.YYY.DYYY0241_OA Dyyy0241Oa;
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    ...
    //    FOLLOW AS NEEDED:             
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    bool func_0022020122_esc_flag;
    bool func_0020971574_esc_flag;
    bool func_0020972064_esc_flag;
    bool func_0020971578_esc_flag;
    //       +->   CYYY0241_CHILD_DELETE             01/09/2024  13:41
    //       !       IMPORTS:
    ...
    public void f_22020122(  )
    {
      ...
      Globdata.GetStateData().SetCurrentABName( "CYYY0241_CHILD_DELETE" );
      {
        ...
        WLa.LocGContextDontChangeTextText150[LocGroupContext_PS_001-1] = FixedStringAttr.ValueOf("CYYY0241", 150);
        f_173015182_rgvc(  );
    ...
    public void f_20971574(  )
    {
      func_0020971574_esc_flag = false;
      {
        ...
        Dyyy0241Ia = (GEN.ORT.YYY.DYYY0241_IA)(IefRuntimeParm2.GetInstance( typeof(GEN.ORT.YYY.DYYY0241).Assembly,
        	"GEN.ORT.YYY.DYYY0241_IA" ));
        Dyyy0241Oa = (GEN.ORT.YYY.DYYY0241_OA)(IefRuntimeParm2.GetInstance( typeof(GEN.ORT.YYY.DYYY0241).Assembly,
        	"GEN.ORT.YYY.DYYY0241_OA" ));
        Dyyy0241Ia.ImpChildCinstanceId = TimestampAttr.ValueOf(WIa.ImpChildCinstanceId);
        Dyyy0241Ia.ImpChildCreferenceId = TimestampAttr.ValueOf(WIa.ImpChildCreferenceId);
        Dyyy0241Ia.ImpChildCparentPkeyAttrText = FixedStringAttr.ValueOf(WIa.ImpChildCparentPkeyAttrText, 5);
        Dyyy0241Ia.ImpChildCkeyAttrNum = IntAttr.ValueOf(WIa.ImpChildCkeyAttrNum);
        Dyyy0241Ia.ImpReferenceIyy1ServerDataUserid = FixedStringAttr.ValueOf(WIa.ImpReferenceIyy1ServerDataUserid, 8);
        Dyyy0241Ia.ImpReferenceIyy1ServerDataReferenceId = TimestampAttr.ValueOf(WIa.ImpReferenceIyy1ServerDataReferenceId);
        Dyyy0241Ia.ImpErrorIyy1ComponentSeverityCode = FixedStringAttr.ValueOf(WOa.ExpErrorIyy1ComponentSeverityCode, 1);
        Dyyy0241Ia.ImpErrorIyy1ComponentRollbackIndicator = FixedStringAttr.ValueOf(WOa.ExpErrorIyy1ComponentRollbackIndicator, 1);
        Dyyy0241Ia.ImpErrorIyy1ComponentOriginServid = DoubleAttr.ValueOf(WOa.ExpErrorIyy1ComponentOriginServid);
        Dyyy0241Ia.ImpErrorIyy1ComponentContextString = StringAttr.ValueOf(WOa.ExpErrorIyy1ComponentContextString, 512);
        Dyyy0241Ia.ImpErrorIyy1ComponentReturnCode = IntAttr.ValueOf(WOa.ExpErrorIyy1ComponentReturnCode);
        Dyyy0241Ia.ImpErrorIyy1ComponentReasonCode = IntAttr.ValueOf(WOa.ExpErrorIyy1ComponentReasonCode);
        Dyyy0241Ia.ImpErrorIyy1ComponentChecksum = FixedStringAttr.ValueOf(WOa.ExpErrorIyy1ComponentChecksum, 15);
        Globdata.GetErrorData().SetErrorEncountered( ErrorData.ErrorEncounteredNoErrorFound );
        IefRuntimeParm2.UseActionBlock( typeof(GEN.ORT.YYY.DYYY0241).Assembly,
        	"GEN.ORT.YYY.DYYY0241",
        	"Execute",
        	Dyyy0241Ia,
        	Dyyy0241Oa );
        if ( ((Globdata.GetErrorData().GetStatus() != ErrorData.StatusNone) || (Globdata.GetErrorData().GetErrorEncountered() != 
        ...
        Globdata.GetStateData().SetCurrentABName( "CYYY0241_CHILD_DELETE" );
        Globdata.GetStateData().SetLastStatementNumber( "0000000018" );
        WLa.LocErrorIyy1ComponentSeverityCode = FixedStringAttr.ValueOf(Dyyy0241Oa.ExpErrorIyy1ComponentSeverityCode, 1);
        WLa.LocErrorIyy1ComponentRollbackIndicator = FixedStringAttr.ValueOf(Dyyy0241Oa.ExpErrorIyy1ComponentRollbackIndicator, 1);
        WLa.LocErrorIyy1ComponentOriginServid = DoubleAttr.ValueOf(Dyyy0241Oa.ExpErrorIyy1ComponentOriginServid);
        WLa.LocErrorIyy1ComponentContextString = StringAttr.ValueOf(Dyyy0241Oa.ExpErrorIyy1ComponentContextString, 512);
        WLa.LocErrorIyy1ComponentReturnCode = IntAttr.ValueOf(Dyyy0241Oa.ExpErrorIyy1ComponentReturnCode);
        WLa.LocErrorIyy1ComponentReasonCode = IntAttr.ValueOf(Dyyy0241Oa.ExpErrorIyy1ComponentReasonCode);
        WLa.LocErrorIyy1ComponentChecksum = FixedStringAttr.ValueOf(Dyyy0241Oa.ExpErrorIyy1ComponentChecksum, 15);
        Dyyy0241Ia.FreeInstance(  );
        Dyyy0241Ia = null;
        Dyyy0241Oa.FreeInstance(  );
        Dyyy0241Oa = null;
...
"                                                                                                                                                      "
    ...
    public void f_22020122_localAlloc( String abname )
    {
      ...
      WLa = (GEN.ORT.YYY.CYYY0241_LA)(IefRuntimeParm2.GetInstance( GetType().Assembly,
      	"GEN.ORT.YYY.CYYY0241_LA" ));
      if ( WLa == null )
      {
        Globdata.GetStateData().SetCurrentABId( "0022020122" );

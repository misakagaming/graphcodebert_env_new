namespace GEN.ORT.YYY
{
  ...
  //
  //    Name: IRO11041_CONTEXT_STRING_SET_S    Date: 2024/01/09
  ...
  public class IRO11041 : ABBase
  {
    ...
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    bool InputGroup_FL_001;
    int InputGroup_PS_001;
    bool InputGroup_RF_001;
    public const int InputGroup_MM_001 = 9;
    
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    // MISC DECLARATIONS AND PROTOTYPES 
    //    FOLLOW AS NEEDED:             
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    //       +->   IRO11041_CONTEXT_STRING_SET_S     01/09/2024  13:40
    //       !       IMPORTS:
    //       !         Group View (9) input_group
    //       !           Work View input_g_string iro1_component (Transient,
    //       !                       Optional, Import only)
    //       !             string_150_tx
    //       !       EXPORTS:
    //       !         Work View output_data iro1_component (Transient, Export
    //       !                     only)
    //       !           context_string_tx
    ...
    //    11 !  NOTE: 
    //    11 !  PRE-CONDITION:
    //    11 !  Must provide at least one parameter for the input group view
    //    11 !  POST-CONDITION:
    //    11 !  A formatted context string is returned.
    //    11 !  RETURN CODE = 0001
    //    12 !   
    //    13 !  NOTE: 
    ...
    //    13 !  
    //    13 !  + 0001/0001       All OK
    //    13 !  - 0021/0002       String length is greater than 255
    //       +---
    ...
    public IRO11041(  )
    {
      ...
      IefCGenSubset = "ALL";
      IefCGenName = "IRO11041_CONTEXT_STRING_SET_S";
      NestingLevel = 0;
    ...
    public void Execute( Object in_runtime_parm1, 
    	...
    	IRO11041_IA import_view, 
    	IRO11041_OA export_view )
    {

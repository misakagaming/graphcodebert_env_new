namespace GEN.ORT.YYY
{
  ...
  //
  //    Name: CYY1S061_CHILD_LIST              Date: 2024/01/09
  //    Target OS:   CLR                       Time: 13:41:09
  ...
  public class CYY1S061 : ABBase
  {
    ...
    //    FOLLOW AS NEEDED:             
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    bool func_0022020258_esc_flag;
    bool func_0020972753_esc_flag;
    bool func_0020972881_esc_flag;
    bool func_0020972286_esc_flag;
    bool func_0020971606_esc_flag;
    //       +->   CYY1S061_CHILD_LIST               01/09/2024  13:41
    //       !       IMPORTS:
    ...
    //       !           scroll_amount
    //       !           order_by_field_num
    //       !         Entity View imp_from child (Transient, Optional, Import
    //       !                     only)
    //       !           cinstance_id
    ...
    //       !           cparent_pkey_attr_text
    //       !           ckey_attr_num
    //       !         Entity View imp_filter_stop child (Transient, Optional,
    //       !                     Import only)
    //       !           cparent_pkey_attr_text
    //       !           ckey_attr_num
    //       !         Entity View imp_filter child (Transient, Optional,
    //       !                     Import only)
    //       !           csearch_attr_text
    //       !       EXPORTS:
    ...
    //    69 !  !  !                    Entity View imp_filter child TO Entity
    //    69 !  !  !              View imp_filter child
    //    69 !  !  !                    Entity View imp_filter_stop child TO
    //    69 !  !  !              Entity View imp_filter_stop child
    //    69 !  !  !                    Entity View imp_filter_start child TO
    //    69 !  !  !              Entity View imp_filter_start child
    //    69 !  !  !                    Entity View imp_from child TO Entity
    //    69 !  !  !              View imp_from child
    ...
    //    75 !                    Work View imp_dialect iyy1_component TO Work
    ...
    public void f_22020258(  )
    {
      ...
      WLa.LocGContextDontChangeTextText150[LocGroupContext_PS_002-1] = FixedStringAttr.ValueOf("CYY1S061", 150);
      f_173015183_rgvc(  );
...
"                                                                                                                                                      "
    ...
    public void f_20971606(  )
    {
      ...
      Cyyy0251Ia.ImpFromChildCinstanceId = TimestampAttr.ValueOf(WIa.ImpFromChildCinstanceId);
      Cyyy0251Ia.ImpFromChildCparentPkeyAttrText = FixedStringAttr.ValueOf(WIa.ImpFromChildCparentPkeyAttrText, 5);
      Cyyy0251Ia.ImpFromChildCkeyAttrNum = IntAttr.ValueOf(WIa.ImpFromChildCkeyAttrNum);
      Cyyy0251Ia.ImpFilterStartChildCparentPkeyAttrText = FixedStringAttr.ValueOf(WIa.ImpFilterStartChildCparentPkeyAttrText, 5);
      Cyyy0251Ia.ImpFilterStartChildCkeyAttrNum = IntAttr.ValueOf(WIa.ImpFilterStartChildCkeyAttrNum);
      Cyyy0251Ia.ImpFilterStopChildCparentPkeyAttrText = FixedStringAttr.ValueOf(WIa.ImpFilterStopChildCparentPkeyAttrText, 5);
      Cyyy0251Ia.ImpFilterStopChildCkeyAttrNum = IntAttr.ValueOf(WIa.ImpFilterStopChildCkeyAttrNum);
      Cyyy0251Ia.ImpFilterChildCsearchAttrText = FixedStringAttr.ValueOf(WIa.ImpFilterChildCsearchAttrText, 25);
      Cyyy0251Ia.ImpFilterIyy1ListSortOption = FixedStringAttr.ValueOf(WIa.ImpFilterIyy1ListSortOption, 3);
      Cyyy0251Ia.ImpFilterIyy1ListScrollType = FixedStringAttr.ValueOf(WIa.ImpFilterIyy1ListScrollType, 1);
      Cyyy0251Ia.ImpFilterIyy1ListListDirection = FixedStringAttr.ValueOf(WIa.ImpFilterIyy1ListListDirection, 1);
      Cyyy0251Ia.ImpFilterIyy1ListScrollAmount = IntAttr.ValueOf(WIa.ImpFilterIyy1ListScrollAmount);
      Cyyy0251Ia.ImpFilterIyy1ListOrderByFieldNum = ShortAttr.ValueOf(WIa.ImpFilterIyy1ListOrderByFieldNum);
      Globdata.GetErrorData().SetErrorEncountered( ErrorData.ErrorEncounteredNoErrorFound );
      ...
      Globdata.GetStateData().SetCurrentABName( "CYY1S061_CHILD_LIST" );
      Globdata.GetStateData().SetLastStatementNumber( "0000000069" );
      WLa.LocErrorIyy1ComponentSeverityCode = FixedStringAttr.ValueOf(Cyyy0251Oa.ExpErrorIyy1ComponentSeverityCode, 1);
      WLa.LocErrorIyy1ComponentRollbackIndicator = FixedStringAttr.ValueOf(Cyyy0251Oa.ExpErrorIyy1ComponentRollbackIndicator, 1);
      WLa.LocErrorIyy1ComponentOriginServid = DoubleAttr.ValueOf(Cyyy0251Oa.ExpErrorIyy1ComponentOriginServid);
      WLa.LocErrorIyy1ComponentContextString = StringAttr.ValueOf(Cyyy0251Oa.ExpErrorIyy1ComponentContextString, 512);
      WLa.LocErrorIyy1ComponentReturnCode = IntAttr.ValueOf(Cyyy0251Oa.ExpErrorIyy1ComponentReturnCode);
      WLa.LocErrorIyy1ComponentReasonCode = IntAttr.ValueOf(Cyyy0251Oa.ExpErrorIyy1ComponentReasonCode);
      WLa.LocErrorIyy1ComponentChecksum = FixedStringAttr.ValueOf(Cyyy0251Oa.ExpErrorIyy1ComponentChecksum, 15);
      WOa.ExpGroupList_MA = IntAttr.ValueOf(Cyyy0251Oa.ExpGroupList_MA);
      for(Adim1 = 1; Adim1 <= WOa.ExpGroupList_MA; ++(Adim1))
      {
        WOa.ExpGListChildCinstanceId[Adim1-1] = TimestampAttr.ValueOf(Cyyy0251Oa.ExpGListChildCinstanceId[Adim1-1]);
        WOa.ExpGListChildCreferenceId[Adim1-1] = TimestampAttr.ValueOf(Cyyy0251Oa.ExpGListChildCreferenceId[Adim1-1]);
        WOa.ExpGListChildCparentPkeyAttrText[Adim1-1] = FixedStringAttr.ValueOf(Cyyy0251Oa.ExpGListChildCparentPkeyAttrText[Adim1-1],
           5);
        WOa.ExpGListChildCkeyAttrNum[Adim1-1] = IntAttr.ValueOf(Cyyy0251Oa.ExpGListChildCkeyAttrNum[Adim1-1]);
        WOa.ExpGListChildCsearchAttrText[Adim1-1] = FixedStringAttr.ValueOf(Cyyy0251Oa.ExpGListChildCsearchAttrText[Adim1-1], 25);
        WOa.ExpGListChildCotherAttrText[Adim1-1] = FixedStringAttr.ValueOf(Cyyy0251Oa.ExpGListChildCotherAttrText[Adim1-1], 25);
      }
    ...
    public void f_22020258_localAlloc( String abname )
    {
      ...
      WLa = (GEN.ORT.YYY.CYY1S061_LA)(IefRuntimeParm2.GetInstance( GetType().Assembly,
      	"GEN.ORT.YYY.CYY1S061_LA" ));
      if ( WLa == null )
      {
        Globdata.GetStateData().SetCurrentABId( "0022020258" );

namespace GEN.ORT.YYY
{
  ...
  //
  //    Name: CYYY9741_SERVICE_TERMINATION     Date: 2024/01/09
  //    Target OS:   CLR                       Time: 13:40:31
  ...
  public class CYYY9741 : ABBase
  {
    ...
    GEN.ORT.YYY.IXX10021_OA Ixx10021Oa;
    ...
    //    FOLLOW AS NEEDED:             
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    bool func_0022020252_esc_flag;
    //       +->   CYYY9741_SERVICE_TERMINATION      01/09/2024  13:40
    //       !       IMPORTS:
    ...
    //       !           activity_cd
    //       !           checksum
    //       !         Work View loc_dialect ixx1_component
    //       !           dialect_cd
    ...
    //     3 !  NOTE: 
    //     3 !  RELEASE HISTORY
    //     3 !  01_00 16-09-2005 New release
    //     3 !  
    //     4 !  SET loc dont_change_return_codes 1_ok TO 1 
    //     5 !   
    //     6 !  NOTE: 
    //     6 !  ****************************************************************
    //     6 !  Let' s format the error message
    //     6 !  
    //     7 !  MOVE imp_error iyy1_component TO loc_imp_error iyy1_component
    //     8 !   
    //     9 !  NOTE: 
    //     9 !  ****************************************************************
    //     9 !  Which spec + impl + serv is this component?
    //     9 !  
    //     9 !  
    //     9 !  
    //    10 !  USE cyyy9051_cmpnt_identifiers_get
    //    10 !     WHICH EXPORTS: Work View loc_imp_error iyy1_component FROM
    //    10 !              Work View exp_identifiers iyy1_component
    //    10 !                    Work View loc_error iyy1_component FROM Work
    //    10 !              View exp_error iyy1_component
    //    11 !  +->IF loc_error iyy1_component return_code < loc
    //    11 !  !        dont_change_return_codes 1_ok
    //    12 !  !  MOVE loc_error iyy1_component TO loc_imp_error
    //    12 !  !              iyy1_component
    //    11 !  +--
    //    13 !   
    //    14 !  NOTE: 
    //    14 !  ****************************************************************
    //    14 !  Let' s set our own dialect code
    //    14 !  
    //    15 !  USE ixx10021_currentdialect_get_s
    //    15 !     WHICH EXPORTS: Work View loc_dialect ixx1_component FROM
    //    15 !              Work View exp_dialect ixx1_component
    //    16 !  SET loc_imp_error iyy1_component dialect_cd TO loc_dialect
    //    16 !              ixx1_component dialect_cd 
    //    17 !   
    //    18 !  NOTE: 
    //    18 !  ****************************************************************
    //    18 !  Let' s convert the error data to message
    //    18 !  
    ...
    //    23 !  NOTE: 
    //    23 !  ****************************************************************
    //    23 !  If the message is not formatted, let' s use our own data
    //    23 !  
    ...
    //    29 !  ****************************************************************
    //    29 !  
    //    29 !  If the error code is negative Severity = 'Error'
    //    29 !  
    ...
    public CYYY9741(  )
    {
      ...
      IefCGenTime = "13:40:31";
      IefCGenEncy = "9.2.A6";
      IefCGenUserId = "AliAl";
      IefCGenModel = "N8I_ORT_YYY_0112_TEMPLATE";
      IefCGenSubset = "ALL";
      IefCGenName = "CYYY9741_SERVICE_TERMINATION";
      NestingLevel = 0;
    ...
    public void Execute( Object in_runtime_parm1, 
    	...
    	CYYY9741_IA import_view, 
    	CYYY9741_OA export_view )
    {
    ...
    private void _Execute()
    {
      ...
      f_22020252_localAlloc( "CYYY9741_SERVICE_TERMINATION" );
    ...
    public void f_22020252(  )
    {
      func_0022020252_esc_flag = false;
      Globdata.GetStateData().SetCurrentABId( "0022020252" );
      Globdata.GetStateData().SetCurrentABName( "CYYY9741_SERVICE_TERMINATION" );
      // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
      ...
      //    **************************************************************  
      //    **                                                              
      //    Let' s format the error message                                 
      //                                                                    
      // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
      ...
      //    **************************************************************  
      //    **                                                              
      //    Which spec + impl + serv is this component?                     
      //                                                                    
      //                                                                    
      //                                                                    
      // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
      ...
      //    **************************************************************  
      //    **                                                              
      //    Let' s set our own dialect code                                 
      //                                                                    
      // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
      Globdata.GetStateData().SetLastStatementNumber( "0000000015" );
      
      Ixx10021Oa = (GEN.ORT.YYY.IXX10021_OA)(IefRuntimeParm2.GetInstance( typeof(GEN.ORT.YYY.IXX10021).Assembly,
      	"GEN.ORT.YYY.IXX10021_OA" ));
      Globdata.GetErrorData().SetErrorEncountered( ErrorData.ErrorEncounteredNoErrorFound );
      IefRuntimeParm2.UseActionBlock( typeof(GEN.ORT.YYY.IXX10021).Assembly,
      	"GEN.ORT.YYY.IXX10021",
      	"Execute",
      	null,
      	Ixx10021Oa );
      if ( ((Globdata.GetErrorData().GetStatus() != ErrorData.StatusNone) || (Globdata.GetErrorData().GetErrorEncountered() != 
      ...
      Globdata.GetStateData().SetCurrentABName( "CYYY9741_SERVICE_TERMINATION" );
      Globdata.GetStateData().SetLastStatementNumber( "0000000015" );
      WLa.LocDialectIxx1ComponentDialectCd = FixedStringAttr.ValueOf(Ixx10021Oa.ExpDialectIxx1ComponentDialectCd, 2);
      Ixx10021Oa.FreeInstance(  );
      Ixx10021Oa = null;
      Globdata.GetStateData().SetLastStatementNumber( "0000000016" );
      WLa.LocImpErrorIyy1ComponentDialectCd = FixedStringAttr.ValueOf(WLa.LocDialectIxx1ComponentDialectCd, 2);
      ...
      //    **************************************************************  
      //    **                                                              
      //    If the message is not formatted, let' s use our own data        
      //                                                                    
      // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
      ...
      //    **                                                              
      //                                                                    
      //    If the error code is negative Severity = 'Error'                
      //                                                                    
      // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    ...
    public void f_22020252_localAlloc( String abname )
    {
      // Request localview allocation 
      WLa = (GEN.ORT.YYY.CYYY9741_LA)(IefRuntimeParm2.GetInstance( GetType().Assembly,
      	"GEN.ORT.YYY.CYYY9741_LA" ));
      if ( WLa == null )
      {
        Globdata.GetStateData().SetCurrentABId( "0022020252" );

namespace GEN.ORT.YYY
{
  ...
  //
  //    Name: CYYY0161_PARENT_INSTANCE_ID_GEN  Date: 2024/01/09
  ...
  public class CYYY0161 : ABBase
  {
    ...
    //    FOLLOW AS NEEDED:             
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    bool func_0022020202_esc_flag;
    //       +->   CYYY0161_PARENT_INSTANCE_ID_GEN   01/09/2024  13:40
    //       !       EXPORTS:
    ...
    //     3 !  NOTE: 
    //     3 !  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    //     3 !  The needed code must be written with respect to the instance
    //     3 !  id' s type and acquirement.
    //     3 !  
    ...
    public void f_22020202(  )
    {
      ...
      // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
      //    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!     
      //    The needed code must be written with respect to the instance    
      //    id' s type and acquirement.                                     
      //                                                                    
      // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
      ...
      TIRDAT2.GetSystemTime( TodaysTime,
      	TIRDAT2.TF_HHMMSS );
      WOa.ExpParentPinstanceId = TimestampAttr.ValueOf(TodaysTimestamp.Get());
      return;
    }

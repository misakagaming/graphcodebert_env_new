namespace GEN.ORT.YYY
{
  ...
  //
  //    Name: SYYY0311_TYPE_CREATE             Date: 2024/01/09
  ...
  public class SYYY0311 : ABBase
  {
    ...
    //    FOLLOW AS NEEDED:             
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    bool func_0022020230_esc_flag;
    //       +->   SYYY0311_TYPE_CREATE              01/09/2024  13:40
    //       !       IMPORTS:
    ...
    //     9 !  !  SET exp_error dont_change_text text_2 TO "AE" 
    //     7 !  +> ELSE IF imp type tkey_attr_text >= "7000"
    //    10 !  !  SET exp_error dont_change_text text_2 TO "PV" 
    //     7 !  +--
    //       +---
    ...
    public SYYY0311(  )
    {
      ...
      IefCGenSubset = "ALL";
      IefCGenName = "SYYY0311_TYPE_CREATE";
      NestingLevel = 0;
    ...
    public void Execute( Object in_runtime_parm1, 
    	...
    	SYYY0311_IA import_view, 
    	SYYY0311_OA export_view )
    {
    ...
    public void f_22020230(  )
    {
      func_0022020230_esc_flag = false;
      Globdata.GetStateData().SetCurrentABId( "0022020230" );
      Globdata.GetStateData().SetCurrentABName( "SYYY0311_TYPE_CREATE" );

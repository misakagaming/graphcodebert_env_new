namespace GEN.ORT.YYY
{
  ...
  //
  //    Name: DYYY0321_TYPE_READ               Date: 2024/01/09
  ...
  public class DYYY0321 : ABBase
  {
    ...
    // * * * * * * * * * * * * * * * * * * *
    string sl_29360177 = ErrorData.LastStatusNone;
    string Type_es;
    string Type_001cd;
    string Type_lk;
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    ...
    /// </summary>
    [Serializable]
    public class DYYY0321_EA : ViewBase, IEntityActionView
    {
      // Entity View: 
      //        Type: TYPE
      /// <summary>
    ...
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    DYYY0321_EA WEa = new DYYY0321_EA();
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    ...
    // CURSOR OPEN FLAGS
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    bool curs_open_0029360177 = false;
    ...
    //    FOLLOW AS NEEDED:             
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    bool func_0022020274_esc_flag;
    IAbstractCommand hstmt_0037916142_1_cmd;
    IAbstractResultSet hstmt_0037916142_1_rs;
    //       +->   DYYY0321_TYPE_READ                01/09/2024  13:40
    //       !       IMPORTS:
    ...
    //    13 !  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    //    13 !  !!!!!!!!!!!!!!!!!!!!!
    //    13 !  If Instance_id is used, reading should not be done according
    //    13 !  to business key(s). This field must be used.
    //    13 !  
    //    13 !  
    //    14 !  NOTE: 
    //    14 !  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    //    14 !  !!!!!!!!!!!!!!!!!!!!!
    //    14 !  Please select "Control of Cursor Generation" property as
    //    14 !  "Select only".  
    //    14 !  
    //    15 !  +=>READ (Select Only) type
    //    15 !  !        WHERE DESIRED type tkey_attr_text = imp type
    //    15 !  !              tkey_attr_text
    //    15 !  +> WHEN successful
    ...
    //    18 !  !              dont_change_reason_codes 141_type_not_found 
    //    15 !  +--
    //       +---
    ...
    public void f_22020274(  )
    {
      ...
      f_29360177(  );
      if ( sl_29360177 == ErrorData.LastStatusSucceeds )
      {
        Globdata.GetStateData().SetLastSubStatementNumber( "1" );
        {
          ...
          WOa.ExpTypeTinstanceId = TimestampAttr.ValueOf(WEa.TypeTinstanceId);
          WOa.ExpTypeTcreateUserId = FixedStringAttr.ValueOf(WEa.TypeTcreateUserId, 8);
          WOa.ExpTypeTupdateUserId = FixedStringAttr.ValueOf(WEa.TypeTupdateUserId, 8);
          WOa.ExpTypeTkeyAttrText = FixedStringAttr.ValueOf(WEa.TypeTkeyAttrText, 4);
          WOa.ExpTypeTsearchAttrText = FixedStringAttr.ValueOf(WEa.TypeTsearchAttrText, 20);
          WOa.ExpTypeTotherAttrText = FixedStringAttr.ValueOf(WEa.TypeTotherAttrText, 2);
          WOa.ExpTypeTotherAttrDate = DateAttr.ValueOf(WEa.TypeTotherAttrDate);
          WOa.ExpTypeTotherAttrTime = TimeAttr.ValueOf(WEa.TypeTotherAttrTime);
          WOa.ExpTypeTotherAttrAmount = DecimalAttr.ValueOf(TIRBDTRU.TruncateToDecimal(WEa.TypeTotherAttrAmount, 2));
        }
      }
      else if ( sl_29360177 == ErrorData.LastStatusNotFound )
      {
    ...
    public void f_22020274_localAlloc( String abname )
    {
      ...
      WLa = (GEN.ORT.YYY.DYYY0321_LA)(IefRuntimeParm2.GetInstance( GetType().Assembly,
      	"GEN.ORT.YYY.DYYY0321_LA" ));
      if ( WLa == null )
      {
        Globdata.GetStateData().SetCurrentABId( "0022020274" );
    ...
    {
      sl_29360177 = ErrorData.LastStatusSucceeds;
      ...
      if ( sl_29360177 == ErrorData.LastStatusSucceeds )
      {
        ...
        DataException = null;
        try {
          if ( hstmt_0037916142_1_cmd == null )
          {
    ...
    public void f_29360177_adonet_dberror(  )
    {
      Globdata.GetErrorData().SetStatus( ErrorData.LastStatusFatalError );

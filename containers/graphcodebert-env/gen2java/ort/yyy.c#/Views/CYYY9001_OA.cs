...
//
//    Name: CYYY9001_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY9001_OA : ViewBase, IExportView
  {
    private static CYYY9001_OA[] freeArray = new CYYY9001_OA[30];
    ...
    public static CYYY9001_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY9001_OA result = freeArray[--countFree];

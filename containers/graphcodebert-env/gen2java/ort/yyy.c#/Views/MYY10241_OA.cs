...
//
//    Name: MYY10241_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: MYY10241_OA
  /// </summary>
  [Serializable]
  public class MYY10241_OA : ViewBase, IExportView
  {
    private static MYY10241_OA[] freeArray = new MYY10241_OA[30];
    ...
    public MYY10241_OA( MYY10241_OA orig )
    {
    ...
    public static MYY10241_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new MYY10241_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            MYY10241_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((MYY10241_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( MYY10241_OA orig )
    {
      ExpErrorIyy1ComponentSeverityCode_AS = orig.ExpErrorIyy1ComponentSeverityCode_AS;
      ExpErrorIyy1ComponentSeverityCode = orig.ExpErrorIyy1ComponentSeverityCode;
      ExpErrorIyy1ComponentRollbackIndicator_AS = orig.ExpErrorIyy1ComponentRollbackIndicator_AS;

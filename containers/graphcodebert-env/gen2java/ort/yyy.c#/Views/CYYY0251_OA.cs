...
//
//    Name: CYYY0251_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0251_OA : ViewBase, IExportView
  {
    private static CYYY0251_OA[] freeArray = new CYYY0251_OA[30];
    ...
    public static CYYY0251_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0251_OA result = freeArray[--countFree];

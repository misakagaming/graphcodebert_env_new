...
//
//    Name: CYY1S061_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYY1S061_LA : ViewBase, ILocalView
  {
    private static CYY1S061_LA[] freeArray = new CYY1S061_LA[30];
    ...
    public static CYY1S061_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYY1S061_LA result = freeArray[--countFree];

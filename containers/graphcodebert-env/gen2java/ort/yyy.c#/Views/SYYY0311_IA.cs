...
//
//    Name: SYYY0311_IA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: SYYY0311_IA
  /// </summary>
  [Serializable]
  public class SYYY0311_IA : ViewBase, IImportView
  {
    private static SYYY0311_IA[] freeArray = new SYYY0311_IA[30];
    ...
    public SYYY0311_IA( SYYY0311_IA orig )
    {
    ...
    public static SYYY0311_IA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new SYYY0311_IA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            SYYY0311_IA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((SYYY0311_IA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( SYYY0311_IA orig )
    {
      ImpReferenceIyy1ServerDataUserid_AS = orig.ImpReferenceIyy1ServerDataUserid_AS;
      ImpReferenceIyy1ServerDataUserid = orig.ImpReferenceIyy1ServerDataUserid;
      ImpReferenceIyy1ServerDataReferenceId_AS = orig.ImpReferenceIyy1ServerDataReferenceId_AS;

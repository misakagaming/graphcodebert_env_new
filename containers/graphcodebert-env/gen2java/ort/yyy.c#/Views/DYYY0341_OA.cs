...
//
//    Name: DYYY0341_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0341_OA : ViewBase, IExportView
  {
    private static DYYY0341_OA[] freeArray = new DYYY0341_OA[30];
    ...
    public static DYYY0341_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0341_OA result = freeArray[--countFree];

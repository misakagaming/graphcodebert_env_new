...
//
//    Name: CYYY0321_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0321_IA : ViewBase, IImportView
  {
    private static CYYY0321_IA[] freeArray = new CYYY0321_IA[30];
    ...
    public static CYYY0321_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0321_IA result = freeArray[--countFree];

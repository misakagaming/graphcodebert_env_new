...
//
//    Name: DYYY0151_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0151_IA : ViewBase, IImportView
  {
    private static DYYY0151_IA[] freeArray = new DYYY0151_IA[30];
    ...
    public static DYYY0151_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0151_IA result = freeArray[--countFree];

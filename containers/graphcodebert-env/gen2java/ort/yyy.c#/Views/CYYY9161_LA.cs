...
//
//    Name: CYYY9161_LA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: CYYY9161_LA
  /// </summary>
  [Serializable]
  public class CYYY9161_LA : ViewBase, ILocalView
  {
    private static CYYY9161_LA[] freeArray = new CYYY9161_LA[30];
    ...
    public CYYY9161_LA( CYYY9161_LA orig )
    {
    ...
    public static CYYY9161_LA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new CYYY9161_LA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY9161_LA result = freeArray[--countFree];

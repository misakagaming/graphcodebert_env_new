...
//
//    Name: CYYY0211_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0211_OA : ViewBase, IExportView
  {
    private static CYYY0211_OA[] freeArray = new CYYY0211_OA[30];
    ...
    public static CYYY0211_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0211_OA result = freeArray[--countFree];

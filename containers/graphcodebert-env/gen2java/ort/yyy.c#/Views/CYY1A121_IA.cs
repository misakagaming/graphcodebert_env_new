...
//
//    Name: CYY1A121_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYY1A121_IA : ViewBase, IImportView
  {
    private static CYY1A121_IA[] freeArray = new CYY1A121_IA[30];
    ...
    public static CYY1A121_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYY1A121_IA result = freeArray[--countFree];

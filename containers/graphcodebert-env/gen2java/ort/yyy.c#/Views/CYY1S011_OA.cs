...
//
//    Name: CYY1S011_OA                      Date: 2024/01/09
//    User: AliAl                            Time: 13:40:39
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYY1S011_OA : ViewBase, IExportView
  {
    static VDF localVdf = null;
    
    private static CYY1S011_OA[] freeArray = new CYY1S011_OA[30];
    ...
    public static CYY1S011_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYY1S011_OA result = freeArray[--countFree];
    ...
    public void SetFromVDF( VDF vdf )
    {
      ...
      {
        _ExpIsc1AuthorizationInfoAuthorityStatus01 = (string)vdf.Entries[5].DataValue.Data;
      }
      else 
      {
      ...
      {
        _ExpMsgIyy1ComponentSeverityCode = (string)vdf.Entries[6].DataValue.Data;
      }
      else 
      {
      ...
      {
        _ExpMsgIyy1ComponentMessageTx = (string)vdf.Entries[7].DataValue.Data;
      }
      else 
      {
      ...
      {
        _ExpErrorIyy1ComponentSeverityCode = (string)vdf.Entries[8].DataValue.Data;
      }
      else 
      {
      ...
      {
        _ExpErrorIyy1ComponentRollbackIndicator = (string)vdf.Entries[9].DataValue.Data;
      }
      else 
      {
      ...
      {
        _ExpErrorIyy1ComponentOriginServid = (double)vdf.Entries[10].DataValue.Data;
      }
      else 
      {
      ...
      {
        _ExpErrorIyy1ComponentContextString = (string)vdf.Entries[11].DataValue.Data;
      }
      else 
      {
      ...
      {
        _ExpErrorIyy1ComponentReturnCode = (int)vdf.Entries[12].DataValue.Data;
      }
      else 
      {
      ...
      {
        _ExpErrorIyy1ComponentReasonCode = (int)vdf.Entries[13].DataValue.Data;
      }
      else 
      {
      ...
      {
        _ExpErrorIyy1ComponentChecksum = (string)vdf.Entries[14].DataValue.Data;
      }
      else 
      {
    ...
    public VDF GetVDF(  )
    {
      ...
      // predicate view item
      vdf.Entries[5].DataValue.Data = _ExpIsc1AuthorizationInfoAuthorityStatus01;
      // predicate view item
      vdf.Entries[6].DataValue.Data = _ExpMsgIyy1ComponentSeverityCode;
      // predicate view item
      vdf.Entries[7].DataValue.Data = _ExpMsgIyy1ComponentMessageTx;
      // predicate view item
      vdf.Entries[8].DataValue.Data = _ExpErrorIyy1ComponentSeverityCode;
      // predicate view item
      vdf.Entries[9].DataValue.Data = _ExpErrorIyy1ComponentRollbackIndicator;
      // predicate view item
      vdf.Entries[10].DataValue.Data = _ExpErrorIyy1ComponentOriginServid;
      // predicate view item
      vdf.Entries[11].DataValue.Data = _ExpErrorIyy1ComponentContextString;
      // predicate view item
      vdf.Entries[12].DataValue.Data = _ExpErrorIyy1ComponentReturnCode;
      // predicate view item
      vdf.Entries[13].DataValue.Data = _ExpErrorIyy1ComponentReasonCode;
      // predicate view item
      vdf.Entries[14].DataValue.Data = _ExpErrorIyy1ComponentChecksum;
      return(vdf);
    }

...
//
//    Name: CYYY0441_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0441_IA : ViewBase, IImportView
  {
    private static CYYY0441_IA[] freeArray = new CYYY0441_IA[30];
    ...
    public static CYYY0441_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0441_IA result = freeArray[--countFree];

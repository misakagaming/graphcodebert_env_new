...
//
//    Name: SYYY0341_IA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: SYYY0341_IA
  /// </summary>
  [Serializable]
  public class SYYY0341_IA : ViewBase, IImportView
  {
    private static SYYY0341_IA[] freeArray = new SYYY0341_IA[30];
    ...
    public SYYY0341_IA( SYYY0341_IA orig )
    {
    ...
    public static SYYY0341_IA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new SYYY0341_IA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            SYYY0341_IA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((SYYY0341_IA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( SYYY0341_IA orig )
    {
      ImpReferenceIyy1ServerDataUserid_AS = orig.ImpReferenceIyy1ServerDataUserid_AS;
      ImpReferenceIyy1ServerDataUserid = orig.ImpReferenceIyy1ServerDataUserid;
      ImpReferenceIyy1ServerDataReferenceId_AS = orig.ImpReferenceIyy1ServerDataReferenceId_AS;

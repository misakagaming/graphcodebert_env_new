...
//
//    Name: CYYY9721_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: CYYY9721_OA
  /// </summary>
  [Serializable]
  public class CYYY9721_OA : ViewBase, IExportView
  {
    private static CYYY9721_OA[] freeArray = new CYYY9721_OA[30];
    ...
    public CYYY9721_OA( CYYY9721_OA orig )
    {
    ...
    public static CYYY9721_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new CYYY9721_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY9721_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((CYYY9721_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( CYYY9721_OA orig )
    {
      ExpReferenceIyy1ServerDataServerDate_AS = orig.ExpReferenceIyy1ServerDataServerDate_AS;
      ExpReferenceIyy1ServerDataServerDate = orig.ExpReferenceIyy1ServerDataServerDate;
      ExpReferenceIyy1ServerDataServerTime_AS = orig.ExpReferenceIyy1ServerDataServerTime_AS;

...
//
//    Name: CYYY0141_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0141_OA : ViewBase, IExportView
  {
    private static CYYY0141_OA[] freeArray = new CYYY0141_OA[30];
    ...
    public static CYYY0141_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0141_OA result = freeArray[--countFree];

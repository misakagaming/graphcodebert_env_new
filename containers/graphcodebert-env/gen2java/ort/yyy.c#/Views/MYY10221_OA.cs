...
//
//    Name: MYY10221_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: MYY10221_OA
  /// </summary>
  [Serializable]
  public class MYY10221_OA : ViewBase, IExportView
  {
    private static MYY10221_OA[] freeArray = new MYY10221_OA[30];
    ...
    public MYY10221_OA( MYY10221_OA orig )
    {
    ...
    public static MYY10221_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new MYY10221_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            MYY10221_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((MYY10221_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( MYY10221_OA orig )
    {
      ExpIyy1ChildCinstanceId_AS = orig.ExpIyy1ChildCinstanceId_AS;
      ExpIyy1ChildCinstanceId = orig.ExpIyy1ChildCinstanceId;
      ExpIyy1ChildCreferenceId_AS = orig.ExpIyy1ChildCreferenceId_AS;

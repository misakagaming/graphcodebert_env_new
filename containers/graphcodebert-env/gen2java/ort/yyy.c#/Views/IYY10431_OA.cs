...
//
//    Name: IYY10431_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class IYY10431_OA : ViewBase, IExportView
  {
    private static IYY10431_OA[] freeArray = new IYY10431_OA[30];
    ...
    public static IYY10431_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10431_OA result = freeArray[--countFree];

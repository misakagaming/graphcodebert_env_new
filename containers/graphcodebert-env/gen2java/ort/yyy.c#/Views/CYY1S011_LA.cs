...
//
//    Name: CYY1S011_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYY1S011_LA : ViewBase, ILocalView
  {
    private static CYY1S011_LA[] freeArray = new CYY1S011_LA[30];
    ...
    public static CYY1S011_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYY1S011_LA result = freeArray[--countFree];

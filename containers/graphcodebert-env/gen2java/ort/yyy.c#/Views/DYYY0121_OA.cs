...
//
//    Name: DYYY0121_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0121_OA : ViewBase, IExportView
  {
    private static DYYY0121_OA[] freeArray = new DYYY0121_OA[30];
    ...
    public static DYYY0121_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0121_OA result = freeArray[--countFree];

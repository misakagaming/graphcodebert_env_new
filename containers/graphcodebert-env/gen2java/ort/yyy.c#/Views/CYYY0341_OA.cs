...
//
//    Name: CYYY0341_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0341_OA : ViewBase, IExportView
  {
    private static CYYY0341_OA[] freeArray = new CYYY0341_OA[30];
    ...
    public static CYYY0341_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0341_OA result = freeArray[--countFree];

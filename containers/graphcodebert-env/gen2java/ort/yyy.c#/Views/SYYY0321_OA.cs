...
//
//    Name: SYYY0321_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: SYYY0321_OA
  /// </summary>
  [Serializable]
  public class SYYY0321_OA : ViewBase, IExportView
  {
    private static SYYY0321_OA[] freeArray = new SYYY0321_OA[30];
    ...
    public SYYY0321_OA( SYYY0321_OA orig )
    {
    ...
    public static SYYY0321_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new SYYY0321_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            SYYY0321_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((SYYY0321_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( SYYY0321_OA orig )
    {
      ExpTypeTinstanceId_AS = orig.ExpTypeTinstanceId_AS;
      ExpTypeTinstanceId = orig.ExpTypeTinstanceId;
      ExpTypeTreferenceId_AS = orig.ExpTypeTreferenceId_AS;

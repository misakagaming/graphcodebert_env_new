...
//
//    Name: DYYY0141_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0141_OA : ViewBase, IExportView
  {
    private static DYYY0141_OA[] freeArray = new DYYY0141_OA[30];
    ...
    public static DYYY0141_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0141_OA result = freeArray[--countFree];

...
//
//    Name: CYYY0331_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0331_IA : ViewBase, IImportView
  {
    private static CYYY0331_IA[] freeArray = new CYYY0331_IA[30];
    ...
    public static CYYY0331_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0331_IA result = freeArray[--countFree];

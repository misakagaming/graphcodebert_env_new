...
//
//    Name: MYY10131_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: MYY10131_OA
  /// </summary>
  [Serializable]
  public class MYY10131_OA : ViewBase, IExportView
  {
    private static MYY10131_OA[] freeArray = new MYY10131_OA[30];
    ...
    public MYY10131_OA( MYY10131_OA orig )
    {
    ...
    public static MYY10131_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new MYY10131_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            MYY10131_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((MYY10131_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( MYY10131_OA orig )
    {
      ExpIyy1ParentPreferenceId_AS = orig.ExpIyy1ParentPreferenceId_AS;
      ExpIyy1ParentPreferenceId = orig.ExpIyy1ParentPreferenceId;
      ExpErrorIyy1ComponentSeverityCode_AS = orig.ExpErrorIyy1ComponentSeverityCode_AS;

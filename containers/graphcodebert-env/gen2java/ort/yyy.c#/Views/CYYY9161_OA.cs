...
//
//    Name: CYYY9161_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: CYYY9161_OA
  /// </summary>
  [Serializable]
  public class CYYY9161_OA : ViewBase, IExportView
  {
    private static CYYY9161_OA[] freeArray = new CYYY9161_OA[30];
    ...
    public CYYY9161_OA( CYYY9161_OA orig )
    {
    ...
    public static CYYY9161_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new CYYY9161_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY9161_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((CYYY9161_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( CYYY9161_OA orig )
    {
      ExpErrorIyy1ComponentSeverityCode_AS = orig.ExpErrorIyy1ComponentSeverityCode_AS;
      ExpErrorIyy1ComponentSeverityCode = orig.ExpErrorIyy1ComponentSeverityCode;
      ExpErrorIyy1ComponentRollbackIndicator_AS = orig.ExpErrorIyy1ComponentRollbackIndicator_AS;

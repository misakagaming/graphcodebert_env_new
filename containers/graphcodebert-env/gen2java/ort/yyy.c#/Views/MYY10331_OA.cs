...
//
//    Name: MYY10331_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: MYY10331_OA
  /// </summary>
  [Serializable]
  public class MYY10331_OA : ViewBase, IExportView
  {
    private static MYY10331_OA[] freeArray = new MYY10331_OA[30];
    ...
    public MYY10331_OA( MYY10331_OA orig )
    {
    ...
    public static MYY10331_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new MYY10331_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            MYY10331_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((MYY10331_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( MYY10331_OA orig )
    {
      ExpIyy1TypeTreferenceId_AS = orig.ExpIyy1TypeTreferenceId_AS;
      ExpIyy1TypeTreferenceId = orig.ExpIyy1TypeTreferenceId;
      ExpErrorIyy1ComponentSeverityCode_AS = orig.ExpErrorIyy1ComponentSeverityCode_AS;

...
//
//    Name: IYY10131_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY10131_OA
  /// </summary>
  [Serializable]
  public class IYY10131_OA : ViewBase, IExportView
  {
    private static IYY10131_OA[] freeArray = new IYY10131_OA[30];
    ...
    public IYY10131_OA( IYY10131_OA orig )
    {
    ...
    public static IYY10131_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY10131_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10131_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY10131_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY10131_OA orig )
    {
      ExpIyy1ParentPreferenceId_AS = orig.ExpIyy1ParentPreferenceId_AS;
      ExpIyy1ParentPreferenceId = orig.ExpIyy1ParentPreferenceId;
      ExpErrorIyy1ComponentSeverityCode_AS = orig.ExpErrorIyy1ComponentSeverityCode_AS;

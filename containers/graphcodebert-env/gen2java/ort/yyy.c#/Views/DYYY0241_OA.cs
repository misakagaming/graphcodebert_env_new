...
//
//    Name: DYYY0241_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0241_OA : ViewBase, IExportView
  {
    private static DYYY0241_OA[] freeArray = new DYYY0241_OA[30];
    ...
    public static DYYY0241_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0241_OA result = freeArray[--countFree];

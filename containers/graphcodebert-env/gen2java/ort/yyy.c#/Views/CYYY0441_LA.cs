...
//
//    Name: CYYY0441_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0441_LA : ViewBase, ILocalView
  {
    private static CYYY0441_LA[] freeArray = new CYYY0441_LA[30];
    ...
    public static CYYY0441_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0441_LA result = freeArray[--countFree];

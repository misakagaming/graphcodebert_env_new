...
//
//    Name: IYY10151_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY10151_OA
  /// </summary>
  [Serializable]
  public class IYY10151_OA : ViewBase, IExportView
  {
    private static IYY10151_OA[] freeArray = new IYY10151_OA[30];
    ...
    public IYY10151_OA( IYY10151_OA orig )
    {
    ...
    public static IYY10151_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY10151_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10151_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY10151_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY10151_OA orig )
    {
      ExpGroupList_MA = orig.ExpGroupList_MA;
      for(int a = 0; a < 48; a++)
      {

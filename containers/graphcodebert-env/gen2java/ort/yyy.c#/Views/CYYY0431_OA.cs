...
//
//    Name: CYYY0431_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0431_OA : ViewBase, IExportView
  {
    private static CYYY0431_OA[] freeArray = new CYYY0431_OA[30];
    ...
    public static CYYY0431_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0431_OA result = freeArray[--countFree];

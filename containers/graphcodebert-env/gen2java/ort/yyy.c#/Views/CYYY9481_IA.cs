...
//
//    Name: CYYY9481_IA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: CYYY9481_IA
  /// </summary>
  [Serializable]
  public class CYYY9481_IA : ViewBase, IImportView
  {
    private static CYYY9481_IA[] freeArray = new CYYY9481_IA[30];
    ...
    public CYYY9481_IA( CYYY9481_IA orig )
    {
    ...
    public static CYYY9481_IA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new CYYY9481_IA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY9481_IA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((CYYY9481_IA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( CYYY9481_IA orig )
    {
      ImpErrorIyy1ComponentOriginServid_AS = orig.ImpErrorIyy1ComponentOriginServid_AS;
      ImpErrorIyy1ComponentOriginServid = orig.ImpErrorIyy1ComponentOriginServid;
      ImpErrorIyy1ComponentContextString_AS = orig.ImpErrorIyy1ComponentContextString_AS;

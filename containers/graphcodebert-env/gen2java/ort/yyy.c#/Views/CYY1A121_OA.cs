...
//
//    Name: CYY1A121_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYY1A121_OA : ViewBase, IExportView
  {
    private static CYY1A121_OA[] freeArray = new CYY1A121_OA[30];
    ...
    public static CYY1A121_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYY1A121_OA result = freeArray[--countFree];

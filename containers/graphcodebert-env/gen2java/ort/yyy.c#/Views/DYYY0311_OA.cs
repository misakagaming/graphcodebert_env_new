...
//
//    Name: DYYY0311_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0311_OA : ViewBase, IExportView
  {
    private static DYYY0311_OA[] freeArray = new DYYY0311_OA[30];
    ...
    public static DYYY0311_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0311_OA result = freeArray[--countFree];

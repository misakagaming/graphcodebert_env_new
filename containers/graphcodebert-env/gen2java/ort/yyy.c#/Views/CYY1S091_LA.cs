...
//
//    Name: CYY1S091_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYY1S091_LA : ViewBase, ILocalView
  {
    private static CYY1S091_LA[] freeArray = new CYY1S091_LA[30];
    ...
    public static CYY1S091_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYY1S091_LA result = freeArray[--countFree];

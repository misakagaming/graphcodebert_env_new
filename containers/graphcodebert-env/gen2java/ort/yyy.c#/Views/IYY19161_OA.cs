...
//
//    Name: IYY19161_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY19161_OA
  /// </summary>
  [Serializable]
  public class IYY19161_OA : ViewBase, IExportView
  {
    private static IYY19161_OA[] freeArray = new IYY19161_OA[30];
    ...
    public IYY19161_OA( IYY19161_OA orig )
    {
    ...
    public static IYY19161_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY19161_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY19161_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY19161_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY19161_OA orig )
    {
      ExpErrorIyy1ComponentSeverityCode_AS = orig.ExpErrorIyy1ComponentSeverityCode_AS;
      ExpErrorIyy1ComponentSeverityCode = orig.ExpErrorIyy1ComponentSeverityCode;
      ExpErrorIyy1ComponentRollbackIndicator_AS = orig.ExpErrorIyy1ComponentRollbackIndicator_AS;

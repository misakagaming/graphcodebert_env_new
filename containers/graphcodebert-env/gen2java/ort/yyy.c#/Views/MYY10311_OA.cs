...
//
//    Name: MYY10311_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: MYY10311_OA
  /// </summary>
  [Serializable]
  public class MYY10311_OA : ViewBase, IExportView
  {
    private static MYY10311_OA[] freeArray = new MYY10311_OA[30];
    ...
    public MYY10311_OA( MYY10311_OA orig )
    {
    ...
    public static MYY10311_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new MYY10311_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            MYY10311_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((MYY10311_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( MYY10311_OA orig )
    {
      ExpIyy1TypeTinstanceId_AS = orig.ExpIyy1TypeTinstanceId_AS;
      ExpIyy1TypeTinstanceId = orig.ExpIyy1TypeTinstanceId;
      ExpIyy1TypeTreferenceId_AS = orig.ExpIyy1TypeTreferenceId_AS;

...
//
//    Name: IYY19041_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY19041_OA
  /// </summary>
  [Serializable]
  public class IYY19041_OA : ViewBase, IExportView
  {
    private static IYY19041_OA[] freeArray = new IYY19041_OA[30];
    ...
    public IYY19041_OA( IYY19041_OA orig )
    {
    ...
    public static IYY19041_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY19041_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY19041_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY19041_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY19041_OA orig )
    {
      ExpErrorMsgIyy1ComponentSeverityCode_AS = orig.ExpErrorMsgIyy1ComponentSeverityCode_AS;
      ExpErrorMsgIyy1ComponentSeverityCode = orig.ExpErrorMsgIyy1ComponentSeverityCode;
      ExpErrorMsgIyy1ComponentMessageTx_AS = orig.ExpErrorMsgIyy1ComponentMessageTx_AS;

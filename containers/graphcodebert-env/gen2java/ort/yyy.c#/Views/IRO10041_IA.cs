...
//
//    Name: IRO10041_IA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IRO10041_IA
  /// </summary>
  [Serializable]
  public class IRO10041_IA : ViewBase, IImportView
  {
    private static IRO10041_IA[] freeArray = new IRO10041_IA[30];
    ...
    public IRO10041_IA( IRO10041_IA orig )
    {
    ...
    public static IRO10041_IA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IRO10041_IA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IRO10041_IA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IRO10041_IA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IRO10041_IA orig )
    {
      InIro1ComponentReturnCode_AS = orig.InIro1ComponentReturnCode_AS;
      InIro1ComponentReturnCode = orig.InIro1ComponentReturnCode;
      InIro1ComponentReasonCode_AS = orig.InIro1ComponentReasonCode_AS;

...
//
//    Name: CYYY0241_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0241_IA : ViewBase, IImportView
  {
    private static CYYY0241_IA[] freeArray = new CYYY0241_IA[30];
    ...
    public static CYYY0241_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0241_IA result = freeArray[--countFree];

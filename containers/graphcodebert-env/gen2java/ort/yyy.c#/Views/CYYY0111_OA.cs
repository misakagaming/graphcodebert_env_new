...
//
//    Name: CYYY0111_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0111_OA : ViewBase, IExportView
  {
    private static CYYY0111_OA[] freeArray = new CYYY0111_OA[30];
    ...
    public static CYYY0111_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0111_OA result = freeArray[--countFree];

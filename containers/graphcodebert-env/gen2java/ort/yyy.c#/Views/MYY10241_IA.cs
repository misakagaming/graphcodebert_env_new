...
//
//    Name: MYY10241_IA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: MYY10241_IA
  /// </summary>
  [Serializable]
  public class MYY10241_IA : ViewBase, IImportView
  {
    private static MYY10241_IA[] freeArray = new MYY10241_IA[30];
    ...
    public MYY10241_IA( MYY10241_IA orig )
    {
    ...
    public static MYY10241_IA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new MYY10241_IA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            MYY10241_IA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((MYY10241_IA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( MYY10241_IA orig )
    {
      ImpReferenceIyy1ServerDataUserid_AS = orig.ImpReferenceIyy1ServerDataUserid_AS;
      ImpReferenceIyy1ServerDataUserid = orig.ImpReferenceIyy1ServerDataUserid;
      ImpReferenceIyy1ServerDataReferenceId_AS = orig.ImpReferenceIyy1ServerDataReferenceId_AS;

...
//
//    Name: CYYY9831_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY9831_OA : ViewBase, IExportView
  {
    private static CYYY9831_OA[] freeArray = new CYYY9831_OA[30];
    ...
    public static CYYY9831_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY9831_OA result = freeArray[--countFree];

...
//
//    Name: CYYY0311_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0311_OA : ViewBase, IExportView
  {
    private static CYYY0311_OA[] freeArray = new CYYY0311_OA[30];
    ...
    public static CYYY0311_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0311_OA result = freeArray[--countFree];

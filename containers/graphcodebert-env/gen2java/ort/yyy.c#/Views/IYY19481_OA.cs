...
//
//    Name: IYY19481_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY19481_OA
  /// </summary>
  [Serializable]
  public class IYY19481_OA : ViewBase, IExportView
  {
    private static IYY19481_OA[] freeArray = new IYY19481_OA[30];
    ...
    public IYY19481_OA( IYY19481_OA orig )
    {
    ...
    public static IYY19481_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY19481_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY19481_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY19481_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY19481_OA orig )
    {
      ExpGroupHilite_MA = orig.ExpGroupHilite_MA;
      for(int a = 0; a < 10; a++)
      {

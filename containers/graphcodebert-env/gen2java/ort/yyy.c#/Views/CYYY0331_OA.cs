...
//
//    Name: CYYY0331_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0331_OA : ViewBase, IExportView
  {
    private static CYYY0331_OA[] freeArray = new CYYY0331_OA[30];
    ...
    public static CYYY0331_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0331_OA result = freeArray[--countFree];

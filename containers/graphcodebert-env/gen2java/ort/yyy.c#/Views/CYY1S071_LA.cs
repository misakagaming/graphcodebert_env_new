...
//
//    Name: CYY1S071_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYY1S071_LA : ViewBase, ILocalView
  {
    private static CYY1S071_LA[] freeArray = new CYY1S071_LA[30];
    ...
    public static CYY1S071_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYY1S071_LA result = freeArray[--countFree];

...
//
//    Name: IYY10141_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY10141_OA
  /// </summary>
  [Serializable]
  public class IYY10141_OA : ViewBase, IExportView
  {
    private static IYY10141_OA[] freeArray = new IYY10141_OA[30];
    ...
    public IYY10141_OA( IYY10141_OA orig )
    {
    ...
    public static IYY10141_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY10141_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10141_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY10141_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY10141_OA orig )
    {
      ExpErrorIyy1ComponentSeverityCode_AS = orig.ExpErrorIyy1ComponentSeverityCode_AS;
      ExpErrorIyy1ComponentSeverityCode = orig.ExpErrorIyy1ComponentSeverityCode;
      ExpErrorIyy1ComponentRollbackIndicator_AS = orig.ExpErrorIyy1ComponentRollbackIndicator_AS;

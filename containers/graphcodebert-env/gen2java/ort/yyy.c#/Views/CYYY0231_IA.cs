...
//
//    Name: CYYY0231_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0231_IA : ViewBase, IImportView
  {
    private static CYYY0231_IA[] freeArray = new CYYY0231_IA[30];
    ...
    public static CYYY0231_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0231_IA result = freeArray[--countFree];

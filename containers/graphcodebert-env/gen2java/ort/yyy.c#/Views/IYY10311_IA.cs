...
//
//    Name: IYY10311_IA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY10311_IA
  /// </summary>
  [Serializable]
  public class IYY10311_IA : ViewBase, IImportView
  {
    private static IYY10311_IA[] freeArray = new IYY10311_IA[30];
    ...
    public IYY10311_IA( IYY10311_IA orig )
    {
    ...
    public static IYY10311_IA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY10311_IA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10311_IA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY10311_IA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY10311_IA orig )
    {
      ImpReferenceIyy1ServerDataUserid_AS = orig.ImpReferenceIyy1ServerDataUserid_AS;
      ImpReferenceIyy1ServerDataUserid = orig.ImpReferenceIyy1ServerDataUserid;
      ImpReferenceIyy1ServerDataReferenceId_AS = orig.ImpReferenceIyy1ServerDataReferenceId_AS;

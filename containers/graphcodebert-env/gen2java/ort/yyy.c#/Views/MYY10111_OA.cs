...
//
//    Name: MYY10111_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: MYY10111_OA
  /// </summary>
  [Serializable]
  public class MYY10111_OA : ViewBase, IExportView
  {
    private static MYY10111_OA[] freeArray = new MYY10111_OA[30];
    ...
    public MYY10111_OA( MYY10111_OA orig )
    {
    ...
    public static MYY10111_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new MYY10111_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            MYY10111_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((MYY10111_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( MYY10111_OA orig )
    {
      ExpIyy1ParentPinstanceId_AS = orig.ExpIyy1ParentPinstanceId_AS;
      ExpIyy1ParentPinstanceId = orig.ExpIyy1ParentPinstanceId;
      ExpIyy1ParentPreferenceId_AS = orig.ExpIyy1ParentPreferenceId_AS;

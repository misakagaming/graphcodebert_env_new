...
//
//    Name: CYYY0421_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0421_IA : ViewBase, IImportView
  {
    private static CYYY0421_IA[] freeArray = new CYYY0421_IA[30];
    ...
    public static CYYY0421_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0421_IA result = freeArray[--countFree];

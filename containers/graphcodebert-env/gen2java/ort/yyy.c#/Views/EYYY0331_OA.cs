...
//
//    Name: EYYY0331_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: EYYY0331_OA
  /// </summary>
  [Serializable]
  public class EYYY0331_OA : ViewBase, IExportView
  {
    private static EYYY0331_OA[] freeArray = new EYYY0331_OA[30];
    ...
    public EYYY0331_OA( EYYY0331_OA orig )
    {
    ...
    public static EYYY0331_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new EYYY0331_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            EYYY0331_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((EYYY0331_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( EYYY0331_OA orig )
    {
      ExpTypeTreferenceId_AS = orig.ExpTypeTreferenceId_AS;
      ExpTypeTreferenceId = orig.ExpTypeTreferenceId;
      ExpErrorDontChangeTextText2_AS = orig.ExpErrorDontChangeTextText2_AS;

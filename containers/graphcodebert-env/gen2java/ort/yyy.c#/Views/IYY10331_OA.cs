...
//
//    Name: IYY10331_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY10331_OA
  /// </summary>
  [Serializable]
  public class IYY10331_OA : ViewBase, IExportView
  {
    private static IYY10331_OA[] freeArray = new IYY10331_OA[30];
    ...
    public IYY10331_OA( IYY10331_OA orig )
    {
    ...
    public static IYY10331_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY10331_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10331_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY10331_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY10331_OA orig )
    {
      ExpIyy1TypeTreferenceId_AS = orig.ExpIyy1TypeTreferenceId_AS;
      ExpIyy1TypeTreferenceId = orig.ExpIyy1TypeTreferenceId;
      ExpErrorIyy1ComponentSeverityCode_AS = orig.ExpErrorIyy1ComponentSeverityCode_AS;

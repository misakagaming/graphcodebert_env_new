...
//
//    Name: CYY1S011_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYY1S011_IA : ViewBase, IImportView
  {
    static VDF localVdf = null;
    
    private static CYY1S011_IA[] freeArray = new CYY1S011_IA[30];
    ...
    public static CYY1S011_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYY1S011_IA result = freeArray[--countFree];

...
//
//    Name: DYYY0221_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0221_IA : ViewBase, IImportView
  {
    private static DYYY0221_IA[] freeArray = new DYYY0221_IA[30];
    ...
    public static DYYY0221_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0221_IA result = freeArray[--countFree];

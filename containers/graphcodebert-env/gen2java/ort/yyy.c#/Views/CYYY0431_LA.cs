...
//
//    Name: CYYY0431_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0431_LA : ViewBase, ILocalView
  {
    private static CYYY0431_LA[] freeArray = new CYYY0431_LA[30];
    ...
    public static CYYY0431_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0431_LA result = freeArray[--countFree];

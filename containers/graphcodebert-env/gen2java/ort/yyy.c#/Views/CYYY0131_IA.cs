...
//
//    Name: CYYY0131_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0131_IA : ViewBase, IImportView
  {
    private static CYYY0131_IA[] freeArray = new CYYY0131_IA[30];
    ...
    public static CYYY0131_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0131_IA result = freeArray[--countFree];

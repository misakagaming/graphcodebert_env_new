...
//
//    Name: CYYY9821_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY9821_OA : ViewBase, IExportView
  {
    private static CYYY9821_OA[] freeArray = new CYYY9821_OA[30];
    ...
    public static CYYY9821_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY9821_OA result = freeArray[--countFree];

...
//
//    Name: IYY10111_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY10111_OA
  /// </summary>
  [Serializable]
  public class IYY10111_OA : ViewBase, IExportView
  {
    private static IYY10111_OA[] freeArray = new IYY10111_OA[30];
    ...
    public IYY10111_OA( IYY10111_OA orig )
    {
    ...
    public static IYY10111_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY10111_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10111_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY10111_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY10111_OA orig )
    {
      ExpIyy1ParentPinstanceId_AS = orig.ExpIyy1ParentPinstanceId_AS;
      ExpIyy1ParentPinstanceId = orig.ExpIyy1ParentPinstanceId;
      ExpIyy1ParentPreferenceId_AS = orig.ExpIyy1ParentPreferenceId_AS;

...
//
//    Name: CYYY9151_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: CYYY9151_OA
  /// </summary>
  [Serializable]
  public class CYYY9151_OA : ViewBase, IExportView
  {
    private static CYYY9151_OA[] freeArray = new CYYY9151_OA[30];
    ...
    public CYYY9151_OA( CYYY9151_OA orig )
    {
    ...
    public static CYYY9151_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new CYYY9151_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY9151_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((CYYY9151_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( CYYY9151_OA orig )
    {
      ExpChecksumIyy1ComponentChecksum_AS = orig.ExpChecksumIyy1ComponentChecksum_AS;
      ExpChecksumIyy1ComponentChecksum = orig.ExpChecksumIyy1ComponentChecksum;
      ExpErrorIyy1ComponentSeverityCode_AS = orig.ExpErrorIyy1ComponentSeverityCode_AS;

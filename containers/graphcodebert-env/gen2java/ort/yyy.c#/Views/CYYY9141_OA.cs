...
//
//    Name: CYYY9141_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY9141_OA : ViewBase, IExportView
  {
    private static CYYY9141_OA[] freeArray = new CYYY9141_OA[30];
    private static int countFree = 0;
    
    // Entity View: EXP_CONTEXT
    //        Type: IYY1_COMPONENT
    /// <summary>
    /// Internal storage for attribute missing flag for: ExpContextIyy1ComponentContextString
    /// </summary>
    private char _ExpContextIyy1ComponentContextString_AS;
    /// <summary>
    /// Attribute missing flag for: ExpContextIyy1ComponentContextString
    /// </summary>
    public char ExpContextIyy1ComponentContextString_AS {
      get {
        return(_ExpContextIyy1ComponentContextString_AS);
      }
      set {
        _ExpContextIyy1ComponentContextString_AS = value;
      }
    }
    /// <summary>
    /// Internal storage, attribute for: ExpContextIyy1ComponentContextString
    /// Domain: Text
    /// Length: 512
    /// Varying Length: Y
    /// </summary>
    private string _ExpContextIyy1ComponentContextString;
    /// <summary>
    /// Attribute for: ExpContextIyy1ComponentContextString
    /// </summary>
    public string ExpContextIyy1ComponentContextString {
      get {
        return(_ExpContextIyy1ComponentContextString);
      }
      set {
        _ExpContextIyy1ComponentContextString = value;
      }
    }
    ...
    public static CYYY9141_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY9141_OA result = freeArray[--countFree];

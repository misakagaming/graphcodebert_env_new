...
//
//    Name: MYY10251_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: MYY10251_OA
  /// </summary>
  [Serializable]
  public class MYY10251_OA : ViewBase, IExportView
  {
    private static MYY10251_OA[] freeArray = new MYY10251_OA[30];
    ...
    public MYY10251_OA( MYY10251_OA orig )
    {
    ...
    public static MYY10251_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new MYY10251_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            MYY10251_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((MYY10251_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( MYY10251_OA orig )
    {
      ExpGroupList_MA = orig.ExpGroupList_MA;
      for(int a = 0; a < 48; a++)
      {

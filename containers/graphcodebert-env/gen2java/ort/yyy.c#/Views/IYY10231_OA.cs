...
//
//    Name: IYY10231_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY10231_OA
  /// </summary>
  [Serializable]
  public class IYY10231_OA : ViewBase, IExportView
  {
    private static IYY10231_OA[] freeArray = new IYY10231_OA[30];
    ...
    public IYY10231_OA( IYY10231_OA orig )
    {
    ...
    public static IYY10231_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY10231_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10231_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY10231_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY10231_OA orig )
    {
      ExpIyy1ChildCreferenceId_AS = orig.ExpIyy1ChildCreferenceId_AS;
      ExpIyy1ChildCreferenceId = orig.ExpIyy1ChildCreferenceId;
      ExpErrorIyy1ComponentSeverityCode_AS = orig.ExpErrorIyy1ComponentSeverityCode_AS;

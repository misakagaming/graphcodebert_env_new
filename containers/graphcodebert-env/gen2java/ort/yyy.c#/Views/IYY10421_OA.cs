...
//
//    Name: IYY10421_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class IYY10421_OA : ViewBase, IExportView
  {
    private static IYY10421_OA[] freeArray = new IYY10421_OA[30];
    ...
    public static IYY10421_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10421_OA result = freeArray[--countFree];

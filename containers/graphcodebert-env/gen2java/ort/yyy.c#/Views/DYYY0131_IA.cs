...
//
//    Name: DYYY0131_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0131_IA : ViewBase, IImportView
  {
    private static DYYY0131_IA[] freeArray = new DYYY0131_IA[30];
    ...
    public static DYYY0131_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0131_IA result = freeArray[--countFree];

...
//
//    Name: CYYY9721_LA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: CYYY9721_LA
  /// </summary>
  [Serializable]
  public class CYYY9721_LA : ViewBase, ILocalView
  {
    private static CYYY9721_LA[] freeArray = new CYYY9721_LA[30];
    private static int countFree = 0;
    
    // Entity View: LOC_YES
    //        Type: DONT_CHANGE_TEXT
    /// <summary>
    /// Internal storage for attribute missing flag for: LocYesDontChangeTextText1
    /// </summary>
    private char _LocYesDontChangeTextText1_AS;
    /// <summary>
    /// Attribute missing flag for: LocYesDontChangeTextText1
    /// </summary>
    public char LocYesDontChangeTextText1_AS {
      get {
        return(_LocYesDontChangeTextText1_AS);
      }
      set {
        _LocYesDontChangeTextText1_AS = value;
      }
    }
    /// <summary>
    /// Internal storage, attribute for: LocYesDontChangeTextText1
    /// Domain: Text
    /// Length: 1
    /// Varying Length: N
    /// </summary>
    private string _LocYesDontChangeTextText1;
    /// <summary>
    /// Attribute for: LocYesDontChangeTextText1
    /// </summary>
    public string LocYesDontChangeTextText1 {
      get {
        return(_LocYesDontChangeTextText1);
      }
      set {
        _LocYesDontChangeTextText1 = value;
      }
    }
    // Entity View: LOC
    //        Type: IXX1_SUPPLIED
    /// <summary>
    /// Internal storage for attribute missing flag for: LocIxx1SuppliedFlag
    /// </summary>
    private char _LocIxx1SuppliedFlag_AS;
    /// <summary>
    /// Attribute missing flag for: LocIxx1SuppliedFlag
    /// </summary>
    public char LocIxx1SuppliedFlag_AS {
      get {
        return(_LocIxx1SuppliedFlag_AS);
      }
      set {
        _LocIxx1SuppliedFlag_AS = value;
      }
    }
    /// <summary>
    /// Internal storage, attribute for: LocIxx1SuppliedFlag
    /// Domain: Text
    /// Length: 1
    /// Varying Length: N
    /// </summary>
    private string _LocIxx1SuppliedFlag;
    /// <summary>
    /// Attribute for: LocIxx1SuppliedFlag
    /// </summary>
    public string LocIxx1SuppliedFlag {
      get {
        return(_LocIxx1SuppliedFlag);
      }
      set {
        _LocIxx1SuppliedFlag = value;
      }
    }
    ...
    public CYYY9721_LA( CYYY9721_LA orig )
    {
      LocYesDontChangeTextText1_AS = orig.LocYesDontChangeTextText1_AS;
      LocYesDontChangeTextText1 = orig.LocYesDontChangeTextText1;
      LocIxx1SuppliedFlag_AS = orig.LocIxx1SuppliedFlag_AS;
      LocIxx1SuppliedFlag = orig.LocIxx1SuppliedFlag;
    ...
    public static CYYY9721_LA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new CYYY9721_LA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY9721_LA result = freeArray[--countFree];
    ...
    public void Reset(  )
    {
      LocYesDontChangeTextText1_AS = ' ';
      LocYesDontChangeTextText1 = " ";
      LocIxx1SuppliedFlag_AS = ' ';
      LocIxx1SuppliedFlag = " ";

...
//
//    Name: MYY10351_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class MYY10351_OA : ViewBase, IExportView
  {
    private static MYY10351_OA[] freeArray = new MYY10351_OA[30];
    ...
    public static MYY10351_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            MYY10351_OA result = freeArray[--countFree];

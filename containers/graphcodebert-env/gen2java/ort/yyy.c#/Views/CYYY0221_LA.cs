...
//
//    Name: CYYY0221_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0221_LA : ViewBase, ILocalView
  {
    private static CYYY0221_LA[] freeArray = new CYYY0221_LA[30];
    ...
    public static CYYY0221_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0221_LA result = freeArray[--countFree];

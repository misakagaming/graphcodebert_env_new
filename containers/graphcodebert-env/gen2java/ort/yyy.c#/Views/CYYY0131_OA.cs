...
//
//    Name: CYYY0131_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0131_OA : ViewBase, IExportView
  {
    private static CYYY0131_OA[] freeArray = new CYYY0131_OA[30];
    ...
    public static CYYY0131_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0131_OA result = freeArray[--countFree];

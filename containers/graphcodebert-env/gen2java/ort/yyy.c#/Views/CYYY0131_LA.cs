...
//
//    Name: CYYY0131_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0131_LA : ViewBase, ILocalView
  {
    private static CYYY0131_LA[] freeArray = new CYYY0131_LA[30];
    ...
    public static CYYY0131_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0131_LA result = freeArray[--countFree];

...
//
//    Name: DYYY0151_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0151_LA : ViewBase, ILocalView
  {
    private static DYYY0151_LA[] freeArray = new DYYY0151_LA[30];
    ...
    public static DYYY0151_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0151_LA result = freeArray[--countFree];

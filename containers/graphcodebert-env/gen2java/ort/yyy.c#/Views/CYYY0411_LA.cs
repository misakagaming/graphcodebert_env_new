...
//
//    Name: CYYY0411_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0411_LA : ViewBase, ILocalView
  {
    private static CYYY0411_LA[] freeArray = new CYYY0411_LA[30];
    ...
    public static CYYY0411_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0411_LA result = freeArray[--countFree];

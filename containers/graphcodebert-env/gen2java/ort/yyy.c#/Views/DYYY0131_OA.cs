...
//
//    Name: DYYY0131_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0131_OA : ViewBase, IExportView
  {
    private static DYYY0131_OA[] freeArray = new DYYY0131_OA[30];
    ...
    public static DYYY0131_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0131_OA result = freeArray[--countFree];

...
//
//    Name: CYYY0421_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0421_OA : ViewBase, IExportView
  {
    private static CYYY0421_OA[] freeArray = new CYYY0421_OA[30];
    ...
    public static CYYY0421_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0421_OA result = freeArray[--countFree];

...
//
//    Name: CYYY0431_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0431_IA : ViewBase, IImportView
  {
    private static CYYY0431_IA[] freeArray = new CYYY0431_IA[30];
    ...
    public static CYYY0431_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0431_IA result = freeArray[--countFree];

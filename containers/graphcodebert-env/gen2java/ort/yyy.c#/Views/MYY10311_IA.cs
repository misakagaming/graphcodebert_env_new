...
//
//    Name: MYY10311_IA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: MYY10311_IA
  /// </summary>
  [Serializable]
  public class MYY10311_IA : ViewBase, IImportView
  {
    private static MYY10311_IA[] freeArray = new MYY10311_IA[30];
    ...
    public MYY10311_IA( MYY10311_IA orig )
    {
    ...
    public static MYY10311_IA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new MYY10311_IA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            MYY10311_IA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((MYY10311_IA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( MYY10311_IA orig )
    {
      ImpReferenceIyy1ServerDataUserid_AS = orig.ImpReferenceIyy1ServerDataUserid_AS;
      ImpReferenceIyy1ServerDataUserid = orig.ImpReferenceIyy1ServerDataUserid;
      ImpReferenceIyy1ServerDataReferenceId_AS = orig.ImpReferenceIyy1ServerDataReferenceId_AS;

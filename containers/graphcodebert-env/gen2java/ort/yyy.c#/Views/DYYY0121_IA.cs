...
//
//    Name: DYYY0121_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0121_IA : ViewBase, IImportView
  {
    private static DYYY0121_IA[] freeArray = new DYYY0121_IA[30];
    ...
    public static DYYY0121_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0121_IA result = freeArray[--countFree];

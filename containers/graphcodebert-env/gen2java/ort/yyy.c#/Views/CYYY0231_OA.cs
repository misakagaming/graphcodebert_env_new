...
//
//    Name: CYYY0231_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0231_OA : ViewBase, IExportView
  {
    private static CYYY0231_OA[] freeArray = new CYYY0231_OA[30];
    ...
    public static CYYY0231_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0231_OA result = freeArray[--countFree];

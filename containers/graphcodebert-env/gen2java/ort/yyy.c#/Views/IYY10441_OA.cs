...
//
//    Name: IYY10441_OA                      Date: 2024/01/09
//    User: AliAl                            Time: 13:41:30
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class IYY10441_OA : ViewBase, IExportView
  {
    private static IYY10441_OA[] freeArray = new IYY10441_OA[30];
    ...
    public static IYY10441_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10441_OA result = freeArray[--countFree];

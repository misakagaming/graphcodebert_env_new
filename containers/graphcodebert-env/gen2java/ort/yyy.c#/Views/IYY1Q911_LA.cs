...
//
//    Name: IYY1Q911_LA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY1Q911_LA
  /// </summary>
  [Serializable]
  public class IYY1Q911_LA : ViewBase, ILocalView
  {
    private static IYY1Q911_LA[] freeArray = new IYY1Q911_LA[30];
    private static int countFree = 0;
    
    // Entity View: LOC_NUMBER
    //        Type: DONT_CHANGE_NUMBER
    /// <summary>
    /// Internal storage for attribute missing flag for: LocNumberDontChangeNumberNum15
    /// </summary>
    private char _LocNumberDontChangeNumberNum15_AS;
    /// <summary>
    /// Attribute missing flag for: LocNumberDontChangeNumberNum15
    /// </summary>
    public char LocNumberDontChangeNumberNum15_AS {
      get {
        return(_LocNumberDontChangeNumberNum15_AS);
      }
      set {
        _LocNumberDontChangeNumberNum15_AS = value;
      }
    }
    /// <summary>
    /// Internal storage, attribute for: LocNumberDontChangeNumberNum15
    /// Domain: Number
    /// Length: 15
    /// Decimal Places: 0
    /// Decimal Precision: N
    /// </summary>
    private double _LocNumberDontChangeNumberNum15;
    /// <summary>
    /// Attribute for: LocNumberDontChangeNumberNum15
    /// </summary>
    public double LocNumberDontChangeNumberNum15 {
      get {
        return(_LocNumberDontChangeNumberNum15);
      }
      set {
        _LocNumberDontChangeNumberNum15 = value;
      }
    }
    // Entity View: LOC_TEXT
    //        Type: DONT_CHANGE_TEXT
    /// <summary>
    /// Internal storage for attribute missing flag for: LocTextDontChangeTextText17
    /// </summary>
    private char _LocTextDontChangeTextText17_AS;
    /// <summary>
    /// Attribute missing flag for: LocTextDontChangeTextText17
    /// </summary>
    public char LocTextDontChangeTextText17_AS {
      get {
        return(_LocTextDontChangeTextText17_AS);
      }
      set {
        _LocTextDontChangeTextText17_AS = value;
      }
    }
    /// <summary>
    /// Internal storage, attribute for: LocTextDontChangeTextText17
    /// Domain: Text
    /// Length: 17
    /// Varying Length: N
    /// </summary>
    private string _LocTextDontChangeTextText17;
    /// <summary>
    /// Attribute for: LocTextDontChangeTextText17
    /// </summary>
    public string LocTextDontChangeTextText17 {
      get {
        return(_LocTextDontChangeTextText17);
      }
      set {
        _LocTextDontChangeTextText17 = value;
      }
    }
    ...
    public IYY1Q911_LA( IYY1Q911_LA orig )
    {
      LocNumberDontChangeNumberNum15_AS = orig.LocNumberDontChangeNumberNum15_AS;
      LocNumberDontChangeNumberNum15 = orig.LocNumberDontChangeNumberNum15;
      LocTextDontChangeTextText17_AS = orig.LocTextDontChangeTextText17_AS;
      LocTextDontChangeTextText17 = orig.LocTextDontChangeTextText17;
    ...
    public static IYY1Q911_LA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY1Q911_LA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY1Q911_LA result = freeArray[--countFree];
    ...
    public void Reset(  )
    {
      LocNumberDontChangeNumberNum15_AS = ' ';
      LocNumberDontChangeNumberNum15 = 0.0;
      LocTextDontChangeTextText17_AS = ' ';
      LocTextDontChangeTextText17 = "                 ";

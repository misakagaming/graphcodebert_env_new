...
//
//    Name: IYY19051_OA                      Date: 2024/01/09
//    User: AliAl                            Time: 13:41:49
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
{
  /// <summary>
  /// Internal data view storage for: IYY19051_OA
  /// </summary>
  [Serializable]
  public class IYY19051_OA : ViewBase, IExportView
  {
    private static IYY19051_OA[] freeArray = new IYY19051_OA[30];
    ...
    public IYY19051_OA( IYY19051_OA orig )
    {
    ...
    public static IYY19051_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY19051_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY19051_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY19051_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY19051_OA orig )
    {
      ExpIdentifiersIyy1ComponentOriginServid_AS = orig.ExpIdentifiersIyy1ComponentOriginServid_AS;
      ExpIdentifiersIyy1ComponentOriginServid = orig.ExpIdentifiersIyy1ComponentOriginServid;
      ExpIdentifiersIyy1ComponentImplementationId_AS = orig.ExpIdentifiersIyy1ComponentImplementationId_AS;

...
//
//    Name: IYY10211_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY10211_OA
  /// </summary>
  [Serializable]
  public class IYY10211_OA : ViewBase, IExportView
  {
    private static IYY10211_OA[] freeArray = new IYY10211_OA[30];
    ...
    public IYY10211_OA( IYY10211_OA orig )
    {
    ...
    public static IYY10211_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY10211_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10211_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY10211_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY10211_OA orig )
    {
      ExpIyy1ChildCinstanceId_AS = orig.ExpIyy1ChildCinstanceId_AS;
      ExpIyy1ChildCinstanceId = orig.ExpIyy1ChildCinstanceId;
      ExpIyy1ChildCreferenceId_AS = orig.ExpIyy1ChildCreferenceId_AS;

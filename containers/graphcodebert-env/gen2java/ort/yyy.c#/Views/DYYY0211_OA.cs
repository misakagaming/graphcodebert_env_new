...
//
//    Name: DYYY0211_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0211_OA : ViewBase, IExportView
  {
    private static DYYY0211_OA[] freeArray = new DYYY0211_OA[30];
    ...
    public static DYYY0211_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0211_OA result = freeArray[--countFree];

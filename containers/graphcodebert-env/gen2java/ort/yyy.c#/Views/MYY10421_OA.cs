...
//
//    Name: MYY10421_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class MYY10421_OA : ViewBase, IExportView
  {
    private static MYY10421_OA[] freeArray = new MYY10421_OA[30];
    ...
    public static MYY10421_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            MYY10421_OA result = freeArray[--countFree];

...
//
//    Name: CYYY9051_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY9051_LA : ViewBase, ILocalView
  {
    private static CYYY9051_LA[] freeArray = new CYYY9051_LA[30];
    ...
    public static CYYY9051_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY9051_LA result = freeArray[--countFree];

...
//
//    Name: CYY1S041_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYY1S041_LA : ViewBase, ILocalView
  {
    private static CYY1S041_LA[] freeArray = new CYY1S041_LA[30];
    ...
    public static CYY1S041_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYY1S041_LA result = freeArray[--countFree];

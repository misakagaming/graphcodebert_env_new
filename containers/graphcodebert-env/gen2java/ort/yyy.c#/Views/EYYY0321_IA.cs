...
//
//    Name: EYYY0321_IA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: EYYY0321_IA
  /// </summary>
  [Serializable]
  public class EYYY0321_IA : ViewBase, IImportView
  {
    private static EYYY0321_IA[] freeArray = new EYYY0321_IA[30];
    ...
    public EYYY0321_IA( EYYY0321_IA orig )
    {
    ...
    public static EYYY0321_IA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new EYYY0321_IA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            EYYY0321_IA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((EYYY0321_IA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( EYYY0321_IA orig )
    {
      ImpTypeTinstanceId_AS = orig.ImpTypeTinstanceId_AS;
      ImpTypeTinstanceId = orig.ImpTypeTinstanceId;
      ImpTypeTkeyAttrText_AS = orig.ImpTypeTkeyAttrText_AS;

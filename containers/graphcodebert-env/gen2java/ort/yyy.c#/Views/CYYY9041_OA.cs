...
//
//    Name: CYYY9041_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY9041_OA : ViewBase, IExportView
  {
    private static CYYY9041_OA[] freeArray = new CYYY9041_OA[30];
    ...
    public static CYYY9041_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY9041_OA result = freeArray[--countFree];

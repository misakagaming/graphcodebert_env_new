...
//
//    Name: MYY10111_IA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: MYY10111_IA
  /// </summary>
  [Serializable]
  public class MYY10111_IA : ViewBase, IImportView
  {
    private static MYY10111_IA[] freeArray = new MYY10111_IA[30];
    ...
    public MYY10111_IA( MYY10111_IA orig )
    {
    ...
    public static MYY10111_IA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new MYY10111_IA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            MYY10111_IA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((MYY10111_IA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( MYY10111_IA orig )
    {
      ImpReferenceIyy1ServerDataUserid_AS = orig.ImpReferenceIyy1ServerDataUserid_AS;
      ImpReferenceIyy1ServerDataUserid = orig.ImpReferenceIyy1ServerDataUserid;
      ImpReferenceIyy1ServerDataReferenceId_AS = orig.ImpReferenceIyy1ServerDataReferenceId_AS;

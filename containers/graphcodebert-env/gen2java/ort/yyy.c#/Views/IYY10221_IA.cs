...
//
//    Name: IYY10221_IA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY10221_IA
  /// </summary>
  [Serializable]
  public class IYY10221_IA : ViewBase, IImportView
  {
    private static IYY10221_IA[] freeArray = new IYY10221_IA[30];
    ...
    public IYY10221_IA( IYY10221_IA orig )
    {
    ...
    public static IYY10221_IA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY10221_IA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10221_IA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY10221_IA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY10221_IA orig )
    {
      ImpIyy1ChildCinstanceId_AS = orig.ImpIyy1ChildCinstanceId_AS;
      ImpIyy1ChildCinstanceId = orig.ImpIyy1ChildCinstanceId;
      ImpIyy1ChildCparentPkeyAttrText_AS = orig.ImpIyy1ChildCparentPkeyAttrText_AS;

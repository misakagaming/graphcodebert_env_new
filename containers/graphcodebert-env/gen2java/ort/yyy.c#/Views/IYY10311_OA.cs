...
//
//    Name: IYY10311_OA                      Date: 2024/01/09
//    User: AliAl                            Time: 13:41:40
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
{
  /// <summary>
  /// Internal data view storage for: IYY10311_OA
  /// </summary>
  [Serializable]
  public class IYY10311_OA : ViewBase, IExportView
  {
    private static IYY10311_OA[] freeArray = new IYY10311_OA[30];
    ...
    public IYY10311_OA( IYY10311_OA orig )
    {
    ...
    public static IYY10311_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY10311_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10311_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY10311_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY10311_OA orig )
    {
      ExpIyy1TypeTinstanceId_AS = orig.ExpIyy1TypeTinstanceId_AS;
      ExpIyy1TypeTinstanceId = orig.ExpIyy1TypeTinstanceId;
      ExpIyy1TypeTreferenceId_AS = orig.ExpIyy1TypeTreferenceId_AS;

...
//
//    Name: CYYY9481_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: CYYY9481_OA
  /// </summary>
  [Serializable]
  public class CYYY9481_OA : ViewBase, IExportView
  {
    private static CYYY9481_OA[] freeArray = new CYYY9481_OA[30];
    ...
    public CYYY9481_OA( CYYY9481_OA orig )
    {
    ...
    public static CYYY9481_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new CYYY9481_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY9481_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((CYYY9481_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( CYYY9481_OA orig )
    {
      ExpGroupHilite_MA = orig.ExpGroupHilite_MA;
      for(int a = 0; a < 10; a++)
      {

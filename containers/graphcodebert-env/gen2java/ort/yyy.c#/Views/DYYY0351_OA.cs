...
//
//    Name: DYYY0351_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0351_OA : ViewBase, IExportView
  {
    private static DYYY0351_OA[] freeArray = new DYYY0351_OA[30];
    ...
    public static DYYY0351_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0351_OA result = freeArray[--countFree];

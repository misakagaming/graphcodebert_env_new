...
//
//    Name: DYYY0351_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0351_LA : ViewBase, ILocalView
  {
    private static DYYY0351_LA[] freeArray = new DYYY0351_LA[30];
    ...
    public static DYYY0351_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0351_LA result = freeArray[--countFree];

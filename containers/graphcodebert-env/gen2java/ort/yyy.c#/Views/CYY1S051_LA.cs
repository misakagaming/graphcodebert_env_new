...
//
//    Name: CYY1S051_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYY1S051_LA : ViewBase, ILocalView
  {
    private static CYY1S051_LA[] freeArray = new CYY1S051_LA[30];
    ...
    public static CYY1S051_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYY1S051_LA result = freeArray[--countFree];

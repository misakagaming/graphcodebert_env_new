...
//
//    Name: CYYY0241_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0241_OA : ViewBase, IExportView
  {
    private static CYYY0241_OA[] freeArray = new CYYY0241_OA[30];
    ...
    public static CYYY0241_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0241_OA result = freeArray[--countFree];

...
//
//    Name: IYY19041_IA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY19041_IA
  /// </summary>
  [Serializable]
  public class IYY19041_IA : ViewBase, IImportView
  {
    private static IYY19041_IA[] freeArray = new IYY19041_IA[30];
    ...
    public IYY19041_IA( IYY19041_IA orig )
    {
    ...
    public static IYY19041_IA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY19041_IA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY19041_IA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY19041_IA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY19041_IA orig )
    {
      ImpErrorIyy1ComponentOriginServid_AS = orig.ImpErrorIyy1ComponentOriginServid_AS;
      ImpErrorIyy1ComponentOriginServid = orig.ImpErrorIyy1ComponentOriginServid;
      ImpErrorIyy1ComponentContextString_AS = orig.ImpErrorIyy1ComponentContextString_AS;

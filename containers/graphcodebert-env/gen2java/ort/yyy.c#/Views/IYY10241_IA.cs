...
//
//    Name: IYY10241_IA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY10241_IA
  /// </summary>
  [Serializable]
  public class IYY10241_IA : ViewBase, IImportView
  {
    private static IYY10241_IA[] freeArray = new IYY10241_IA[30];
    ...
    public IYY10241_IA( IYY10241_IA orig )
    {
    ...
    public static IYY10241_IA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY10241_IA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10241_IA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY10241_IA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY10241_IA orig )
    {
      ImpReferenceIyy1ServerDataUserid_AS = orig.ImpReferenceIyy1ServerDataUserid_AS;
      ImpReferenceIyy1ServerDataUserid = orig.ImpReferenceIyy1ServerDataUserid;
      ImpReferenceIyy1ServerDataReferenceId_AS = orig.ImpReferenceIyy1ServerDataReferenceId_AS;

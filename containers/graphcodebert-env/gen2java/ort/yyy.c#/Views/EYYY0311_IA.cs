...
//
//    Name: EYYY0311_IA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: EYYY0311_IA
  /// </summary>
  [Serializable]
  public class EYYY0311_IA : ViewBase, IImportView
  {
    private static EYYY0311_IA[] freeArray = new EYYY0311_IA[30];
    ...
    public EYYY0311_IA( EYYY0311_IA orig )
    {
    ...
    public static EYYY0311_IA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new EYYY0311_IA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            EYYY0311_IA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((EYYY0311_IA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( EYYY0311_IA orig )
    {
      ImpReferenceIyy1ServerDataUserid_AS = orig.ImpReferenceIyy1ServerDataUserid_AS;
      ImpReferenceIyy1ServerDataUserid = orig.ImpReferenceIyy1ServerDataUserid;
      ImpReferenceIyy1ServerDataReferenceId_AS = orig.ImpReferenceIyy1ServerDataReferenceId_AS;

...
//
//    Name: IYY10341_OA                      Date: 2024/01/09
//    User: AliAl                            Time: 13:41:41
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
{
  /// <summary>
  /// Internal data view storage for: IYY10341_OA
  /// </summary>
  [Serializable]
  public class IYY10341_OA : ViewBase, IExportView
  {
    private static IYY10341_OA[] freeArray = new IYY10341_OA[30];
    ...
    public IYY10341_OA( IYY10341_OA orig )
    {
    ...
    public static IYY10341_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY10341_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10341_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY10341_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY10341_OA orig )
    {
      ExpErrorIyy1ComponentSeverityCode_AS = orig.ExpErrorIyy1ComponentSeverityCode_AS;
      ExpErrorIyy1ComponentSeverityCode = orig.ExpErrorIyy1ComponentSeverityCode;
      ExpErrorIyy1ComponentRollbackIndicator_AS = orig.ExpErrorIyy1ComponentRollbackIndicator_AS;

...
//
//    Name: ISC11021_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: ISC11021_OA
  /// </summary>
  [Serializable]
  public class ISC11021_OA : ViewBase, IExportView
  {
    private static ISC11021_OA[] freeArray = new ISC11021_OA[30];
    ...
    public ISC11021_OA( ISC11021_OA orig )
    {
    ...
    public static ISC11021_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new ISC11021_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            ISC11021_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((ISC11021_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( ISC11021_OA orig )
    {
      ExpErrorIsc1ComponentSeverityCode_AS = orig.ExpErrorIsc1ComponentSeverityCode_AS;
      ExpErrorIsc1ComponentSeverityCode = orig.ExpErrorIsc1ComponentSeverityCode;
      ExpErrorIsc1ComponentRollbackIndicator_AS = orig.ExpErrorIsc1ComponentRollbackIndicator_AS;

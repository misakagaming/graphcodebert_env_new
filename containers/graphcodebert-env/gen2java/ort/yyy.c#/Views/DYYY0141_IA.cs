...
//
//    Name: DYYY0141_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0141_IA : ViewBase, IImportView
  {
    private static DYYY0141_IA[] freeArray = new DYYY0141_IA[30];
    ...
    public static DYYY0141_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0141_IA result = freeArray[--countFree];

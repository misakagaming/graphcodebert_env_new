...
//
//    Name: DYYY0231_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0231_IA : ViewBase, IImportView
  {
    private static DYYY0231_IA[] freeArray = new DYYY0231_IA[30];
    ...
    public static DYYY0231_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0231_IA result = freeArray[--countFree];

...
//
//    Name: EYYY0331_IA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: EYYY0331_IA
  /// </summary>
  [Serializable]
  public class EYYY0331_IA : ViewBase, IImportView
  {
    private static EYYY0331_IA[] freeArray = new EYYY0331_IA[30];
    ...
    public EYYY0331_IA( EYYY0331_IA orig )
    {
    ...
    public static EYYY0331_IA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new EYYY0331_IA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            EYYY0331_IA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((EYYY0331_IA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( EYYY0331_IA orig )
    {
      ImpReferenceIyy1ServerDataUserid_AS = orig.ImpReferenceIyy1ServerDataUserid_AS;
      ImpReferenceIyy1ServerDataUserid = orig.ImpReferenceIyy1ServerDataUserid;
      ImpReferenceIyy1ServerDataReferenceId_AS = orig.ImpReferenceIyy1ServerDataReferenceId_AS;

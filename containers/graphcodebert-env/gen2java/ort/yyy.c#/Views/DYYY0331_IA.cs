...
//
//    Name: DYYY0331_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0331_IA : ViewBase, IImportView
  {
    private static DYYY0331_IA[] freeArray = new DYYY0331_IA[30];
    ...
    public static DYYY0331_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0331_IA result = freeArray[--countFree];

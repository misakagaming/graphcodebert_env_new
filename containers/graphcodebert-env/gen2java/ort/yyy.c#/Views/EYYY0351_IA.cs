...
//
//    Name: EYYY0351_IA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: EYYY0351_IA
  /// </summary>
  [Serializable]
  public class EYYY0351_IA : ViewBase, IImportView
  {
    private static EYYY0351_IA[] freeArray = new EYYY0351_IA[30];
    ...
    public EYYY0351_IA( EYYY0351_IA orig )
    {
    ...
    public static EYYY0351_IA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new EYYY0351_IA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            EYYY0351_IA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((EYYY0351_IA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( EYYY0351_IA orig )
    {
      ImpFilterIyy1ListSortOption_AS = orig.ImpFilterIyy1ListSortOption_AS;
      ImpFilterIyy1ListSortOption = orig.ImpFilterIyy1ListSortOption;
      ImpFilterIyy1ListScrollType_AS = orig.ImpFilterIyy1ListScrollType_AS;

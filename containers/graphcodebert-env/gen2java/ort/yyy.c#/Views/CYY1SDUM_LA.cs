...
//
//    Name: CYY1SDUM_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYY1SDUM_LA : ViewBase, ILocalView
  {
    private static CYY1SDUM_LA[] freeArray = new CYY1SDUM_LA[30];
    ...
    public static CYY1SDUM_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYY1SDUM_LA result = freeArray[--countFree];

...
//
//    Name: EYYY0431_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class EYYY0431_OA : ViewBase, IExportView
  {
    private static EYYY0431_OA[] freeArray = new EYYY0431_OA[30];
    ...
    public static EYYY0431_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            EYYY0431_OA result = freeArray[--countFree];

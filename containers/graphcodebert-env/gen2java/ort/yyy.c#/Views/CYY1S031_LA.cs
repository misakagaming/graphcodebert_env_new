...
//
//    Name: CYY1S031_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYY1S031_LA : ViewBase, ILocalView
  {
    private static CYY1S031_LA[] freeArray = new CYY1S031_LA[30];
    ...
    public static CYY1S031_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYY1S031_LA result = freeArray[--countFree];

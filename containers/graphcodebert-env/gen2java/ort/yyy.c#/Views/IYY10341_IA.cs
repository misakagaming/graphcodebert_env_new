...
//
//    Name: IYY10341_IA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY10341_IA
  /// </summary>
  [Serializable]
  public class IYY10341_IA : ViewBase, IImportView
  {
    private static IYY10341_IA[] freeArray = new IYY10341_IA[30];
    ...
    public IYY10341_IA( IYY10341_IA orig )
    {
    ...
    public static IYY10341_IA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY10341_IA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10341_IA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY10341_IA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY10341_IA orig )
    {
      ImpReferenceIyy1ServerDataUserid_AS = orig.ImpReferenceIyy1ServerDataUserid_AS;
      ImpReferenceIyy1ServerDataUserid = orig.ImpReferenceIyy1ServerDataUserid;
      ImpReferenceIyy1ServerDataReferenceId_AS = orig.ImpReferenceIyy1ServerDataReferenceId_AS;

...
//
//    Name: CYYY9041_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY9041_IA : ViewBase, IImportView
  {
    private static CYYY9041_IA[] freeArray = new CYYY9041_IA[30];
    ...
    public static CYYY9041_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY9041_IA result = freeArray[--countFree];

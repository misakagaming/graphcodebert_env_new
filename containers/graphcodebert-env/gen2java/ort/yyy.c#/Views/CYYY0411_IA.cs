...
//
//    Name: CYYY0411_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0411_IA : ViewBase, IImportView
  {
    private static CYYY0411_IA[] freeArray = new CYYY0411_IA[30];
    ...
    public static CYYY0411_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0411_IA result = freeArray[--countFree];

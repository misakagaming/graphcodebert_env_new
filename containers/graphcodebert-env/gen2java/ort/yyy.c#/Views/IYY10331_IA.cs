...
//
//    Name: IYY10331_IA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY10331_IA
  /// </summary>
  [Serializable]
  public class IYY10331_IA : ViewBase, IImportView
  {
    private static IYY10331_IA[] freeArray = new IYY10331_IA[30];
    ...
    public IYY10331_IA( IYY10331_IA orig )
    {
    ...
    public static IYY10331_IA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY10331_IA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10331_IA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY10331_IA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY10331_IA orig )
    {
      ImpReferenceIyy1ServerDataUserid_AS = orig.ImpReferenceIyy1ServerDataUserid_AS;
      ImpReferenceIyy1ServerDataUserid = orig.ImpReferenceIyy1ServerDataUserid;
      ImpReferenceIyy1ServerDataReferenceId_AS = orig.ImpReferenceIyy1ServerDataReferenceId_AS;

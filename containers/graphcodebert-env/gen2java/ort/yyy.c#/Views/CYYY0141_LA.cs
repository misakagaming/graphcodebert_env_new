...
//
//    Name: CYYY0141_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0141_LA : ViewBase, ILocalView
  {
    private static CYYY0141_LA[] freeArray = new CYYY0141_LA[30];
    ...
    public static CYYY0141_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0141_LA result = freeArray[--countFree];

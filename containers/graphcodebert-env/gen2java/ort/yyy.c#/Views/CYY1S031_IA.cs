...
//
//    Name: CYY1S031_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYY1S031_IA : ViewBase, IImportView
  {
    static VDF localVdf = null;
    
    private static CYY1S031_IA[] freeArray = new CYY1S031_IA[30];
    ...
    public static CYY1S031_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYY1S031_IA result = freeArray[--countFree];

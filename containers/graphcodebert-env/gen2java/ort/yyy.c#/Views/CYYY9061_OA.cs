...
//
//    Name: CYYY9061_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: CYYY9061_OA
  /// </summary>
  [Serializable]
  public class CYYY9061_OA : ViewBase, IExportView
  {
    private static CYYY9061_OA[] freeArray = new CYYY9061_OA[30];
    ...
    public CYYY9061_OA( CYYY9061_OA orig )
    {
    ...
    public static CYYY9061_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new CYYY9061_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY9061_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((CYYY9061_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( CYYY9061_OA orig )
    {
      ExpNmparmsIyy1ComponentOriginServid_AS = orig.ExpNmparmsIyy1ComponentOriginServid_AS;
      ExpNmparmsIyy1ComponentOriginServid = orig.ExpNmparmsIyy1ComponentOriginServid;
      ExpNmparmsIyy1ComponentImplementationId_AS = orig.ExpNmparmsIyy1ComponentImplementationId_AS;

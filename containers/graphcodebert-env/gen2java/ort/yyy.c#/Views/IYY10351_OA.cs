...
//
//    Name: IYY10351_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class IYY10351_OA : ViewBase, IExportView
  {
    private static IYY10351_OA[] freeArray = new IYY10351_OA[30];
    ...
    public static IYY10351_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10351_OA result = freeArray[--countFree];

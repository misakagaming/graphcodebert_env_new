...
//
//    Name: MYY10411_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class MYY10411_OA : ViewBase, IExportView
  {
    private static MYY10411_OA[] freeArray = new MYY10411_OA[30];
    ...
    public static MYY10411_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            MYY10411_OA result = freeArray[--countFree];

...
//
//    Name: CYYY0221_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0221_OA : ViewBase, IExportView
  {
    private static CYYY0221_OA[] freeArray = new CYYY0221_OA[30];
    ...
    public static CYYY0221_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0221_OA result = freeArray[--countFree];

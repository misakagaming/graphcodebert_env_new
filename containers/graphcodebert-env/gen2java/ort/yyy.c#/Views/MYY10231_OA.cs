...
//
//    Name: MYY10231_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: MYY10231_OA
  /// </summary>
  [Serializable]
  public class MYY10231_OA : ViewBase, IExportView
  {
    private static MYY10231_OA[] freeArray = new MYY10231_OA[30];
    ...
    public MYY10231_OA( MYY10231_OA orig )
    {
    ...
    public static MYY10231_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new MYY10231_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            MYY10231_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((MYY10231_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( MYY10231_OA orig )
    {
      ExpIyy1ChildCreferenceId_AS = orig.ExpIyy1ChildCreferenceId_AS;
      ExpIyy1ChildCreferenceId = orig.ExpIyy1ChildCreferenceId;
      ExpErrorIyy1ComponentSeverityCode_AS = orig.ExpErrorIyy1ComponentSeverityCode_AS;

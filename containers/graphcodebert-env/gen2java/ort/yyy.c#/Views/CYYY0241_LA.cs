...
//
//    Name: CYYY0241_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0241_LA : ViewBase, ILocalView
  {
    private static CYYY0241_LA[] freeArray = new CYYY0241_LA[30];
    ...
    public static CYYY0241_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0241_LA result = freeArray[--countFree];

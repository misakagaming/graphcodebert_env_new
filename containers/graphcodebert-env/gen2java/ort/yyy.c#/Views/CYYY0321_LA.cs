...
//
//    Name: CYYY0321_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0321_LA : ViewBase, ILocalView
  {
    private static CYYY0321_LA[] freeArray = new CYYY0321_LA[30];
    ...
    public static CYYY0321_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0321_LA result = freeArray[--countFree];

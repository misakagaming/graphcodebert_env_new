...
//
//    Name: IYY10251_IA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY10251_IA
  /// </summary>
  [Serializable]
  public class IYY10251_IA : ViewBase, IImportView
  {
    private static IYY10251_IA[] freeArray = new IYY10251_IA[30];
    ...
    public IYY10251_IA( IYY10251_IA orig )
    {
    ...
    public static IYY10251_IA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY10251_IA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10251_IA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY10251_IA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY10251_IA orig )
    {
      ImpFilterIyy1ListSortOption_AS = orig.ImpFilterIyy1ListSortOption_AS;
      ImpFilterIyy1ListSortOption = orig.ImpFilterIyy1ListSortOption;
      ImpFilterIyy1ListScrollType_AS = orig.ImpFilterIyy1ListScrollType_AS;

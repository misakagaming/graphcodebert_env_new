...
//
//    Name: DYYY0111_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0111_OA : ViewBase, IExportView
  {
    private static DYYY0111_OA[] freeArray = new DYYY0111_OA[30];
    ...
    public static DYYY0111_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0111_OA result = freeArray[--countFree];

...
//
//    Name: DYYY0331_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0331_OA : ViewBase, IExportView
  {
    private static DYYY0331_OA[] freeArray = new DYYY0331_OA[30];
    ...
    public static DYYY0331_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0331_OA result = freeArray[--countFree];

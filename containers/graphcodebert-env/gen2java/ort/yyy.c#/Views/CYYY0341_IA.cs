...
//
//    Name: CYYY0341_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0341_IA : ViewBase, IImportView
  {
    private static CYYY0341_IA[] freeArray = new CYYY0341_IA[30];
    ...
    public static CYYY0341_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0341_IA result = freeArray[--countFree];

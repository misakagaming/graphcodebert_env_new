...
//
//    Name: DYYY0311_LA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0311_LA : ViewBase, ILocalView
  {
    private static DYYY0311_LA[] freeArray = new DYYY0311_LA[30];
    ...
    public static DYYY0311_LA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0311_LA result = freeArray[--countFree];

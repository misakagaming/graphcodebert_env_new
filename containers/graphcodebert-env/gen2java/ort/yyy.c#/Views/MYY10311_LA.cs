...
//
//    Name: MYY10311_LA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: MYY10311_LA
  /// </summary>
  [Serializable]
  public class MYY10311_LA : ViewBase, ILocalView
  {
    private static MYY10311_LA[] freeArray = new MYY10311_LA[30];
    ...
    public MYY10311_LA( MYY10311_LA orig )
    {
    ...
    public static MYY10311_LA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new MYY10311_LA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            MYY10311_LA result = freeArray[--countFree];

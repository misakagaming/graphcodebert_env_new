...
//
//    Name: DYYY0211_IA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class DYYY0211_IA : ViewBase, IImportView
  {
    private static DYYY0211_IA[] freeArray = new DYYY0211_IA[30];
    ...
    public static DYYY0211_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            DYYY0211_IA result = freeArray[--countFree];

...
//
//    Name: EYYY0321_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: EYYY0321_OA
  /// </summary>
  [Serializable]
  public class EYYY0321_OA : ViewBase, IExportView
  {
    private static EYYY0321_OA[] freeArray = new EYYY0321_OA[30];
    ...
    public EYYY0321_OA( EYYY0321_OA orig )
    {
    ...
    public static EYYY0321_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new EYYY0321_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            EYYY0321_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((EYYY0321_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( EYYY0321_OA orig )
    {
      ExpTypeTinstanceId_AS = orig.ExpTypeTinstanceId_AS;
      ExpTypeTinstanceId = orig.ExpTypeTinstanceId;
      ExpTypeTreferenceId_AS = orig.ExpTypeTreferenceId_AS;

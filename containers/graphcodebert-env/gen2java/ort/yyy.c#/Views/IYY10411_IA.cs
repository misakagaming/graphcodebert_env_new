...
//
//    Name: IYY10411_IA                      Date: 2024/01/09
//    User: AliAl                            Time: 13:41:29
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class IYY10411_IA : ViewBase, IImportView
  {
    private static IYY10411_IA[] freeArray = new IYY10411_IA[30];
    ...
    public static IYY10411_IA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10411_IA result = freeArray[--countFree];

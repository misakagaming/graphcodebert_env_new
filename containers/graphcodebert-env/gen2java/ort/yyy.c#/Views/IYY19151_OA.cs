...
//
//    Name: IYY19151_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY19151_OA
  /// </summary>
  [Serializable]
  public class IYY19151_OA : ViewBase, IExportView
  {
    private static IYY19151_OA[] freeArray = new IYY19151_OA[30];
    private static int countFree = 0;
    
    // Entity View: EXP_CHECKSUM
    //        Type: IYY1_COMPONENT
    /// <summary>
    /// Internal storage for attribute missing flag for: ExpChecksumIyy1ComponentChecksum
    /// </summary>
    private char _ExpChecksumIyy1ComponentChecksum_AS;
    /// <summary>
    /// Attribute missing flag for: ExpChecksumIyy1ComponentChecksum
    /// </summary>
    public char ExpChecksumIyy1ComponentChecksum_AS {
      get {
        return(_ExpChecksumIyy1ComponentChecksum_AS);
      }
      set {
        _ExpChecksumIyy1ComponentChecksum_AS = value;
      }
    }
    /// <summary>
    /// Internal storage, attribute for: ExpChecksumIyy1ComponentChecksum
    /// Domain: Text
    /// Length: 15
    /// Varying Length: N
    /// </summary>
    private string _ExpChecksumIyy1ComponentChecksum;
    /// <summary>
    /// Attribute for: ExpChecksumIyy1ComponentChecksum
    /// </summary>
    public string ExpChecksumIyy1ComponentChecksum {
      get {
        return(_ExpChecksumIyy1ComponentChecksum);
      }
      set {
        _ExpChecksumIyy1ComponentChecksum = value;
      }
    }
    ...
    public IYY19151_OA( IYY19151_OA orig )
    {
      ExpChecksumIyy1ComponentChecksum_AS = orig.ExpChecksumIyy1ComponentChecksum_AS;
      ExpChecksumIyy1ComponentChecksum = orig.ExpChecksumIyy1ComponentChecksum;
    ...
    public static IYY19151_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY19151_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY19151_OA result = freeArray[--countFree];
    ...
    public void Reset(  )
    {
      ExpChecksumIyy1ComponentChecksum_AS = ' ';
      ExpChecksumIyy1ComponentChecksum = "               ";
    ...
    {
      this.CopyFrom((IYY19151_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY19151_OA orig )
    {
      ExpChecksumIyy1ComponentChecksum_AS = orig.ExpChecksumIyy1ComponentChecksum_AS;
      ExpChecksumIyy1ComponentChecksum = orig.ExpChecksumIyy1ComponentChecksum;
      ExpErrorIyy1ComponentSeverityCode_AS = orig.ExpErrorIyy1ComponentSeverityCode_AS;

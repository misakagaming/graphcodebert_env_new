...
//
//    Name: CYYY0441_OA                      Date: 2024/01/09
//    User: AliAl                            Time: 13:41:26
//
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class CYYY0441_OA : ViewBase, IExportView
  {
    private static CYYY0441_OA[] freeArray = new CYYY0441_OA[30];
    ...
    public static CYYY0441_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            CYYY0441_OA result = freeArray[--countFree];

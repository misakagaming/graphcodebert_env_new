...
//
//    Name: IYY10241_OA                      Date: 2024/01/09
...
{
  /// <summary>
  /// Internal data view storage for: IYY10241_OA
  /// </summary>
  [Serializable]
  public class IYY10241_OA : ViewBase, IExportView
  {
    private static IYY10241_OA[] freeArray = new IYY10241_OA[30];
    ...
    public IYY10241_OA( IYY10241_OA orig )
    {
    ...
    public static IYY10241_OA GetInstance(  )
    {
      if ( countFree == 0 )
      {
        return(new IYY10241_OA());
      }
      else 
      {
        lock (freeArray)
        {
          ...
          {
            IYY10241_OA result = freeArray[--countFree];
    ...
    {
      this.CopyFrom((IYY10241_OA) orig);
    }
    
    /// <summary>
    /// Sets the current instance based on the passed view.
    /// </summary>
    public void CopyFrom( IYY10241_OA orig )
    {
      ExpErrorIyy1ComponentSeverityCode_AS = orig.ExpErrorIyy1ComponentSeverityCode_AS;
      ExpErrorIyy1ComponentSeverityCode = orig.ExpErrorIyy1ComponentSeverityCode;
      ExpErrorIyy1ComponentRollbackIndicator_AS = orig.ExpErrorIyy1ComponentRollbackIndicator_AS;

...
//
//    Name: EYYY0421_OA                      Date: 2024/01/09
...
namespace GEN.ORT.YYY
{
  ...
  /// </summary>
  [Serializable]
  public class EYYY0421_OA : ViewBase, IExportView
  {
    private static EYYY0421_OA[] freeArray = new EYYY0421_OA[30];
    ...
    public static EYYY0421_OA GetInstance(  )
    {
      ...
      else 
      {
        lock (freeArray)
        {
          ...
          {
            EYYY0421_OA result = freeArray[--countFree];
